...
/**
 * Thrown when a {@link ServiceError} or {@link IOException} is thrown by
 * OpenMUC OpenIEC61850 during write actions.
 */
public class NodeWriteException extends NodeException {
    ...
    public NodeWriteException(final String message, final Throwable throwable, final ConnectionState connectionState) {
