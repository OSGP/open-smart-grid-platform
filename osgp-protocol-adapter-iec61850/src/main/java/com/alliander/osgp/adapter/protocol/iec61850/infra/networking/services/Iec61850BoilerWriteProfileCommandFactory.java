...
public class Iec61850BoilerWriteProfileCommandFactory implements RtuWriteCommandFactory<ProfileDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850BoilerWriteProfileCommandFactory.class);
    ...
    private static Iec61850BoilerWriteProfileCommandFactory instance;

    private Iec61850BoilerWriteProfileCommandFactory() {
    }

    public static synchronized Iec61850BoilerWriteProfileCommandFactory getInstance() {
        if (instance == null) {
            instance = new Iec61850BoilerWriteProfileCommandFactory();
        }
        return instance;
    }
