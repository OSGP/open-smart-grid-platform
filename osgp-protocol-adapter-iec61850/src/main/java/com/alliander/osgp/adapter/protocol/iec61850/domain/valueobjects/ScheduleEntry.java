...
public class ScheduleEntry {
    ...
    public static final class Builder {
        ...
        /**
         * Makes this {@link ScheduleEntry} work on the {@code time} provided as
         * {@code short} value (e.g. 06:35 is represented by 635).
         *
         * @param time
        ...
        public Builder withTime(final short time) {
            ...
            if (time % 100 > 59) {
                throw new IllegalArgumentException("time value must not end with two digits outside [0..59]: " + time);
            }
            this.time = time;
            return this;
        }
