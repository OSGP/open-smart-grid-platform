...
public class Iec61850MinimumActualPowerCommand implements RtuCommand {
    ...
    public MeasurementDto translate(final NodeContainer containingNode) {
        return new MeasurementDto(1, DataAttribute.MIN_ACTUAL_POWER.getDescription(), 0, new DateTime(
