...
public class PublicLightingGetActualPowerUsageRequestMessageProcessor extends DeviceRequestMessageProcessor {
    ...
    // protected void handleGetActualPowerUsageDeviceResponse(final
    ...
    //
    // try {
    // final GetActualPowerUsageDeviceResponse response =
    ...
    //
    // try {
    // this.deviceService.doGetActualPowerUsage(oslpEnvelope, deviceRequest,
