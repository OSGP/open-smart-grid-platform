...
public class Iec61850LoadMaximumActualPowerCommand implements RtuCommand {
    ...
    public MeasurementDto execute(final Iec61850Client client, final DeviceConnection connection,
        ...
        final NodeContainer containingNode = connection.getFcModelNode(logicalDevice, this.logicalNode,
                DataAttribute.MAX_ACTUAL_POWER, Fc.MX);
    ...
    public MeasurementDto translate(final NodeContainer containingNode) {
        return new MeasurementDto(this.index, DataAttribute.MAX_ACTUAL_POWER.getDescription(), 0, new DateTime(
