...
public final class Iec61850PvCommandFactory implements LogicalDeviceReadCommandFactory<MeasurementDto, MeasurementFilterDto> {
    ...
    public static synchronized Iec61850PvCommandFactory getInstance() {
        if (instance == null) {
