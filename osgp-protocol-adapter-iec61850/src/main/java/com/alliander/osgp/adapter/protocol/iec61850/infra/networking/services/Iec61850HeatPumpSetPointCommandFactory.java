...
public class Iec61850HeatPumpSetPointCommandFactory implements RtuWriteCommandFactory<SetPointDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850HeatPumpSetPointCommandFactory.class);
    ...
    static {
        initializeBatteryCommandMap();
    }

    private static Iec61850HeatPumpSetPointCommandFactory instance;

    private Iec61850HeatPumpSetPointCommandFactory() {
    }

    public static synchronized Iec61850HeatPumpSetPointCommandFactory getInstance() {
        if (instance == null) {
            instance = new Iec61850HeatPumpSetPointCommandFactory();
        }
        return instance;
    }
