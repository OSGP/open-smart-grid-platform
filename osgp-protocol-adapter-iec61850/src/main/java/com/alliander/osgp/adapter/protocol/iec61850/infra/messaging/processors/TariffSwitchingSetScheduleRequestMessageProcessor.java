...
public class TariffSwitchingSetScheduleRequestMessageProcessor extends DeviceRequestMessageProcessor {
    ...
    // final ScheduleMessageDataContainer scheduleMessageDataContainer =
    // (ScheduleMessageDataContainer) unsignedOslpEnvelopeDto
    // .getExtraData();
    //
    ...
    // final SetScheduleDeviceRequest deviceRequest = new
    // SetScheduleDeviceRequest(organisationIdentification,
    // deviceIdentification, correlationUid, scheduleMessageDataContainer,
    // RelayType.TARIFF, domain,
    // domainVersion, messageType, ipAddress, retryCount, isScheduled);
    //
    // try {
    // this.deviceService.doSetSchedule(oslpEnvelope, deviceRequest,
    // deviceResponseHandler, ipAddress, domain,
