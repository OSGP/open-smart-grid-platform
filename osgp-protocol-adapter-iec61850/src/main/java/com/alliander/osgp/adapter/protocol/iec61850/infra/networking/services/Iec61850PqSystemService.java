...
@Service
public class Iec61850PqSystemService implements SystemService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850PqSystemService.class);
    private static final LogicalDevice DEVICE = LogicalDevice.PQ;

    @Autowired
    private Iec61850PqCommandFactory iec61850PqCommandFactory;
    ...
    public void setData(final SetDataSystemIdentifierDto systemIdentifier, final Iec61850Client client,
            final DeviceConnection connection) throws NodeException {
        {
             ...
             * detected by an increment of the SchdId after the profiles are
             * already set to the RTU
             */
