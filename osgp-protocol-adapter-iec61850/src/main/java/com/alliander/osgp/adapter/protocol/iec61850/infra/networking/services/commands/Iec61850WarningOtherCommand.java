...
public class Iec61850WarningOtherCommand implements RtuReadCommand<MeasurementDto> {
    ...
    public MeasurementDto execute(final Iec61850Client client, final DeviceConnection connection,
        ...
        final NodeContainer containingNode = connection.getFcModelNode(logicalDevice, logicalDeviceIndex,
                LogicalNode.GENERIC_PROCESS_I_O, DataAttribute.WARNING_OTHER, Fc.ST);
    ...
    public MeasurementDto translate(final NodeContainer containingNode) {
        return new MeasurementDto(1, DataAttribute.WARNING_OTHER.getDescription(),
                ...
                containingNode.getInteger(SubDataAttribute.STATE).getValue(), new ArrayList<PhaseDto>());
    }
}
