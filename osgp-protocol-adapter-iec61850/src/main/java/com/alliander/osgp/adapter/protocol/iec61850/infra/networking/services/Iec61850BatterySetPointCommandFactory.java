...
public class Iec61850BatterySetPointCommandFactory implements RtuWriteCommandFactory<SetPointDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850BatterySetPointCommandFactory.class);
    ...
    private static Iec61850BatterySetPointCommandFactory instance;

    private Iec61850BatterySetPointCommandFactory() {
    }

    public static synchronized Iec61850BatterySetPointCommandFactory getInstance() {
        if (instance == null) {
            instance = new Iec61850BatterySetPointCommandFactory();
        }
        return instance;
    }
