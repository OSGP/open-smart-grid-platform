...
public class Iec61850BoilerSetPointCommandFactory implements RtuWriteCommandFactory<SetPointDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850BoilerSetPointCommandFactory.class);
    ...
    private static Iec61850BoilerSetPointCommandFactory instance;

    private Iec61850BoilerSetPointCommandFactory() {
    }

    public static synchronized Iec61850BoilerSetPointCommandFactory getInstance() {
        if (instance == null) {
            instance = new Iec61850BoilerSetPointCommandFactory();
        }
        return instance;
    }
