...
public class CommonGetFirmwareRequestMessageProcessor extends DeviceRequestMessageProcessor {
    ...
    // deviceResponse) {
    // CommonGetFirmwareRequestMessageProcessor.this.handleUnableToConnectDeviceResponse(deviceResponse,
    // t,
    // null,
    // CommonGetFirmwareRequestMessageProcessor.this.responseMessageSender,
    // deviceResponse,
    ...
    //
    // try {
    // this.deviceService.doGetFirmwareVersion(oslpEnvelope, deviceRequest,
    ...
    // private void handleGetFirmwareVersionDeviceResponse(final DeviceResponse
    // deviceResponse,
    ...
    //
    // try {
    // final GetFirmwareVersionDeviceResponse response =
    // (GetFirmwareVersionDeviceResponse) deviceResponse;
