...
public class Iec61850ModeCommand implements RtuReadCommand<MeasurementDto> {
    ...
    public MeasurementDto execute(final Iec61850Client client, final DeviceConnection connection,
        ...
        final NodeContainer containingNode = connection.getFcModelNode(logicalDevice, logicalDeviceIndex,
                LogicalNode.LOGICAL_NODE_ZERO, DataAttribute.MODE, Fc.ST);
    ...
    public MeasurementDto translate(final NodeContainer containingNode) {
        return new MeasurementDto(1, DataAttribute.MODE.getDescription(),
                ...
                containingNode.getByte(SubDataAttribute.STATE).getValue(), new ArrayList<PhaseDto>());
    }
}
