...
public class Iec61850HeatPumpWriteProfileCommandFactory implements RtuWriteCommandFactory<ProfileDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850HeatPumpWriteProfileCommandFactory.class);
    ...
    private static Iec61850HeatPumpWriteProfileCommandFactory instance;

    private Iec61850HeatPumpWriteProfileCommandFactory() {
    }

    public static synchronized Iec61850HeatPumpWriteProfileCommandFactory getInstance() {
        if (instance == null) {
            instance = new Iec61850HeatPumpWriteProfileCommandFactory();
        }
        return instance;
    }
