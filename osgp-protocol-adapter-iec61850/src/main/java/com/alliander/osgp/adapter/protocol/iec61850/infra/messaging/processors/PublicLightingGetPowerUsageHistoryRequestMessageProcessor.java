...
public class PublicLightingGetPowerUsageHistoryRequestMessageProcessor extends DeviceRequestMessageProcessor {
    ...
    // deviceResponse, t, ((PowerUsageHistoryResponseMessageDataContainer)
    // unsignedOslpEnvelopeDto
    // .getExtraData()).getRequestContainer(),
    // PublicLightingGetPowerUsageHistoryRequestMessageProcessor.this.responseMessageSender,
    // deviceResponse, domain, domainVersion, messageType, isScheduled,
    // retryCount);
    // }
    // };
    //
    // try {
    // final PowerUsageHistoryResponseMessageDataContainer
    // powerUsageHistoryResponseMessageDataContainer =
    // (PowerUsageHistoryResponseMessageDataContainer) unsignedOslpEnvelopeDto
    // .getExtraData();
    // final TimePeriod timePeriod = new
    // TimePeriod(powerUsageHistoryResponseMessageDataContainer.getStartTime(),
    // powerUsageHistoryResponseMessageDataContainer.getEndTime());
    // final HistoryTermType historyTermType =
    // powerUsageHistoryResponseMessageDataContainer.getHistoryTermType();
    //
    // final GetPowerUsageHistoryDeviceRequest deviceRequest = new
    // GetPowerUsageHistoryDeviceRequest(
    // organisationIdentification, deviceIdentification, correlationUid,
    // new PowerUsageHistoryMessageDataContainer(timePeriod, historyTermType),
    // domain, domainVersion,
    // messageType, ipAddress, retryCount, isScheduled);
    //
    // this.deviceService.doGetPowerUsageHistory(oslpEnvelope,
    // powerUsageHistoryResponseMessageDataContainer,
    // deviceRequest, deviceResponseHandler, ipAddress, domain, domainVersion,
    ...
    // protected void handleGetPowerUsageHistoryDeviceResponse(final
    // DeviceResponse deviceResponse,
    // final PowerUsageHistoryMessageDataContainer messageData,
    // final DeviceResponseMessageSender responseMessageSender, final String
    // domain, final String domainVersion,
    ...
    // final PowerUsageHistoryResponseMessageDataContainer
    // powerUsageHistoryResponseMessageDataContainerDto = null;
    // final Serializable dataObject;
    //
    // try {
    // final GetPowerUsageHistoryDeviceResponse response =
    // (GetPowerUsageHistoryDeviceResponse) deviceResponse;
    // this.deviceResponseService.handleDeviceMessageStatus(response.getStatus());
    // powerUsageHistoryResponseMessageDataContainerDto = new
    // PowerUsageHistoryResponseMessageDataContainer(
    ...
    // deviceResponse.getDeviceIdentification(), result, osgpException,
    // dataObject, isScheduled, retryCount);
    //
