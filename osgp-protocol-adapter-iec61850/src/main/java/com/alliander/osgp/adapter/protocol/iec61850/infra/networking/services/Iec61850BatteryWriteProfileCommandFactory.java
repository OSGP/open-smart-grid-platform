...
public class Iec61850BatteryWriteProfileCommandFactory implements RtuWriteCommandFactory<ProfileDto> {
    private static final Logger LOGGER = LoggerFactory.getLogger(Iec61850BatteryWriteProfileCommandFactory.class);
    ...
    private static Iec61850BatteryWriteProfileCommandFactory instance;

    private Iec61850BatteryWriteProfileCommandFactory() {
    }

    public static synchronized Iec61850BatteryWriteProfileCommandFactory getInstance() {
        if (instance == null) {
            instance = new Iec61850BatteryWriteProfileCommandFactory();
        }
        return instance;
    }
