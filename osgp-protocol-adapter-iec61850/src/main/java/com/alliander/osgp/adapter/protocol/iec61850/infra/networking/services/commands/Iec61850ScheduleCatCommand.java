...
public class Iec61850ScheduleCatCommand implements RtuReadCommand<MeasurementDto>, RtuWriteCommand<SetPointDto> {
    ...
    public Iec61850ScheduleCatCommand(final int index) {
        this.index = index;
    ...
    public MeasurementDto execute(final Iec61850Client client, final DeviceConnection connection,
        ...
        final NodeContainer containingNode = connection.getFcModelNode(logicalDevice, logicalDeviceIndex,
                this.logicalNode, DATA_ATTRIBUTE_RTU, FC);
    ...
    public MeasurementDto translate(final NodeContainer containingNode) {
        return new MeasurementDto(this.index, DATA_ATTRIBUTE.getDescription(), 0, new DateTime(DateTimeZone.UTC),
                containingNode.getInteger(SUB_DATA_ATTRIBUTE).getValue(), new ArrayList<PhaseDto>());
    }
