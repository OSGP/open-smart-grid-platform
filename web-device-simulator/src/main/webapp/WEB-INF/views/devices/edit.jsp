	...
	<div class="container">
		...
		<div class="navbar">
			<div class="navbar-inner">
				...
				<ul class="nav">
					<li class="active"><a href="/web-device-simulator/devices">Home</a></li>
		...
		<div class="row">
			<div class="offset1">
				...
				<div class="row">
					<div class="span10">
						<div class="messages">
							<div id="feedback" class="alert alert-success" style="display: none;"></div>
				...
				<div class="row">
					<div class="span10">
						<h1>
							<spring:message code="device.edit.page.title" />
						</h1>
					</div>
				</div>
						...
						<fieldset>
							...
							<form:form commandName="device" method="POST" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:label path="deviceIdentification" class="uneditable-input">
											<c:out value="${device.deviceIdentification}" />
										</form:label>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:select path="actualLinkType">
											<form:options />
										</form:select>
									</div>
								</div>
								...
								<div class="control-group">
									<form:label path="tariffOn" class="control-label">
										<spring:message code="entity.device.tariffOn" />
									</form:label>
									<div class="controls">
								...
								<div class="row">
									<div class="span4">
										<a href="/web-device-simulator/devices" class="btn"><spring:message code="device.list.link.label" /></a> <input type="submit" class="btn btn-primary"
				...
				<div class="row">
					<div class="span10">
						<fieldset>
							<legend>
								<spring:message code="device.edit.page.commands.label" />
							</legend>

							<div class="btn-group font-size13">
								<div class="control-label">
									<spring:message code="device.edit.page.commands.registerdevice.label" />
								</div>
								<div class="btn-group-controls">
									<div class="control-label">
										<spring:message code="device.edit.page.commands.registerdevice.hasschedule.label" />
									</div>
									<div class="controls">
										<input type="checkbox" id="hasSchedule" />
									</div>
									<button id="registerDevice" class="btn">
										<spring:message code="device.edit.page.commands.registerdevice.label" />
									</button>
									<button id="confirmDeviceRegistration" class="btn">
										<spring:message code="device.edit.page.commands.confirmdeviceregistration.label" />
									</button>
								</div>
							</div>
							...
							<div class="btn-group font-size13">
								<div class="control-label">
									<spring:message code="device.edit.page.commands.eventnotification.label" />
								</div>
								<div class="btn-group-controls">
									<div class="control-label">
										<spring:message code="device.edit.page.commands.eventnotification.event.label" />
									</div>
									<div class="controls">
										<select id="event">
									...
									<div class="control-label">
										<spring:message code="device.edit.page.commands.eventnotification.description.label" />
									</div>
									<div class="controls">
										<input id="description" />
									</div>
									<div class="control-label">
										<spring:message code="device.edit.page.commands.eventnotification.index.label" />
									</div>
									<div class="controls">
										<input id="index" />
									</div>
							...
							<div class="btn-group font-size13">
								<div class="control-label">
									<spring:message code="device.edit.page.commands.sequencenumber.label" />
								</div>
								<div class="btn-group-controls">
									<input id="sequenceNumber"></input>
									<button id="setSequenceNumber" class="btn">
										<spring:message code="device.edit.page.commands.setsequencenumber.label" />
									</button>
								</div>
							</div>
						</fieldset>
