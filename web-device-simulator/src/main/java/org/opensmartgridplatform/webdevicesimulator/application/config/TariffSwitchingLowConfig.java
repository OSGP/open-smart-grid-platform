...
public class TariffSwitchingLowConfig implements SchedulingConfigurer {
    ...
    public void configureTasks(final ScheduledTaskRegistrar taskRegistrar) {
        ...
        taskRegistrar.addCronTask(new CronTask(this.tariffSwitchingLow, this.tariffSwitchingLowTrigger()));
    }
    ...
    public TaskScheduler tariffSwitchingLowTaskScheduler() {
        ...
        tariffSwitchingLowTaskScheduler.setPoolSize(Integer.parseInt(
                this.environment.getRequiredProperty(PROPERTY_NAME_AUTONOMOUS_TARIFFSWITCHING_LOW_POOL_SIZE)));
        tariffSwitchingLowTaskScheduler.setThreadNamePrefix(
                this.environment.getRequiredProperty(PROPERTY_NAME_AUTONOMOUS_TARIFFSWITCHING_LOW_THREAD_NAME_PREFIX));
