...
public abstract class AbstractController {
     ...
     */
    protected void addErrorMessage(final RedirectAttributes model, final String code, final Object... params) {
     ...
     *            message.
     */
    protected void addFeedbackMessage(final RedirectAttributes model, final String code, final Object... params) {
        LOGGER.debug(ADDING_ERROR_MESSAGE_WITH_CODE + code + AND_PARAMS);
        for (final Object param : params) {
            LOGGER.debug(PARAM + param.getClass().toString());
        }
    ...
    /**
     * Replace empty strings "" (default behavior) with null values on model
     * binding
     */
    @InitBinder
