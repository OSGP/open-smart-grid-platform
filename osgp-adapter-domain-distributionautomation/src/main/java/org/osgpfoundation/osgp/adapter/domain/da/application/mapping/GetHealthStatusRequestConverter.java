...
public class GetHealthStatusRequestConverter extends BidirectionalConverter<GetHealthStatusRequest, GetHealthStatusRequestDto> {
    ...
    @Override
    public GetHealthStatusRequest convertFrom(final GetHealthStatusRequestDto source, final Type<GetHealthStatusRequest> destinationType) {
        return new GetHealthStatusRequest();
    }
