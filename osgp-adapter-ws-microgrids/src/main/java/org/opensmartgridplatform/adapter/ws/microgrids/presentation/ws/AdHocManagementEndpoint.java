...
public class AdHocManagementEndpoint {
    ...
    public GetDataAsyncResponse getData(@OrganisationIdentification final String organisationIdentification,
        ...
        try {
            final org.opensmartgridplatform.domain.microgrids.valueobjects.GetDataRequest dataRequest = this.mapper
                    .map(request, org.opensmartgridplatform.domain.microgrids.valueobjects.GetDataRequest.class);
    ...
    public GetDataResponse getGetDataResponse(@OrganisationIdentification final String organisationIdentification,
        ...
        try {
            ...
            final org.opensmartgridplatform.domain.microgrids.valueobjects.GetDataResponse dataResponse = this.service
    ...
    public SetDataAsyncResponse setData(@OrganisationIdentification final String organisationIdentification,
        ...
        try {
            final org.opensmartgridplatform.domain.microgrids.valueobjects.SetDataRequest setDataRequest = this.mapper
                    .map(request, org.opensmartgridplatform.domain.microgrids.valueobjects.SetDataRequest.class);
