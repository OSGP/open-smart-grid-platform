...
public class ResumeScheduleSteps {
  ...
  public void receivingAResumeScheduleRequest(final Map<String, String> requestParameters)
      throws Throwable {
    ...
    request.setIsImmediate(
        getBoolean(
            requestParameters,
            PlatformPubliclightingKeys.KEY_ISIMMEDIATE,
            PlatformPubliclightingDefaults.DEFAULT_ISIMMEDIATE));

    try {
      ScenarioContext.current()
          .put(PlatformPubliclightingKeys.RESPONSE, this.client.resumeSchedule(request));
  ...
  public void receivingASetResumeScheduleByAnUnknownOrganization(
  ...
  public void theResumeScheduleAsyncResponseContains(final Map<String, String> expectedResponseData)
      throws Throwable {
    final ResumeScheduleAsyncResponse asyncResponse =
        (ResumeScheduleAsyncResponse)
  ...
  public void thenThePlatformBuffersAResumeScheduleResponseMessage(
    ...
    Wait.until(
        () -> {
          ...
          try {
            response =
                this.getResponseWithCorrelationUID(
                    deviceIdentification,
                    (String)
                        ScenarioContext.current()
                            .get(PlatformPubliclightingKeys.KEY_CORRELATION_UID));
  ...
  public void theResumeScheduleAsyncResponseContainsSoapFault(
  ...
  public void thePlatformBuffersAGetResumeScheduleResponseMessageForDevice(
      final String deviceIdentification, final Map<String, String> expectedResult)
    ...
    try {
      this.getResponseWithCorrelationUID(
          deviceIdentification, asyncResponse.getAsyncResponse().getCorrelationUid());
    } catch (final SoapFaultClientException ex) {
      assertThat(ex.getFaultStringOrReason())
          .isEqualTo(getString(expectedResult, PlatformPubliclightingKeys.KEY_FAULTSTRING));
    }
  }

  private ResumeScheduleResponse getResponseWithCorrelationUID(
      final String deviceIdentification, final String correlationUID)
      throws InterruptedException, SoapFaultClientException {
