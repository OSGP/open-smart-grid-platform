...
@Configuration
@EnableJpaRepositories(entityManagerFactoryRef = "entityMgrFactWsPublicLighting", transactionManagerRef = "txMgrWsPublicLighting", basePackageClasses = {
        PublicLightingResponseDataRepository.class, ResponseDataRepository.class })
public class AdapterWsPublicLightingPersistenceConfig extends ApplicationPersistenceConfiguration {
    ...
    public JpaTransactionManager transactionManager(
            @Qualifier("entityMgrFactWsPublicLighting") final EntityManagerFactory barEntityManagerFactory) {
