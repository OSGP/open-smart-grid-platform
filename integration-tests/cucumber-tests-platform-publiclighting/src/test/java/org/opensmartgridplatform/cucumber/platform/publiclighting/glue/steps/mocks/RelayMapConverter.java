...
public class RelayMapConverter {
     ...
     *
     * @param indexAddressMap
     *            the IndexAddressMap to convert.
    ...
    /**
     * Converts two Strings to a relay map. The String containing the index and
     * address should conform to the following format: "index,address,relayType"
     * (without the quotes).
     *
     * @param relayMapString
     *            the index, address and relay type to convert.
     * @return the created RelayMap.
     */
