...
public class Iec60870DeviceFactory implements InitializingBean {
    ...
    @Autowired
    private Iec60870LightSensorDeviceCreator lightSensorCreator;

    @Autowired
    private Iec60870LightMeasurementRtuDeviceCreator lightMeasurementRtuCreator;

    @Autowired
    private Iec60870DistributionAutomationDeviceCreator daCreator;
