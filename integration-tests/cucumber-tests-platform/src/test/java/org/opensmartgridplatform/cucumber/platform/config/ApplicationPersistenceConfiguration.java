...
public abstract class ApplicationPersistenceConfiguration extends BaseApplicationConfiguration {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ApplicationPersistenceConfiguration.class);
  ...
  protected static final String PROPERTY_NAME_HIBERNATE_NAMING_STRATEGY =
  ...
  protected DataSource makeDataSource() {
    ...
    final DefaultConnectionPoolFactory factory =
        new DefaultConnectionPoolFactory.Builder()
            ...
            .withAutoCommit(this.databaseAutoCommit)
   ...
   */
  protected LocalContainerEntityManagerFactoryBean makeEntityManager(
      final String unitName, final DataSource dataSource) throws ClassNotFoundException {
    ...
    entityManagerFactoryBean.setPackagesToScan(
        this.getEntitymanagerPackagesToScan().split(REGEX_COMMA_WITH_OPTIONAL_WHITESPACE));
