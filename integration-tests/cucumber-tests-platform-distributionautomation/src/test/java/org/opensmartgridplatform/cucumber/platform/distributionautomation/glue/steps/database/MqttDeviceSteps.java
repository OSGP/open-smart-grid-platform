...
public class MqttDeviceSteps {
    ...
    public void anMQTTDevice(final Map<String, String> settings) {
        final Map<String, String> mqttSettings = SettingsHelper.addAsDefaults(settings, MQTT_DEFAULT_SETTINGS);
    ...
    private void addDeviceToProtocolAdapter(final Map<String, String> settings) {
        ...
        device.setHost(getString(settings, PlatformDistributionAutomationKeys.MQTT_HOST,
                PlatformDistributionAutomationDefaults.MQTT_HOST));
        device.setPort(getInteger(settings, PlatformDistributionAutomationKeys.MQTT_PORT,
        ...
        device.setQos(getString(settings, PlatformDistributionAutomationKeys.MQTT_QOS,
