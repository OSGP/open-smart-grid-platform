...
@EnableJpaRepositories(
    entityManagerFactoryRef = "entityMgrFactKafkaDistributionAutomation",
    transactionManagerRef = "txMgrKafkaDistributionAutomation",
    basePackageClasses = {LocationRepository.class})
public class AdapterKafkaDistributionAutomationPersistenceConfig
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(
      @Qualifier("dsKafkaDistributionAutomation") final DataSource dataSource)
  ...
  public JpaTransactionManager transactionManager(
      @Qualifier("entityMgrFactKafkaDistributionAutomation")
