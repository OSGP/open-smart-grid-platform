...
public class FilterFactories {
     ...
     */
    public static Filter createFilter(final String filterFactoryFqcn, final FilterFactoryParams params)
            throws FilterFactory.FilterNotCreatedException {
     ...
     *
     */
    public static Filter createFilter(final Class<? extends FilterFactory> filterFactoryClass,
            final FilterFactoryParams params) throws FilterFactory.FilterNotCreatedException {
        final FilterFactory filterFactory = createFilterFactory(filterFactoryClass);

        return filterFactory.createFilter(params);
    }

    static FilterFactory createFilterFactory(final String filterFactoryFqcn) throws FilterNotCreatedException {
