...
public class SetPointBuilder {
    ...
    public SetPointBuilder withSettings(final Map<String, String> settings, final int systemIndex) {
        ...
        final int numberOfSetPoints = SettingsHelper.getIntegerValue(settings, PlatformKeys.KEY_NUMBER_OF_SET_POINTS,
                systemIndex);
    ...
    private SetPointBuilder withSettings(final Map<String, String> settings, final int systemIndex, final int index) {
        ...
        this.withStartTime(
                SettingsHelper.getXmlGregorianCalendarValue(settings, PlatformKeys.KEY_SETPOINT_START_TIME, indexes));
        this.withEndTime(SettingsHelper.getXmlGregorianCalendarValue(settings, PlatformKeys.KEY_SETPOINT_END_TIME, indexes));
        ...
        this.withValue(SettingsHelper.getDoubleValue(settings, PlatformKeys.KEY_SETPOINT_VALUE, indexes));
