...
Feature: SmartMetering Bundle - GetAdministrativeStatus
  ...
  Scenario Outline: Get administrative status of a <protocol> <version> device in a bundle request
    Given a dlms device
  ...
  Scenario: Get administrative status of a DSMR 2.2 device in a bundle request
    Given a dlms device
