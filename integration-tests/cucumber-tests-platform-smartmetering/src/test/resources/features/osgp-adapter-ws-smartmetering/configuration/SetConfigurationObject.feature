...
Feature: SmartMetering Configuration - SetConfigurationObject
  ...
  Scenario Outline: Set configuration object on a <protocol> <version> device
    ...
    When the set configuration object request is received
      ...
      | ConfigurationFlagType_4    | HLS_6_ON_P3_ENABLE        |
      | ConfigurationFlagEnabled_4 | <H6P3_r>                  |
    ...
    And device simulation should have values in a <valueType> type value attribute of the configuration object
      ...
      | ConfigurationFlagEnabled_15 | false                     |
    Examples:
      | deviceIdentification | protocol | version | valueType | flagsInitiallyOnSim | OPMO      | OPMO_r    | OPMO_1    | DOPO  | DOPO_r | DOPO_1 | P0EN  | P0EN_r | P0EN_1 | DAPO  | DAPO_r | DAPO_1 | H6P3  | H6P3_r | H6P3_1 |
      | TEST1024000000001    | DSMR     | 4.2.2   | structure | 10                  | ALWAYS_ON | TRIGGERED | TRIGGERED | true  | true   | true   | false | false  | false  | false |        | false  | false |        | false  |
      | TEST1024000000001    | DSMR     | 4.2.2   | structure | 10                  | ALWAYS_ON | TRIGGERED | TRIGGERED | true  |        | true   | false |        | false  | false |        | false  | false |        | false  |
      | TEST1024000000001    | DSMR     | 4.2.2   | structure | 10                  | ALWAYS_ON |           | ALWAYS_ON | true  | true   | true   | false | false  | false  | false |        | false  | false |        | false  |
      | TEST1031000000001    | SMR      | 4.3     | structure | 11                  | TRIGGERED | ALWAYS_ON | ALWAYS_ON | true  | true   | true   | false | false  | false  | false  | true  | true  | false |        | false  |
      | TEST1027000000001    | SMR      | 5.0.0   | bitstring | 15                  |           |           |           | false |        | false  | true  | true   | true   | true  | true   | true   | true  | false  | false  |
      | TEST1028000000001    | SMR      | 5.1     | bitstring | 15                  |           |           |           | false |        | false  | true  | true   | true   | false |        | false  | false | true   | true   |
