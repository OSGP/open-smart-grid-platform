...
public class DeviceFactory {
    ...
    public static Device fromParameterMap(final Map<String, String> requestParameters) {
        ...
        device.setAuthenticationKey(
                RequestFactoryHelper.hexDecodeDeviceKey(settings.get(PlatformKeys.KEY_DEVICE_AUTHENTICATIONKEY),
                        PlatformKeys.KEY_DEVICE_AUTHENTICATIONKEY));
        device.setGlobalEncryptionUnicastKey(
                RequestFactoryHelper.hexDecodeDeviceKey(settings.get(PlatformKeys.KEY_DEVICE_ENCRYPTIONKEY),
        ...
        device.setMbusDefaultKey(
                RequestFactoryHelper.hexDecodeDeviceKey(settings.get(PlatformSmartmeteringKeys.MBUS_DEFAULT_KEY),
