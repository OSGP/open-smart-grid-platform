...
/**
 * Keys specific for the dlms related data. Note: Keep in mind that generic keys should be specified
 * in the cucumber-tests-platform project.
 */
public class PlatformSmartmeteringKeys
    extends org.opensmartgridplatform.cucumber.platform.PlatformKeys {
  ...
  public static final String ACTIVITY_CALENDAR_ACTIVATE_PASSIVE_CALENDAR_TIME =
  ...
  public static final String NUMBER_OF_CAPTURE_OBJECTS = "NumberOfCaptureObjects";
  public static final String CAPTURE_OBJECT_CLASS_ID = "CaptureObject_ClassId";
  public static final String CAPTURE_OBJECT_LOGICAL_NAME = "CaptureObject_LogicalName";
