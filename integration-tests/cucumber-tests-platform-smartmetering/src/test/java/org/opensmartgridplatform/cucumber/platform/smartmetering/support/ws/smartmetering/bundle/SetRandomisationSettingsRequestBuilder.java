...
public class SetRandomisationSettingsRequestBuilder {
    ...
    public SetRandomisationSettingsRequestBuilder fromParameterMap(final Map<String, String> parameters) {
        this.directAttach = Integer.parseInt(parameters.get(PlatformKeys.KEY_DIRECT_ATTACH));
        this.randomisationStartWindow = Integer.parseInt(parameters.get(PlatformKeys.KEY_RANDOMISATION_START_WINDOW));
        this.multiplicationFactor = Integer.parseInt(parameters.get(PlatformKeys.KEY_MULTIPLICATION_FACTOR));
