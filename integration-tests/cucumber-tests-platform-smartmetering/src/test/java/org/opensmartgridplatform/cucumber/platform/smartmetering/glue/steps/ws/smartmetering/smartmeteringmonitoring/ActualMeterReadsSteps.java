...
public class ActualMeterReadsSteps {
  ...
  private SmartMeteringMonitoringRequestClient<
          ActualMeterReadsAsyncResponse, ActualMeterReadsRequest>
      requestClient;

  @Autowired
  private SmartMeteringMonitoringResponseClient<
          ActualMeterReadsResponse, ActualMeterReadsAsyncRequest>
      responseClient;
  ...
  public void theGetActualMeterReadsRequestIsReceived(final Map<String, String> settings)
      throws Throwable {
    final ActualMeterReadsRequest request =
        ActualMeterReadsRequestFactory.fromParameterMap(settings);
  ...
  public void theGetActualMeterReadsRequestGeneratingAnErrorIsReceived(
    ...
    final ActualMeterReadsAsyncRequest actualMeterReadsAsyncRequest =
        ActualMeterReadsRequestFactory.fromScenarioContext();
    assertThat(actualMeterReadsAsyncRequest)
        .as("ActualMeterReadsAsyncRequest should not be null")
        .isNotNull();

    try {
      final ActualMeterReadsResponse response =
  ...
  public void theActualMeterReadsResultShouldBeReturned(final Map<String, String> settings)
    ...
    final ActualMeterReadsAsyncRequest asyncRequest =
        ActualMeterReadsRequestFactory.fromScenarioContext();
    ...
    assertThat(response.getActiveEnergyExport())
        .as("ActiveEnergyExport should not be null")
        .isNotNull();
    assertThat(response.getActiveEnergyExportTariffOne())
        .as("ActiveEnergyExportTariffOne should not be null")
        .isNotNull();
    assertThat(response.getActiveEnergyExportTariffTwo())
        .as("ActiveEnergyExportTariffTwo should not be null")
        .isNotNull();
    assertThat(response.getActiveEnergyImport())
        .as("ActiveEnergyImport should not be null")
        .isNotNull();
    assertThat(response.getActiveEnergyImportTariffOne())
        .as("ActiveEnergyImportTariffOne should not be null")
        .isNotNull();
    assertThat(response.getActiveEnergyImportTariffTwo())
        .as("ActiveEnergyimportTariffTwo should not be null")
        .isNotNull();
