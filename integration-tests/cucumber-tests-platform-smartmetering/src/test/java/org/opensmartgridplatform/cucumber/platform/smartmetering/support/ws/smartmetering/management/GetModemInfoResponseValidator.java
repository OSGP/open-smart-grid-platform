...
public class GetModemInfoResponseValidator {
    ...
    public static void validate(final GetModemInfoResponseData response, final Map<String, String> expectedValues) {
        for (final Map.Entry<String, String> expectedEntyValue : expectedValues.entrySet()) {
            ...
            case "packetSwitchedStatus":
                assertThat(response.getPacketSwitchedStatus()).isEqualTo(PacketSwitchedStatus.fromValue(expectedValue));
                break;
            case "cellId":
            ...
            case "captureTime":
                try {
                    assertThat(response.getCaptureTime()).isEqualTo(DatatypeFactory.newInstance()
                            .newXMLGregorianCalendar(expectedValue));
