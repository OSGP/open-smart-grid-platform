...
public class ClearAlarmRegisterRequestFactory {
    ...
    public static ClearAlarmRegisterAsyncRequest fromScenarioContext() {
        final ClearAlarmRegisterAsyncRequest clearAlarmRegisterAsyncRequest = new ClearAlarmRegisterAsyncRequest();
        clearAlarmRegisterAsyncRequest.setCorrelationUid(RequestFactoryHelper.getCorrelationUidFromScenarioContext());
