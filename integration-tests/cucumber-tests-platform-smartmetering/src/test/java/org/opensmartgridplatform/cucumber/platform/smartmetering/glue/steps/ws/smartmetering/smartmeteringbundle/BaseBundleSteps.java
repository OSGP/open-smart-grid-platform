...
public class BaseBundleSteps {
  ...
  @Autowired protected SmartMeteringBundleClient client;

  @Autowired protected MapperFacade mapperFacade;

  protected void ensureBundleResponse()
  ...
  protected Response getNextBundleResponse()
    ...
    final BundleResponse bundleResponse =
