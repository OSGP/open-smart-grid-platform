...
public class DlmsDeviceSteps {
    ...
    private void createDlmsDeviceInProtocolAdapterDatabase(final Map<String, String> inputSettings) {
        ...
        Base.exec("INSERT INTO encrypted_secret (device_identification,secret_type,encoded_secret,creation_time,encryption_key_reference_id)" +
                ...
                "('TEST1024000000001'd, 'E_METER_ENCRYPTION_KEY_UNICAST', '867424ac75b6d53c89276d304608321f0a1f6e401f453f84adf3477c7ee1623c', NOW(), (SELECT id FROM public.encryption_key_reference where encryption_provider_type = 'JRE'))," +
