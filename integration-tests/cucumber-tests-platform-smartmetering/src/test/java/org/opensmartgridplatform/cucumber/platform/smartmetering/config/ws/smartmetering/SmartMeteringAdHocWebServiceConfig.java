...
public class SmartMeteringAdHocWebServiceConfig extends BaseWebServiceConfig {
  ...
  public DefaultWebServiceTemplateFactory smartMeteringAdHocWebServiceTemplateFactory() {
    return new DefaultWebServiceTemplateFactory.Builder()
        .setMarshaller(this.smartMeteringAdHocMarshaller())
        .setMessageFactory(this.messageFactory())
        .setTargetUri(
            this.baseUri.concat(this.configuration.webserviceTemplateDefaultUriSmartMeteringAdHoc))
  ...
  /**
   * Method for creating the Marshalling Payload Method Processor for SmartMetering AdHoc
   * webservice.
   *
