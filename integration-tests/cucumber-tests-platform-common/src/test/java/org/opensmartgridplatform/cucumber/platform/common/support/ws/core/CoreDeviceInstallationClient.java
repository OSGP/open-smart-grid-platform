...
public class CoreDeviceInstallationClient extends BaseClient {
  ...
  @Autowired private DefaultWebServiceTemplateFactory coreDeviceInstallationWstf;
  ...
  public AddDeviceResponse addDevice(
      final AddDeviceRequest request, final String organizationIdentification)
      throws WebServiceSecurityException {
    final WebServiceTemplate wst =
        this.coreDeviceInstallationWstf.getTemplate(organizationIdentification, this.getUserName());
  ...
  public UpdateDeviceResponse updateDevice(final UpdateDeviceRequest request)
      throws WebServiceSecurityException {
    final WebServiceTemplate wst =
        this.coreDeviceInstallationWstf.getTemplate(
  ...
  public AddLightMeasurementDeviceResponse addLightMeasurementDevice(
      final AddLightMeasurementDeviceRequest request) throws WebServiceSecurityException {
    return this.addLightMeasurementDevice(request, this.getOrganizationIdentification());
  }

  public AddLightMeasurementDeviceResponse addLightMeasurementDevice(
      final AddLightMeasurementDeviceRequest request, final String organizationIdentification)
      throws WebServiceSecurityException {
    final WebServiceTemplate wst =
        this.coreDeviceInstallationWstf.getTemplate(organizationIdentification, this.getUserName());
  ...
  public StartDeviceTestAsyncResponse startDeviceTest(
      final StartDeviceTestRequest request, final String organizationIdentification)
      throws WebServiceSecurityException {
    final WebServiceTemplate wst =
        this.coreDeviceInstallationWstf.getTemplate(
            this.getOrganizationIdentification(), this.getUserName());
  ...
  public StartDeviceTestResponse getStartDeviceTestResponse(
      final StartDeviceTestAsyncRequest request) throws WebServiceSecurityException {
    final WebServiceTemplate wst =
        this.coreDeviceInstallationWstf.getTemplate(
            this.getOrganizationIdentification(), this.getUserName());
