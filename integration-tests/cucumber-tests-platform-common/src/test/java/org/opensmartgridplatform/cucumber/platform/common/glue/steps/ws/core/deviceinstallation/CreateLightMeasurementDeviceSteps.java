...
public class CreateLightMeasurementDeviceSteps {
    ...
    private LightMeasurementDevice createLightMeasurementDevice(final Map<String, String> settings) {
        ...
        lmd.setDeviceIdentification(getString(settings, PlatformKeys.KEY_DEVICE_IDENTIFICATION,
                PlatformCommonDefaults.DEFAULT_DEVICE_IDENTIFICATION));
        ...
        lmd.setDescription(
                getString(settings, PlatformKeys.KEY_LMD_DESCRIPTION, PlatformCommonDefaults.DEFAULT_LMD_DESCRIPTION));
        ...
        lmd.setDigitalInput(getShort(settings, PlatformKeys.KEY_LMD_DIGITAL_INPUT,
