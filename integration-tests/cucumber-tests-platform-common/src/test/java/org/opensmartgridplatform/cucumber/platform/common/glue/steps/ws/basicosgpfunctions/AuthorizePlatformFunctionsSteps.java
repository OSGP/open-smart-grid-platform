...
public class AuthorizePlatformFunctionsSteps {
  ...
  @Autowired private CoreFirmwareManagementClient firmwareManagementClient;

  private static final Logger LOGGER =
      LoggerFactory.getLogger(AuthorizePlatformFunctionsSteps.class);
  ...
  private void createOrganisation(final Map<String, String> requestParameters)
    ...
    organisation.setOrganisationIdentification(
  ...
  private void getOrganisations(final Map<String, String> requestParameters)
    ...
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE,
            this.adminDeviceManagementClient.findAllOrganizations(
                new FindAllOrganisationsRequest()));
  }
  ...
  private void getMessages(final Map<String, String> requestParameters)
    ...
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE, this.adminDeviceManagementClient.findMessageLogs(request));
  }
  ...
  private void getDevicesWithoutOwner(final Map<String, String> requestParameters)
    ...
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE,
            this.adminDeviceManagementClient.findDevicesWithoutOwner(
                new FindDevicesWhichHaveNoOwnerRequest()));
  }
  ...
  private void setOwner(final Map<String, String> requestParameters)
    ...
    ScenarioContext.current()
        .put(PlatformCommonKeys.RESPONSE, this.adminDeviceManagementClient.setOwner(request));
  }
  ...
  private void removeFirmware(final Map<String, String> requestParameters)
  ...
  private void createFirmware(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
    ...
    request.setFirmware(firmware);
    ScenarioContext.current()
        .put(PlatformCommonKeys.RESPONSE, this.firmwareManagementClient.addFirmware(request));
  }

  private void getFirmware(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
    final FindFirmwareRequest request = new FindFirmwareRequest();
    request.setFirmwareId(PlatformCommonDefaults.FIRMWARE_ID);
    ScenarioContext.current()
        .put(PlatformCommonKeys.RESPONSE, this.firmwareManagementClient.findFirmware(request));
  }

  private void changeDeviceModel(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
  ...
  private void removeDeviceModel(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
  ...
  private void createDeviceModel(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
  ...
  private void getDeviceModels(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE,
  ...
  private void updateDeviceProtocol(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
  ...
  private void getProtocolInfos(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE,
  ...
  private void getManufacturers(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE,
            this.adminDeviceManagementClient.findAllManufacturers(
                new FindAllManufacturersRequest()));
  }

  private void changeManufacturer(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
  ...
  private void removeManufacturer(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
  ...
  private void createManufacturer(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
    ...
    ScenarioContext.current()
        .put(
            PlatformCommonKeys.RESPONSE, this.adminDeviceManagementClient.addManufacturer(request));
  }

  private void findScheduledTasks(final Map<String, String> requestParameters)
      throws WebServiceSecurityException {
