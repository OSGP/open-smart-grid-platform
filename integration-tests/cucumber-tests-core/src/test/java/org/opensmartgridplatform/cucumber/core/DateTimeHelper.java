...
public class DateTimeHelper {
  ...
  public static ZonedDateTime getZonedDateTime2(
      final String startDate, final ZonedDateTime defaultStartDate) {
    return dateTimeToZonedDateTime(getDateTime2(startDate, defaultStartDate));
  }
  ...
  public static ZonedDateTime getSunriseSunsetZonedDateTime(
      final String actionTimeType, final ZonedDateTime date, final Location location) {
    return dateTimeToZonedDateTime(getSunriseSunsetTime(actionTimeType, date, location));
  }
  ...
  public static ZonedDateTime dateTimeToZonedDateTime(final ZonedDateTime dateTime) {
    return dateTime;
  }
}
