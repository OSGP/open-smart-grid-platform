...
public class ObjectMessageBuilder {
    ...
    public ObjectMessageBuilder withOrganisationIdentification(final String organisationIdentification) {
    ...
    public ObjectMessage build() throws JMSException {
        ...
        message.setStringProperty(Constants.ORGANISATION_IDENTIFICATION, this.organisationIdentification);
