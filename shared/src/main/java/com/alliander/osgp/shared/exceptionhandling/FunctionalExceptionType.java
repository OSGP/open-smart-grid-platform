...
public enum FunctionalExceptionType {
    ...
    UNEXPECTED_EXCEPTION_DURING_ENCRYPTION(803, "UNEXPECTED_EXCEPTION_DURING_ENCRYPTION"),
    UNEXPECTED_EXCEPTION_DURING_DECRYPTION(804, "UNEXPECTED_EXCEPTION_DURING_DECRYPTION"),
    UNEXPECTED_EXCEPTION_WHEN_READING_KEY(805, "UNEXPECTED_EXCEPTION_WHEN_READING_KEY");
