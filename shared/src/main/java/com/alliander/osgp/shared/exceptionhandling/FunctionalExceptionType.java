...
public enum FunctionalExceptionType {
    ...
    GATEWAY_DEVICE_NOT_SET_FOR_MBUS_DEVICE(218, "GATEWAY_DEVICE_NOT_SET_FOR_MBUS_DEVICE"),
    GATEWAY_DEVICE_INVALID_FOR_MBUS_DEVICE(219, "GATEWAY_DEVICE_INVALID_FOR_MBUS_DEVICE"),
