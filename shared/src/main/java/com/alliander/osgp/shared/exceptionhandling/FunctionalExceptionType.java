...
public enum FunctionalExceptionType {
    ...
    CHALLENGE_LENGHT_OUT_OF_RANGE(213, "CHALLENGE_LENGHT_OUT_OF_RANGE"),
    ...
    INVALID_ICCID(408, "INVALID_ICCID"),
    SESSION_INFO_NULL(409, "SESSION_INFO_NULL"),
    ERROR_RETRIEVING_ATTRIBUTE_VALUE(410, "ERROR_RETRIEVING_ATTRIBUTE_VALUE"),
    ...
    // Key exceptions
    INVALID_KEY(801, "INVALID_KEY"),
    WRONG_KEY_FORMAT(802, "WRONG_KEY_FORMAT"),
    UNEXPECTED_EXCEPTION_DURING_ENCRYPTION(803, "Unexpected exception during encryption"),
    UNEXPECTED_EXCEPTION_DURING_DECRYPTION(804, "Unexpected exception during decryption"),
    UNEXPECTED_EXCEPTION_WHEN_READING_KEY(805, "Unexpected exception when reading key");
