...
public class MessageMetadata implements Serializable {
    ...
    public String toString() {
        return new StringBuilder()
                .append("MessageMetadata [correlationUid=").append(this.correlationUid)
                .append(", organisationIdentification=").append(this.organisationIdentification)
                .append(", deviceIdentification=").append(this.deviceIdentification)
                .append(", messageType=").append(this.messageType)
                .append(", domain=").append(this.domain)
                .append(", domainVersion=").append(this.domainVersion)
                .append(", ipAddress=").append(this.ipAddress)
                .append(", messagePriority=").append(this.messagePriority)
                .append(", scheduled=").append(this.scheduled)
                .append(", scheduleTime=").append(this.scheduleTime)
                .append(", bypassRetry=").append(this.bypassRetry)
