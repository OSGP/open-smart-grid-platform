...
public class GetProfileGenericDataRequestBuilder {
    ...
    public GetProfileGenericDataRequestBuilder fromParameterMap(final Map<String, String> parameterMap)
        ...
        this.beginDate = DateConverter.createXMLGregorianCalendar(sdf.parse(parameterMap.get(Keys.KEY_BEGIN_DATE)));
        this.endDate = DateConverter.createXMLGregorianCalendar(sdf.parse(parameterMap.get(Keys.KEY_END_DATE)));
        this.obisCodeValues = new ObisCodeValuesBuilder()
                .withObisCodeA(Short.parseShort(parameterMap.get(Keys.OBIS_CODE_A)))
                .withObisCodeB(Short.parseShort(parameterMap.get(Keys.OBIS_CODE_B)))
                .withObisCodeC(Short.parseShort(parameterMap.get(Keys.OBIS_CODE_C)))
                .withObisCodeD(Short.parseShort(parameterMap.get(Keys.OBIS_CODE_D)))
                .withObisCodeE(Short.parseShort(parameterMap.get(Keys.OBIS_CODE_E)))
                .withObisCodeF(Short.parseShort(parameterMap.get(Keys.OBIS_CODE_F))).build();
