...
public class DeviceLogItemSteps {
    ...
    @Autowired
    com.alliander.osgp.platform.cucumber.steps.database.DeviceLogItemSteps deviceLogItemSteps;
    ...
    public void theGetAdministrativeStatusCommunicationForDeviceShouldBeInTheDeviceLogItemTable(
        ...
        this.deviceLogItemSteps.theGetAdministrativeStatusCommunicationForDeviceShouldBeInTheDeviceLogItemTable(deviceIdentification);
    }
    ...
    public void theGetAdministrativeStatusCommunicationForDeviceShouldNotBeInTheDeviceLogItemTable(
            final String deviceIdentification) throws Throwable {
        this.deviceLogItemSteps.theGetAdministrativeStatusCommunicationForDeviceShouldNotBeInTheDeviceLogItemTable(deviceIdentification);
    }
}
