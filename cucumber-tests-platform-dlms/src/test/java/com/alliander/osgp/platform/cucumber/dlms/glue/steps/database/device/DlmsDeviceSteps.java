 ...
 */
package com.alliander.osgp.platform.cucumber.dlms.glue.steps.database.device;
...
import com.alliander.osgp.platform.cucumber.dlms.Defaults;
import com.alliander.osgp.platform.cucumber.dlms.Keys;
import com.alliander.osgp.platform.cucumber.dlms.builders.entities.DeviceBuilder;
import com.alliander.osgp.platform.cucumber.dlms.builders.entities.DlmsDeviceBuilder;
import com.alliander.osgp.platform.cucumber.dlms.builders.entities.SmartMeterBuilder;
...
public class DlmsDeviceSteps {
    ...
    private void createDeviceAuthorisationInCoreDatabase(final Device device) {
        final Organisation organisation = this.organisationRepo
                .findByOrganisationIdentification(com.alliander.osgp.platform.cucumber.Defaults.DEFAULT_ORGANIZATION_IDENTIFICATION);
