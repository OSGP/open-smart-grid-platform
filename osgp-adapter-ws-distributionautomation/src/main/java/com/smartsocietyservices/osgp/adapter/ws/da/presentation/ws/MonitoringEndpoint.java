...
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesRequest;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesAsyncResponse;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesAsyncRequest;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesResponse;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesPeriodicRequest;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesPeriodicAsyncResponse;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesPeriodicAsyncRequest;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetPQValuesPeriodicResponse;
...
public class MonitoringEndpoint extends GenericDistributionAutomationEndPoint {
    ...
    public GetPQValuesAsyncResponse getPQValues( @OrganisationIdentification final String organisationIdentification,
        ...
        try {
            final com.smartsocietyservices.osgp.domain.da.valueobjects.GetPQValuesRequest getPQValue = this.mapper.map( request, com.smartsocietyservices.osgp.domain.da.valueobjects.GetPQValuesRequest.class );
    ...
    public GetPQValuesPeriodicAsyncResponse getPQValuesPeriodic( @OrganisationIdentification final String organisationIdentification,
        ...
        try {
            final com.smartsocietyservices.osgp.domain.da.valueobjects.GetPQValuesPeriodicRequest getPQValuesPeriodicRequest = this.mapper.map( request, com.smartsocietyservices.osgp.domain.da.valueobjects.GetPQValuesPeriodicRequest.class );
