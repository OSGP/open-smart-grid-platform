...
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetHealthStatusAsyncRequest;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetHealthStatusResponse;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetHealthStatusRequest;
import com.smartsocietyservices.osgp.adapter.ws.schema.distributionautomation.generic.GetHealthStatusAsyncResponse;
...
public class DeviceManagementEndpoint extends GenericDistributionAutomationEndPoint  {
    ...
    public GetHealthStatusAsyncResponse getHealthStatus( @OrganisationIdentification final String organisationIdentification,
        ...
        try {
            final com.smartsocietyservices.osgp.domain.da.valueobjects.GetHealthStatusRequest getHealthStatusRequest = this.mapper.map( request, com.smartsocietyservices.osgp.domain.da.valueobjects.GetHealthStatusRequest.class );
