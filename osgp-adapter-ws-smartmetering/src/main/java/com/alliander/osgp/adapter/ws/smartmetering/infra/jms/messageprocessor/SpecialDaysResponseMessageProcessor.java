...
public class SpecialDaysResponseMessageProcessor extends DomainResponseMessageProcessor {
     ...
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(SpecialDaysResponseMessageProcessor.class);
    ...
    public void processMessage(final ObjectMessage objectMessage) throws JMSException {
        LOGGER.debug("Processing smart metering special days data response message");
