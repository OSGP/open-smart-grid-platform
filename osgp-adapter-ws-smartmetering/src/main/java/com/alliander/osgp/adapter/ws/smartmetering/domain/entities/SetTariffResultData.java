...
public class SetTariffResultData extends AbstractEntity {
    ...
    private SetTariffResultData() {

    }

    public SetTariffResultData(final String organisationIdentification, final String messageType,
