...
public class ActionMapperResponseService {
    ...
    private void postConstruct() {
        ...
        CLASS_TO_MAPPER_MAP.put(EventMessageResponseListDto.class, this.managementMapper);
        ...
        CLASS_TO_MAPPER_MAP.put(GetConfigurationResponseListDto.class, this.monitoringMapper);
        CLASS_TO_MAPPER_MAP.put(FirmwareVersionResponseListDto.class, this.monitoringMapper);
    ...
    static {
        ...
        CLASS_MAP.put(EventMessageResponseListDto.class,
        ...
        CLASS_MAP.put(GetConfigurationResponseListDto.class,
                com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.GetConfigurationResponseData.class);
        CLASS_MAP.put(FirmwareVersionResponseListDto.class,
    ...
    public BundleResponse mapAllActions(final Serializable actionList) throws FunctionalException {
        ...
        final BundleResponseMessagesResponseListDto bundleResponseMessageDataContainer = (BundleResponseMessagesResponseListDto) actionList;
