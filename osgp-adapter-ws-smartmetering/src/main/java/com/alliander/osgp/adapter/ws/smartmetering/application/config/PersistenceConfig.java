 ...
 */
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackageClasses = { PeriodicMeterDataRepository.class, SynchronizeTimeDataRepository.class})
@Configuration
