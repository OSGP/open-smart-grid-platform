...
public class MessagingConfig extends AbstractMessagingConfig {
    ...
    // "jms.default.initial.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_DEFAULT_MAXIMUM_REDELIVERIES =
    // "jms.default.maximum.redeliveries";
    // private static final String
    // PROPERTY_NAME_JMS_DEFAULT_MAXIMUM_REDELIVERY_DELAY =
    // "jms.default.maximum.redelivery.delay";
    // private static final String PROPERTY_NAME_JMS_DEFAULT_REDELIVERY_DELAY =
    // "jms.default.redelivery.delay";

    // JMS Settings: Smart Metering logging
    private static final String PROPERTY_NAME_JMS_SMART_METERING_LOGGING_PREFIX = "jms.smartmetering.logging.";

    private static final String PROPERTY_NAME_JMS_SMART_METERING_LOGGING_QUEUE = "jms.smartmetering.logging.queue";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_EXPLICIT_QOS_ENABLED =
    // "jms.smartmetering.logging.explicit.qos.enabled";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_DELIVERY_PERSISTENT =
    // "jms.smartmetering.logging.delivery.persistent";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_TIME_TO_LIVE =
    // "jms.smartmetering.logging.time.to.live";

    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_INITIAL_REDELIVERY_DELAY =
    // "jms.smartmetering.logging.initial.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_MAXIMUM_REDELIVERIES =
    // "jms.smartmetering.logging.maximum.redeliveries";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_MAXIMUM_REDELIVERY_DELAY =
    // "jms.smartmetering.logging.maximum.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_LOGGING_REDELIVERY_DELAY =
    // "jms.smartmetering.logging.redelivery.delay";
    ...
    private static final String PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_PREFIX = "jms.smartmetering.requests.";

    private static final String PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_QUEUE = "jms.smartmetering.requests.queue";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_EXPLICIT_QOS_ENABLED =
    // "jms.smartmetering.requests.explicit.qos.enabled";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_DELIVERY_PERSISTENT =
    // "jms.smartmetering.requests.delivery.persistent";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_TIME_TO_LIVE =
    // "jms.smartmetering.requests.time.to.live";

    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_INITIAL_REDELIVERY_DELAY =
    // "jms.smartmetering.requests.initial.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_MAXIMUM_REDELIVERIES =
    // "jms.smartmetering.requests.maximum.redeliveries";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_MAXIMUM_REDELIVERY_DELAY =
    // "jms.smartmetering.requests.maximum.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_REDELIVERY_DELAY =
    // "jms.smartmetering.requests.redelivery.delay";
    ...
    private static final String PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_PREFIX = "jms.smartmetering.responses.";

    private static final String PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_QUEUE = "jms.smartmetering.responses.queue";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_EXPLICIT_QOS_ENABLED =
    // "jms.smartmetering.responses.explicit.qos.enabled";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_DELIVERY_PERSISTENT =
    // "jms.smartmetering.responses.delivery.persistent";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_TIME_TO_LIVE =
    // "jms.smartmetering.responses.time.to.live";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_RECEIVE_TIMEOUT =
    // "jms.smartmetering.responses.receive.timeout";

    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_CONCURRENT_CONSUMERS =
    // "jms.smartmetering.responses.concurrent.consumers";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_MAX_CONCURRENT_CONSUMERS =
    // "jms.smartmetering.responses.max.concurrent.consumers";
    //
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_INITIAL_REDELIVERY_DELAY =
    // "jms.smartmetering.responses.initial.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_MAXIMUM_REDELIVERIES =
    // "jms.smartmetering.responses.maximum.redeliveries";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_MAXIMUM_REDELIVERY_DELAY =
    // "jms.smartmetering.responses.maximum.redelivery.delay";
    // private static final String
    // PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_REDELIVERY_DELAY =
    // "jms.smartmetering.responses.redelivery.delay";
    ...
    public ActiveMQDestination smartMeteringResponsesQueue() {
        return new ActiveMQQueue(
                this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_QUEUE));
    }
    ...
    public RedeliveryPolicy smartMeteringLoggingRedeliveryPolicy() {
        final RedeliveryPolicy redeliveryPolicy = super.createCustomRedeliveryPolicy(
                PROPERTY_NAME_JMS_SMART_METERING_LOGGING_PREFIX);
        ...
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_MAXIMUM_REDELIVERIES)));
        ...
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_REDELIVERY_DELAY)));
        redeliveryPolicy.setDestination(this.smartMeteringLoggingQueue());
        redeliveryPolicy.setBackOffMultiplier(Double.parseDouble(
                this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_BACK_OFF_MULTIPLIER)));
    ...
    public RedeliveryPolicy smartMeteringRequestsRedeliveryPolicy() {
        final RedeliveryPolicy redeliveryPolicy = super.createCustomRedeliveryPolicy(
                PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_PREFIX);
        // redeliveryPolicy.setInitialRedeliveryDelay(Long.parseLong(this.environment
        // .getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_INITIAL_REDELIVERY_DELAY)));
        // redeliveryPolicy.setMaximumRedeliveries(Integer.parseInt(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_MAXIMUM_REDELIVERIES)));
        // redeliveryPolicy.setMaximumRedeliveryDelay(Long.parseLong(this.environment
        // .getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_MAXIMUM_REDELIVERY_DELAY)));
        // redeliveryPolicy.setRedeliveryDelay(Long.parseLong(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_REDELIVERY_DELAY)));
        redeliveryPolicy.setDestination(this.smartMeteringRequestsQueue());
        redeliveryPolicy.setBackOffMultiplier(Double.parseDouble(
                this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_BACK_OFF_MULTIPLIER)));
        redeliveryPolicy.setUseExponentialBackOff(Boolean.parseBoolean(this.environment
    ...
    public RedeliveryPolicy smartMeteringResponsesRedeliveryPolicy() {
        final RedeliveryPolicy redeliveryPolicy = super.createCustomRedeliveryPolicy(
                PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_PREFIX);
        // redeliveryPolicy.setInitialRedeliveryDelay(Long.parseLong(this.environment
        // .getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_INITIAL_REDELIVERY_DELAY)));
        // redeliveryPolicy.setMaximumRedeliveries(Integer.parseInt(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_MAXIMUM_REDELIVERIES)));
        // redeliveryPolicy.setMaximumRedeliveryDelay(Long.parseLong(this.environment
        // .getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_MAXIMUM_REDELIVERY_DELAY)));
        // redeliveryPolicy.setRedeliveryDelay(Long.parseLong(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_REDELIVERY_DELAY)));
        redeliveryPolicy.setDestination(this.smartMeteringResponsesQueue());
        redeliveryPolicy.setBackOffMultiplier(Double.parseDouble(
                this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_BACK_OFF_MULTIPLIER)));
        redeliveryPolicy.setUseExponentialBackOff(Boolean.parseBoolean(this.environment
    ...
    @Override
    protected Map<ActiveMQDestination, Object> registerRedeliveryPolicies() {
        final Map<ActiveMQDestination, Object> redeliveryPolicyMap = new HashMap<>();
    ...
    public JmsTemplate loggingJmsTemplate() {
        final JmsTemplate jmsTemplate = super.createCustomJmsTemplate(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_PREFIX);
        ...
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_EXPLICIT_QOS_ENABLED)));
        // jmsTemplate.setTimeToLive(Long.parseLong(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_TIME_TO_LIVE)));
        // jmsTemplate.setDeliveryPersistent(Boolean.parseBoolean(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_LOGGING_DELIVERY_PERSISTENT)));
    ...
    public JmsTemplate smartMeteringRequestsJmsTemplate() {
        final JmsTemplate jmsTemplate = super.createCustomJmsTemplate(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_PREFIX);
        jmsTemplate.setDefaultDestination(this.smartMeteringRequestsQueue());
        // Enable the use of deliveryMode, priority, and timeToLive
        // jmsTemplate.setExplicitQosEnabled(Boolean.parseBoolean(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_EXPLICIT_QOS_ENABLED)));
        // jmsTemplate.setTimeToLive(Long.parseLong(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_TIME_TO_LIVE)));
        // jmsTemplate.setDeliveryPersistent(Boolean.parseBoolean(
        // this.environment.getRequiredProperty(PROPERTY_NAME_JMS_SMART_METERING_REQUESTS_DELIVERY_PERSISTENT)));
        // jmsTemplate.setConnectionFactory(this.pooledConnectionFactory());
        return jmsTemplate;
    }
    ...
    public DefaultMessageListenerContainer smartMeteringResponseMessageListenerContainer() {
        final DefaultMessageListenerContainer messageListenerContainer = super.defaultMessageListenerContainer(
                PROPERTY_NAME_JMS_SMART_METERING_RESPONSES_PREFIX, this.smartMeteringResponsesQueue(),
    ...
    // final RedeliveryPolicyMap redeliveryPolicyMap = new
    // RedeliveryPolicyMap();
    // redeliveryPolicyMap.setDefaultEntry(this.defaultRedeliveryPolicy());
    // redeliveryPolicyMap.put(this.smartMeteringRequestsQueue(),
    // this.smartMeteringRequestsRedeliveryPolicy());
    // redeliveryPolicyMap.put(this.smartMeteringResponsesQueue(),
    // this.smartMeteringResponsesRedeliveryPolicy());
    // redeliveryPolicyMap.put(this.smartMeteringLoggingQueue(),
    // this.smartMeteringLoggingRedeliveryPolicy());
    // return redeliveryPolicyMap;
    // }
