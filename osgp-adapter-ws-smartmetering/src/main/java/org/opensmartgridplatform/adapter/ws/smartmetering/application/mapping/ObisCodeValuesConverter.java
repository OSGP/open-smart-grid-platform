...
public class ObisCodeValuesConverter extends
        BidirectionalConverter<ObisCodeValues, org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ObisCodeValues> {
    ...
    public org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ObisCodeValues convertTo(
            ...
            final Type<org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ObisCodeValues> destinationType,
            final MappingContext context) {

        return new org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ObisCodeValues((byte) source.getA(),
