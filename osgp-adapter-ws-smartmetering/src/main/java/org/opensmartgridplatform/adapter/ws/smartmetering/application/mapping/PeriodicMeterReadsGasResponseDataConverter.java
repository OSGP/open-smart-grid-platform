...
public class PeriodicMeterReadsGasResponseDataConverter extends
        CustomConverter<PeriodicMeterReadsContainerGas, org.opensmartgridplatform.adapter.ws.schema.smartmetering.monitoring.PeriodicMeterReadsGasResponseData> {
    ...
    public PeriodicMeterReadsGasResponseData convert(final PeriodicMeterReadsContainerGas source,
        ...
        for (final org.opensmartgridplatform.domain.core.valueobjects.smartmetering.PeriodicMeterReadsGas m : source
    ...
    private PeriodicMeterReadsGas convert(
            final org.opensmartgridplatform.domain.core.valueobjects.smartmetering.PeriodicMeterReadsGas source) {
