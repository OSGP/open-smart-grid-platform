...
public class ReadAlarmRegisterDataConverter extends
        CustomConverter<org.opensmartgridplatform.adapter.ws.schema.smartmetering.monitoring.ReadAlarmRegisterData, ReadAlarmRegisterData> {

    @Override
    public ReadAlarmRegisterData convert(
            final org.opensmartgridplatform.adapter.ws.schema.smartmetering.monitoring.ReadAlarmRegisterData source,
