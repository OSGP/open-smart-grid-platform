...
import com.alliander.osgp.domain.core.valueobjects.smartmetering.CaptureObjectDefinition;
...
public class DefinableLoadProfileConfigurationDataMappingTest {
    ...
    public void testDefinableLoadProfileConfigurationCapturePeriodOnly() {
        ...
        final com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData wsDefinableLoadProfileConfigurationData = this
    ...
    private com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData newDefinableLoadProfileConfigurationDataCapturePeriodOnly() {
        final com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData definableLoadProfileConfigurationData = new com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData();
    ...
    private com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData newDefinableLoadProfileConfigurationDataCaptureObjectsOnly() {
        final com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData definableLoadProfileConfigurationData = new com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData();
    ...
    private com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData newDefinableLoadProfileConfigurationData() {
        final com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData definableLoadProfileConfigurationData = new com.alliander.osgp.adapter.ws.schema.smartmetering.configuration.DefinableLoadProfileConfigurationData();
        definableLoadProfileConfigurationData.setCaptureObjects(this.newCaptureObjects());
        definableLoadProfileConfigurationData.setCapturePeriod(CAPTURE_PERIOD);
        return definableLoadProfileConfigurationData;
    ...
    private com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinitions newCaptureObjects() {
        final com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinitions captureObjectDefinitions = new com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinitions();
        final List<com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinition> captureObjects = captureObjectDefinitions
                .getCaptureObject();
    ...
    private com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinition newCaptureObjectDefinition(
            final int classId,
            final com.alliander.osgp.adapter.ws.schema.smartmetering.common.ObisCodeValues obisCodeValues,
            final byte attributeIndex, final Integer dataIndex) {
        final com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinition captureObjectDefinition = new com.alliander.osgp.adapter.ws.schema.smartmetering.common.CaptureObjectDefinition();
    ...
    private com.alliander.osgp.adapter.ws.schema.smartmetering.common.ObisCodeValues newLogicalName(final short a,
            final short b, final short c, final short d, final short e, final short f) {
        final com.alliander.osgp.adapter.ws.schema.smartmetering.common.ObisCodeValues obisCodeValues = new com.alliander.osgp.adapter.ws.schema.smartmetering.common.ObisCodeValues();
