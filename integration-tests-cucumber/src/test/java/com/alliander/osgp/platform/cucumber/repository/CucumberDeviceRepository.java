 ...
 */
package com.alliander.osgp.platform.cucumber.repository;
...
@Repository
public interface CucumberDeviceRepository extends JpaRepository<Device, Long>, JpaSpecificationExecutor<Device> {
