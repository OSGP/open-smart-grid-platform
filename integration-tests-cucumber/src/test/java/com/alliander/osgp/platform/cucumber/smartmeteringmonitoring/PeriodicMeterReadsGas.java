...
public class PeriodicMeterReadsGas extends SuperCucumber {
    ...
    public void theGetPeriodicMeterReadsRequestIsReceived() throws Throwable {
        ...
        this.correlationUid = this.RequestRunner(PROPERTIES_MAP, TEST_CASE_NAME_REQUEST, TEST_CASE_XML_225,
                TEST_SUITE_XML);
    }
    ...
    public void theGetIntervalMeterReadsRequestIsReceived() throws Throwable {
        ...
        this.correlationUid = this.RequestRunner(PROPERTIES_MAP, TEST_CASE_NAME_REQUEST, TEST_CASE_XML_228,
                TEST_SUITE_XML);
    }
