...
public class PersistenceConfigResponseDlms {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
            @Qualifier("dsDlms") DataSource barDataSource) throws ClassNotFoundException {

        final LocalContainerEntityManagerFactoryBean entityManagerFactoryBean = new LocalContainerEntityManagerFactoryBean();

        entityManagerFactoryBean.setPersistenceUnitName("OSGP_CUCUMBER_DLMS");
