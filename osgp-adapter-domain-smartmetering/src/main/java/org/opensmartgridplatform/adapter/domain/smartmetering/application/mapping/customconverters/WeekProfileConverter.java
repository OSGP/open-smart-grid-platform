...
public class WeekProfileConverter extends BidirectionalConverter<WeekProfileDto, WeekProfile> {
    ...
    @Override
    public WeekProfile convertTo(final WeekProfileDto source, final Type<WeekProfile> destinationType,
        ...
        return WeekProfile.newBuilder().withWeekProfileName(source.getWeekProfileName())
                ...
                .withSunday(this.convertDayProfileTo(source.getSunday())).build();
    }
    ...
    @Override
    public WeekProfileDto convertFrom(final WeekProfile source, final Type<WeekProfileDto> destinationType,
            final MappingContext context) {
        ...
        return WeekProfileDto.newBuilder().withWeekProfileName(source.getWeekProfileName())
                ...
                .withSunday(this.convertDayProfileFrom(source.getSunday())).build();
    }
