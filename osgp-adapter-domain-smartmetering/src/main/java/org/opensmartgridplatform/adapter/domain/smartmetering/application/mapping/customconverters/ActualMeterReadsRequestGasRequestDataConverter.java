...
@Component
public class ActualMeterReadsRequestGasRequestDataConverter implements
        CustomValueToDtoConverter<ActualMeterReadsGasRequestData, ActualMeterReadsDataGasDto> {

    @Autowired
    private DomainHelperService domainHelperService;

    @Override
    public ActualMeterReadsDataGasDto convert(final ActualMeterReadsGasRequestData value, final SmartMeter smartMeter)
