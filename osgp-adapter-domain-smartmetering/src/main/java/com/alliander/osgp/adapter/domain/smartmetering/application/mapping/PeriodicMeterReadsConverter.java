...
public class PeriodicMeterReadsConverter extends CustomConverter<PeriodicMeterReadsDto, PeriodicMeterReads> {

    @Override
    public PeriodicMeterReads convert(final PeriodicMeterReadsDto pmr,
        ...
        return new PeriodicMeterReads(pmr.getLogTime(), this.convert(pmr.getActiveEnergyImport()), this.convert(pmr
                .getActiveEnergyExport()), this.convert(pmr.getActiveEnergyImportTariffOne()), this.convert(pmr
                .getActiveEnergyImportTariffTwo()), this.convert(pmr.getActiveEnergyExportTariffOne()),
                this.convert(pmr.getActiveEnergyExportTariffTwo()), amrProfileStatusCode);
    }
