...
public class PushSetupSmsDtoConverter extends
        BidirectionalConverter<PushSetupSms, com.alliander.osgp.dto.valueobjects.smartmetering.PushSetupSmsDto> {

    @Override
    public com.alliander.osgp.dto.valueobjects.smartmetering.PushSetupSmsDto convertTo(final PushSetupSms source,
            final Type<com.alliander.osgp.dto.valueobjects.smartmetering.PushSetupSmsDto> destinationType,
    ...
    @Override
    public PushSetupSms convertFrom(final com.alliander.osgp.dto.valueobjects.smartmetering.PushSetupSmsDto source,
            final Type<PushSetupSms> destinationType, final MappingContext context) {
        if (source == null) {
            return null;
        }

        // TODO: write convert objects, or create singleConverter instead of
