...
public class MessagingConfig {
    ...
    @Bean(name = "domainSmartMeteringIncomingWebServiceRequestsQueue")
    ...
    @Bean(name = "domainSmartMeteringIncomingWebServiceRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainSmartMeteringOutgoingWebServiceResponsesQueue")
    ...
    public JmsOperations outgoingWebServiceResponsesJmsTemplate() {
    ...
    @Bean(name = "domainSmartMeteringOutgoingWebServiceResponsesRedeliveryPolicy")
    ...
    @Bean(name = "domainSmartMeteringOsgpCoreRequestsQueue")
    ...
    @Bean(name = "domainSmartMeteringOspgCoreRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainSmartMeteringIncomingOsgpCoreResponsesQueue")
    ...
    @Bean(name = "domainSmartMeteringIncomingOsgpCoreResponsesRedeliveryPolicy")
    ...
    @Bean(name = "domainSmartMeteringIncomingOsgpCoreRequestsQueue")
    ...
    @Bean(name = "domainSmartMeteringIncomingOsgpCoreRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainSmartMeteringOutgoingOsgpCoreResponsesRedeliveryPolicy")
