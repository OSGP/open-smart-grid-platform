...
public class PeriodicMeterReadsresponseMessageProcessor extends OsgpCoreResponseMessageProcessor {
    ...
    protected boolean hasRegularResponseObject(final ResponseMessage responseMessage) {
        ...
        return dataObject instanceof PeriodicMeterReadsResponseListDto
                || dataObject instanceof PeriodicMeterReadGasResponseListDto;
    }
    ...
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        if (responseMessage.getDataObject() instanceof PeriodicMeterReadsResponseListDto) {
            final PeriodicMeterReadsResponseListDto periodicMeterReadsContainer = (PeriodicMeterReadsResponseListDto) responseMessage
                    .getDataObject();
        ...
        } else if (responseMessage.getDataObject() instanceof PeriodicMeterReadGasResponseListDto) {
            final PeriodicMeterReadGasResponseListDto periodicMeterReadsContainerGas = (PeriodicMeterReadGasResponseListDto) responseMessage
                    .getDataObject();
