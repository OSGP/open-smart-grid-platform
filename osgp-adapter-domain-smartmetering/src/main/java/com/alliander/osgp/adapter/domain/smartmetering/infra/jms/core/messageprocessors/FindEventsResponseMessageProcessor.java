...
public class FindEventsResponseMessageProcessor extends OsgpCoreResponseMessageProcessor {
    ...
    protected boolean hasRegularResponseObject(final ResponseMessage responseMessage) {
        return responseMessage.getDataObject() instanceof EventMessageDataResponseListDto;
    }
    ...
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        final EventMessageDataResponseListDto eventMessageDataContainer = (EventMessageDataResponseListDto) responseMessage
                .getDataObject();
