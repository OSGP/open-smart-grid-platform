...
public class ActualMeterReadsConverter extends CustomConverter<MeterReadsDto, MeterReads> {

    @Override
    public MeterReads convert(final MeterReadsDto source, final Type<? extends MeterReads> destinationType) {
