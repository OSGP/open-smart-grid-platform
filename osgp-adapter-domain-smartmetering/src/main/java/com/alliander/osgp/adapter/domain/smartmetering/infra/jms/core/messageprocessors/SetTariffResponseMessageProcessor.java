...
/**
 * Class for processing smart metering set tariff response messages
 */
@Component("domainSmartMeteringSetTariffResponseMessageProcessor")
public class SetTariffResponseMessageProcessor extends OsgpCoreResponseMessageProcessor {
    /**
