 ...
 */
package com.alliander.osgp.automatictests.platform.dlms.glue.steps.database.device;

import static com.alliander.osgp.automatictests.platform.Defaults.SMART_METER_E;
import static com.alliander.osgp.automatictests.platform.Defaults.SMART_METER_G;
...
import com.alliander.osgp.automatictests.platform.dlms.Defaults;
import com.alliander.osgp.automatictests.platform.dlms.Keys;
import com.alliander.osgp.automatictests.platform.dlms.builders.entities.DeviceBuilder;
import com.alliander.osgp.automatictests.platform.dlms.builders.entities.DlmsDeviceBuilder;
import com.alliander.osgp.automatictests.platform.dlms.builders.entities.SmartMeterBuilder;
...
public class DlmsDeviceSteps {
    ...
    private void createDeviceAuthorisationInCoreDatabase(final Device device) {
        final Organisation organisation = this.organisationRepo
                .findByOrganisationIdentification(com.alliander.osgp.automatictests.platform.Defaults.ORGANIZATION_IDENTIFICATION);
