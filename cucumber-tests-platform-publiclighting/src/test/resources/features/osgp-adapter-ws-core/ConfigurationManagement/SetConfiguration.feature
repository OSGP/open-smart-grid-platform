...
Feature: CoreConfigurationManagement SetConfiguration
  ...
  Scenario Outline: Set configuration of a device
    ...
    Examples: 
      ...
      | OSLP ELSTER | RELAY                   |          |         | 1,1,TARIFF |                   |           |               |              |              |
      | OSLP ELSTER | RELAY                   |          |         | 1,1,TARIFF |                   | AUX       |               |              |              |
  ...
  Scenario Outline: Set configuration data with invalid data which result in validation errors
    ...
    Examples: 
      | Protocol    | LightType | DcLights | DcMap               | RcType          | RelayConf                                                             | ShortInterval | PreferredLinkType | MeterType | LongInterval | IntervalType | FaultCode       | FaultString      | ValidationErrors                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |  |
      ...
      | OSLP        |           |          |                     | TARIFF_REVERSED | ,,TARIFF_REVERSED                                                     |               |                   |           |              |              | SOAP-ENV:Client | Validation error | cvc-minInclusive-valid: Value '0' is not facet-valid with respect to minInclusive '1' for type '#AnonType_IndexRelayMap'.;cvc-type.3.1.3: The value '0' of element 'ns2:Index' is not valid.;cvc-minInclusive-valid: Value '0' is not facet-valid with respect to minInclusive '1' for type '#AnonType_AddressRelayMap'.;cvc-type.3.1.3: The value '0' of element 'ns2:Address' is not valid.                                                                                                                                                                          |  |
  ...
  Scenario Outline: Set configuration data with invalid data
    ...
    Examples: 
      | Protocol    | LightType       | DcLights | DcMap | RelayConf           | ShortInterval | PreferredLinkType | MeterType | LongInterval | IntervalType | InnerMessage                                                                                                                                                                                                      |
      | OSLP        | RELAY           |        1 |   1,1 |                     |               |                   |           |              |              | Light type (e.g. relay, dali) must match configuration type (e.g. relay, dali).                                                                                                                                   |
      | OSLP        | DALI            |          |       | 1,1,LIGHT           |               |                   |           |              |              | Light type (e.g. relay, dali) must match configuration type (e.g. relay, dali).                                                                                                                                   |
      | OSLP        | ONE_TO_TEN_VOLT |          |       | 1,1,TARIFF          |               |                   |           |              |              | Light type (e.g. relay, dali) must match configuration type (e.g. relay, dali).                                                                                                                                   |
      | OSLP        | ONE_TO_TEN_VOLT |          |       | 1,1,TARIFF_REVERSED |               |                   |           |              |              | Light type (e.g. relay, dali) must match configuration type (e.g. relay, dali).                                                                                                                                   |
