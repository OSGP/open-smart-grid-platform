...
Feature: CoreConfigurationManagement SetConfiguration
  ...
  Scenario Outline: Set configuration data with invalid data which result in validation errors
    ...
    Examples:
      | Protocol    | LightType | DcLights | DcMap               | RelayConf                                                             | OsgpIpAddress | OsgpPort | FaultCode       | FaultString      | ValidationErrors                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | OSLP ELSTER | RELAY     |          |                     | 1,1                                                                   |               |          | SOAP-ENV:Client | Validation error | cvc-complex-type.2.4.b: The content of element 'ns2:RelayMap' is not complete. One of '{"http://www.opensmartgridplatform.org/schemas/configurationmanagement/2014/10":RelayType}' is expected.                                                                                                                                                                                                                                                                                                                                                                        |
      ...
      | OSLP ELSTER |           |          |                     | 1,1                                                                   |               |          | SOAP-ENV:Client | Validation error | cvc-complex-type.2.4.b: The content of element 'ns2:RelayMap' is not complete. One of '{"http://www.opensmartgridplatform.org/schemas/configurationmanagement/2014/10":RelayType}' is expected.                                                                                                                                                                                                                                                                                                                                                                        |
  ...
  Scenario Outline: Set configuration data with invalid data
    ...
    Then the set configuration async response contains soap fault
      ...
      | Component      | WS_CORE                                                              |
      | InnerException | org.opensmartgridplatform.domain.core.exceptions.ValidationException |
