...
public class DefinableLoadProfileSteps extends GlueBase {
    ...
    public void theDefinableLoadProfileOfContains(final String deviceIdentification, final Map<String, String> settings)
            throws Throwable {

        LOGGER.info("Ignoring verification of Definable Load Profile configuration on simulator."
