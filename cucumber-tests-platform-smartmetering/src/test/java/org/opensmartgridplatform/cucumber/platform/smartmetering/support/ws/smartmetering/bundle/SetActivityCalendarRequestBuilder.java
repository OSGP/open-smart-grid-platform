...
public class SetActivityCalendarRequestBuilder {
    private static final ActivityCalendar DEFAULT_ACTIVITY_CALENDAR = new ActivityCalendar("ACTCAL01",
    ...
    public SetActivityCalendarRequestBuilder withActivityCalendar(final ActivityCalendar activityCalendar) {
