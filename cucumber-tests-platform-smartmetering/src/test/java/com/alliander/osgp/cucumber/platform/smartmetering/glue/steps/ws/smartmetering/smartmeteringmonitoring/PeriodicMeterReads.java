...
import com.alliander.osgp.cucumber.platform.smartmetering.builders.PeriodicMeterReadsRequestBuilder;
...
public class PeriodicMeterReads extends SmartMeteringStepsBase {
    ...
    public void theGetMeterReadsRequestIsReceived(final String stringPeriodType, final Map<String, String> settings)
            throws Throwable {
        ...
        final PeriodicMeterReadsRequest request = new PeriodicMeterReadsRequestBuilder()
    ...
    public void theMeterReadsResultShouldBeReturned(final String periodType, final Map<String, String> settings)
        ...
        final PeriodicMeterReadsResponse response = this.responseClient.getResponse(asyncRequest, correlationUid);
