...
public class SetAlarmNotificationsRequestBuilder {
    ...
    public SetAlarmNotificationsRequestBuilder fromParameterMap(final Map<String, String> parameters) {
        this.alarmNotifications = new ArrayList<>();
    ...
    private AlarmNotification getAlarmNotification(final Map<String, String> parameters, final int index) {
        final AlarmNotification alarmNotification = new AlarmNotification();
