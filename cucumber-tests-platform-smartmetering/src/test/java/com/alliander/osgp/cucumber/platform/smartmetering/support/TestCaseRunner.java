...
import com.alliander.osgp.cucumber.platform.smartmetering.SoapUiRunner;
...
public class TestCaseRunner {
    ...
    private String getCorrelId(final Map<String, String> propertiesMap) {
        if (propertiesMap.containsKey(PlatformKeys.KEY_CORRELATION_UID)) {
            return propertiesMap.get(PlatformKeys.KEY_CORRELATION_UID);
        } else {
            return null;
        }
    }
    ...
    private boolean resetCorrelId(final Map<String, String> propertiesMap) {
        if (propertiesMap.containsKey(PlatformKeys.KEY_CORRELATION_UID)) {
            propertiesMap.put(PlatformKeys.KEY_CORRELATION_UID, null);
            return true;
        } else {
            return false;
        }
