...
public class DeviceFactory {
    ...
    public static Device fromParameterMap(final Map<String, String> requestParameters) {
        ...
        device.setMbusIdentificationNumber(
                Helpers.getLong(settings, PlatformSmartmeteringKeys.MBUS_IDENTIFICATION_NUMBER));
        ...
        device.setMbusVersion(Helpers.getShort(settings, PlatformSmartmeteringKeys.MBUS_VERSION));
        device.setMbusDeviceTypeIdentification(
                Helpers.getShort(settings, PlatformSmartmeteringKeys.MBUS_DEVICE_TYPE_IDENTIFICATION));
