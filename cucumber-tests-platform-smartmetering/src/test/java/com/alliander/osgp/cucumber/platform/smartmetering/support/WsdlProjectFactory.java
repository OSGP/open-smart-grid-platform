...
public class WsdlProjectFactory {
    ...
    public WsdlProjectFactory(final String soapProjectXml, final String certBasePath, final String serviceEndpoint)
        ...
        this.project.setPropertyValue("serviceEndpoint", serviceEndpoint);
    }
