...
public class AdminController {
  ...
  @Autowired OsgpAdminClientSoapService osgpAdminClientSoapService;

  @Autowired PublicLightingController publicLightingController;

  /**
   * Is called by the add-device page. This controller receives the device from the JSP page and
   * calls the 'updateKeyRequest' in the Soap Client Service. This requests is sent to the Platform,
  ...
  /**
   * Mapped to 'addDevice'. Returns a ModelAndView containing the name of the JSP page which
   * contains a form. Adds a Device object to the model. The form fills the device object and the
   * button on the jsp page links to the 'doAddDevice' Controller.
   */
