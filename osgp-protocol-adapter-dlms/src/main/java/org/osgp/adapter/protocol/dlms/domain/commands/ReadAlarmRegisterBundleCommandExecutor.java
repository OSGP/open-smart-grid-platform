...
@Component
public class ReadAlarmRegisterBundleCommandExecutor extends
BundleCommandExecutor<ReadAlarmRegisterDataDto, ActionResponseDto> {
    ...
    public ReadAlarmRegisterBundleCommandExecutor() {
