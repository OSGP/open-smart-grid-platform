...
@Component
public class GetAssociationLnObjectsBundleCommandExecutor extends
        BundleCommandExecutor<GetAssociationLnObjectsRequestDto, ActionResponseDto> {

    private static final Logger LOGGER = LoggerFactory.getLogger(GetAssociationLnObjectsBundleCommandExecutor.class);

    @Autowired
    private GetAssociationLnObjectsCommandExecutor getAssociationLnObjectsCommandExecutor;

    public GetAssociationLnObjectsBundleCommandExecutor() {
