...
@Component()
public class GetAdministrativeStatusBundleCommandExecutor extends
        BundleCommandExecutor<GetAdministrativeStatusDataDto, ActionResponseDto> {
    ...
    public GetAdministrativeStatusBundleCommandExecutor() {
