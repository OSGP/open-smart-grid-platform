...
public class GetPeriodicMeterReadsBundleCommandExecutorStub extends AbstractCommandExecutorStub implements
    ...
    public ActionResponseDto execute(final DlmsConnection conn, final DlmsDevice device,
            final PeriodicMeterReadsRequestDataDto object) throws ProtocolAdapterException {
