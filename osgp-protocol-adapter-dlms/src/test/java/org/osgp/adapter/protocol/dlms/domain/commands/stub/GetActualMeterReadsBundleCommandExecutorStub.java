...
public class GetActualMeterReadsBundleCommandExecutorStub extends AbstractCommandExecutorStub implements
        GetActualMeterReadsBundleCommandExecutor {

    @Override
    public ActionResponseDto execute(final ClientConnection conn, final DlmsDevice device,
            final ActualMeterReadsDataDto object) throws ProtocolAdapterException {
