...
public class GetPeriodicMeterReadsGasBundleCommandExecutorStub extends AbstractCommandExecutorStub implements GetPeriodicMeterReadsGasBundleCommandExecutor {

    @Override
    public ActionResponseDto execute(ClientConnection conn, DlmsDevice device,
            PeriodicMeterReadsGasRequestDataDto object) throws ProtocolAdapterException {
