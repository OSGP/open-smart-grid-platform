...
public class SetSpecialDaysBundleCommandExecutorStub extends AbstractCommandExecutorStub implements
        SetSpecialDaysBundleCommandExecutor {

    @Override
    public ActionResponseDto execute(final ClientConnection conn, final DlmsDevice device,
            final SpecialDaysRequestDataDto object) throws ProtocolAdapterException {
