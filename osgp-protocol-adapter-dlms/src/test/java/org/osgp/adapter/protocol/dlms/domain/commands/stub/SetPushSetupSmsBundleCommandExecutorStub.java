...
public class SetPushSetupSmsBundleCommandExecutorStub extends AbstractCommandExecutorStub implements SetPushSetupSmsBundleCommandExecutor {

    @Override
    public ActionResponseDto execute(ClientConnection conn, DlmsDevice device, SetPushSetupSmsRequestDataDto object)
