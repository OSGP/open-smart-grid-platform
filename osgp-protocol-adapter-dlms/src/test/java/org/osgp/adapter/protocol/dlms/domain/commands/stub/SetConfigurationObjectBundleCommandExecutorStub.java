...
public class SetConfigurationObjectBundleCommandExecutorStub extends AbstractCommandExecutorStub implements
    ...
    public ActionResponseDto execute(final DlmsConnection conn, final DlmsDevice device,
            final SetConfigurationObjectRequestDataDto object) throws ProtocolAdapterException {
