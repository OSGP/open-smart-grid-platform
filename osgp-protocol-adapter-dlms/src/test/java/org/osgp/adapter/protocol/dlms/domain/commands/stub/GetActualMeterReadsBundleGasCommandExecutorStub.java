...
public class GetActualMeterReadsBundleGasCommandExecutorStub extends AbstractCommandExecutorStub implements GetActualMeterReadsBundleGasCommandExecutor {

    @Override
    public ActionResponseDto execute(ClientConnection conn, DlmsDevice device, ActualMeterReadsDataGasDto object)
