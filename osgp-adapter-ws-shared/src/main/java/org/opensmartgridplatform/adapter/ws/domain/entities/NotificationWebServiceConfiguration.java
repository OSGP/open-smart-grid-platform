...
public class NotificationWebServiceConfiguration implements Serializable {
    ...
    public String toString() {
        return String.format("%s[%s, context=%s, target=%s, useKeyStore=%b, useTrustStore=%b, useCircuitBreaker=%b]",
                this.getClass().getSimpleName(), this.getId(), this.getMarshallerContextPath(), this.getTargetUri(),
                this.isUseKeyStore(), this.isUseTrustStore(), this.isUseCircuitBreaker());
    }

    /**
     * Sets key store configuration values. If none of the provided values is
     * blank, configures this to use the key store, otherwise configures this
     * not to use the key store.
     */
    ...
    /**
     * Sets trust store configuration values. If none of the provided values is
     * blank, configures this to use the trust store, otherwise configures this
     * not to use the trust store.
     */
    ...
    /**
     * Sets circuit breaker configuration values. If all provided values are
     * positive, configures this to use the circuit breaker, otherwise
     * configures this not to use the circuit breaker.
     */
    public void useCircuitBreaker(final int threshold, final int durationInitial, final int durationMaximum,
