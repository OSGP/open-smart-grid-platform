 ...
 * MessageContext.
 */
public class SoapHeaderMessagePriorityEndpointInterceptor extends AbstractSoapHeaderInterceptor {

    public SoapHeaderMessagePriorityEndpointInterceptor(final String messagePriorityHeaderName) {
        super(messagePriorityHeaderName, messagePriorityHeaderName);
    }
