 ...
 */
package com.alliander.osgp.adapter.domain.microgrids.infra.jms.ws;
 ...
 */
public abstract class AbstractWebServiceRequestMessageProcessor implements MessageProcessor {
     ...
     */
    @Qualifier("domainMicrogridsOutgoingOsgpCoreRequestMessageSender")
    @Autowired
