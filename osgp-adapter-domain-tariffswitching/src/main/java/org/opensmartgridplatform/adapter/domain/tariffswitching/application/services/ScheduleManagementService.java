...
public class ScheduleManagementService extends AbstractService {
    ...
    public void setTariffSchedule(final String organisationIdentification, final String deviceIdentification,
        ...
        final List<org.opensmartgridplatform.dto.valueobjects.ScheduleEntryDto> schedulesDto = this.domainCoreMapper
                .mapAsList(schedules, org.opensmartgridplatform.dto.valueobjects.ScheduleEntryDto.class);
