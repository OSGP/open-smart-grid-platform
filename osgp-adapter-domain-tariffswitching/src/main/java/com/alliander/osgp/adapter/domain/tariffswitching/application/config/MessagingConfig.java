...
public class MessagingConfig extends AbstractConfig {
    ...
    @Bean(name = "domainTariffSwitchingIncomingWebServiceRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainTariffSwitchingOutgoingServiceResponsesRedeliveryPolicy")
    ...
    @Bean(name = "domainTariffSwitchingOutgoinOsgpCoreRequestsQueue")
    ...
    @Bean(name = "domainTariffSwitchingOutgoingOsgpCoreRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainTariffSwitchingIncomingOsgpCoreResponsesRedeliveryPolicy")
    ...
    @Bean(name = "domainTariffSwitchingIncomingOsgpCoreRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainTariffSwitchingOutgoingOsgpCoreResponsesRedeliveryPolicy")
