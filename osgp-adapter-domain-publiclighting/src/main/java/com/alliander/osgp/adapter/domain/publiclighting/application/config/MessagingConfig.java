...
public class MessagingConfig extends AbstractConfig {
    ...
    @Bean(name = "domainPublicLightingIncomingWebServiceRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainPublicLightingOutgoingWebServiceResponsesRedeliveryPolicy")
    ...
    @Bean(name = "domainPublicLightingOsgpCoreRequestsQueue")
    ...
    @Bean(name = "domainPublicLightingOspgCoreRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainPublicLightingIncomingOsgpCoreResponsesRedeliveryPolicy")
    ...
    @Bean(name = "domainPublicLightingIncomingOsgpCoreRequestsRedeliveryPolicy")
    ...
    @Bean(name = "domainPublicLightingOutgoingOsgpCoreResponsesRedeliveryPolicy")
