...
public class DistributionAutomationMapperTest {
    ...
    public void testBitmaskMeasurementElementMapping() {
        ...
        final org.opensmartgridplatform.domain.da.measurements.elements.BitmaskMeasurementElement domainMeasurementElement = new org.opensmartgridplatform.domain.da.measurements.elements.BitmaskMeasurementElement(
                (byte) 40);

        // Act
        final BitmaskMeasurementElement actual = this.mapper.map(domainMeasurementElement,
    ...
    public void testMeasurementReportHeaderMapping() {
        ...
        final MeasurementReportHeader expected = WSMeasurementsFactory.spontaneousReportHeader(commonAddress);
        final org.opensmartgridplatform.domain.da.measurements.MeasurementReportHeader domainMeasurementReportHeader = DomainMeasurementsFactory
                .spontaneousReportHeader(commonAddress);

        // Act
        final MeasurementReportHeader actual = this.mapper.map(domainMeasurementReportHeader,
    ...
    public void testMeasurementReportMapping() {
        ...
        final org.opensmartgridplatform.domain.da.measurements.MeasurementReport domainMeasurementReport = new org.opensmartgridplatform.domain.da.measurements.MeasurementReport(
                DomainMeasurementsFactory.spontaneousReportHeader(commonAddress), domainGroups);

        // Act
        final MeasurementReport actual = this.mapper.map(domainMeasurementReport, MeasurementReport.class);
