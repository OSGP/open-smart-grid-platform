...
import org.opensmartgridplatform.domain.da.measurements.elements.FloatingPointMeasurementElement;
import org.opensmartgridplatform.domain.da.measurements.elements.TimestampMeasurementElement;

/**
 * Factory for easy creation of {@link MeasurementElement}, {@link Measurement},
 * {@link MeasurementReportHeader} and {@link MeasurementGroup} objects for use
 * in unit tests.
 */
public class DomainMeasurementsFactory {
    ...
    public static FloatingPointMeasurementElement floatingPointFrom(final float value) {
        return new FloatingPointMeasurementElement(value);
    }
    ...
    public static Measurement gasFlowMeasurement(final float gasFlow) {
        ...
        final FloatingPointMeasurementElement cubicMeters = new FloatingPointMeasurementElement(gasFlow);
    ...
    public static MeasurementReportHeader spontaneousReportHeader(final int commonAddress) {
        return new org.opensmartgridplatform.domain.da.measurements.MeasurementReportHeader.Builder()
                ...
                .withMeasurementType(
                        org.opensmartgridplatform.domain.da.measurements.MeasurementType.MEASURED_SHORT_FLOAT_WITH_TIME_TAG)
