 ...
 */
package org.opensmartgridplatform.adapter.ws.schema.distributionautomation.generic.testutils;
 ...
 * {@link MeasurementReportHeader}, {@link MeasurementGroup} and
 * {@link MeasurementGroups} objects for use in unit tests.
 */
public class WSMeasurementsFactory {
    ...
    /**
     * Creates a fixed {@link Measurement} containing four
     * {@link MeasurementElement}s.
     *
     * @return
     */
    ...
    public static MeasurementGroup gasFlowMeasurementGroup(final int groupIdentifier,
        ...
        for (final float gasFlowMeasurement : gasFlowMeasurements) {
            wsMeasurements.getMeasurementList().add(WSMeasurementsFactory.gasFlowMeasurement(gasFlowMeasurement));
        }
