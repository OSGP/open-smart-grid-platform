...
public class DeviceManagementMapperTest {
    ...
    public void mapsUpdatedDeviceToDevice() {
        ...
        final org.opensmartgridplatform.domain.core.entities.DeviceOutputSetting expectedOutputSetting = new org.opensmartgridplatform.domain.core.entities.DeviceOutputSetting(
                RELAY_INTERNAL_ID, RELAY_EXTERNAL_ID,
                org.opensmartgridplatform.domain.core.valueobjects.RelayType.LIGHT, DOS_ALIAS);
        expectedOutputSettings.add(expectedOutputSetting);
        expected.updateOutputSettings(expectedOutputSettings);

        final org.opensmartgridplatform.domain.core.valueobjects.Address expectedAddress = new org.opensmartgridplatform.domain.core.valueobjects.Address(
