...
package org.opensmartgridplatform.adapter.ws.core.infa.jms.messageprocessor;
  ...
  void init() throws JMSException {
    this.messageProcessor =
        new DomainResponseMessageProcessor(
            this.notificationService, this.responseDataService, "OSGP");

    when(this.message.getJMSType()).thenReturn("DEVICE_UPDATED");
