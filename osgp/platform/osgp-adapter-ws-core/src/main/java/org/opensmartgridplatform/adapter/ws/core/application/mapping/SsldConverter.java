...
class SsldConverter extends BidirectionalConverter<Ssld, Device> {
  ...
  public org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.Device convertTo(
    ...
    if (ssld != null) {
      ...
      for (final DeviceOutputSetting deviceOutputSetting : ssld.getOutputSettings()) {
        ...
        newDeviceOutputSetting.setRelayType(
            deviceOutputSetting.getOutputType() == null
                ? null
      ...
      final List<org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.Ean> eans =
          new ArrayList<>();
      for (final org.opensmartgridplatform.domain.core.entities.Ean ean : ssld.getEans()) {
        final org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.Ean newEan =
            new org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.Ean();
  ...
  public Ssld convertFrom(
    ...
    for (final org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.DeviceOutputSetting
        deviceOutputSetting : source.getOutputSettings()) {
      final org.opensmartgridplatform.domain.core.entities.DeviceOutputSetting
          newDeviceOutputSetting =
              new org.opensmartgridplatform.domain.core.entities.DeviceOutputSetting(
                  ...
                  deviceOutputSetting.getRelayType() == null
                      ? null
                      : org.opensmartgridplatform.domain.core.valueobjects.RelayType.valueOf(
                          deviceOutputSetting.getRelayType().name()),
    ...
    for (final org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.Ean ean :
        source.getEans()) {
  ...
  private void addRelayStatuses(
    ...
    if (ssld.getRelayStatuses() != null) {
      for (final org.opensmartgridplatform.domain.core.entities.RelayStatus r :
          ssld.getRelayStatuses()) {
        final org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.RelayStatus temp =
            this.convertRelayStatus(r);
        if (temp != null) {
  ...
  private org.opensmartgridplatform.adapter.ws.schema.core.devicemanagement.RelayStatus
      convertRelayStatus(final RelayStatus status) {
  ...
  public boolean equals(final Object obj) {
    return super.equals(obj)
        && Objects.equals(this.helper, ((SsldConverter) obj).helper)
