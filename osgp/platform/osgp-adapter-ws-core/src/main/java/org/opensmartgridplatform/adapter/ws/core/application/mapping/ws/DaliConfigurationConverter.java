...
public class DaliConfigurationConverter extends
        BidirectionalConverter<org.opensmartgridplatform.adapter.ws.schema.core.configurationmanagement.DaliConfiguration, DaliConfiguration> {

    @Override
    public DaliConfiguration convertTo(
            final org.opensmartgridplatform.adapter.ws.schema.core.configurationmanagement.DaliConfiguration source,
    ...
    @Override
    public org.opensmartgridplatform.adapter.ws.schema.core.configurationmanagement.DaliConfiguration convertFrom(
            final DaliConfiguration source,
            final Type<org.opensmartgridplatform.adapter.ws.schema.core.configurationmanagement.DaliConfiguration> destinationType,
        ...
        final org.opensmartgridplatform.adapter.ws.schema.core.configurationmanagement.DaliConfiguration dest = new org.opensmartgridplatform.adapter.ws.schema.core.configurationmanagement.DaliConfiguration();
