...
public class SsldConverter extends BidirectionalConverter<org.opensmartgridplatform.domain.core.entities.Ssld, Ssld> {

    @Override
    public Ssld convertTo(final org.opensmartgridplatform.domain.core.entities.Ssld source,
            final Type<Ssld> destinationType, final MappingContext mappingContext) {
    ...
    @Override
    public org.opensmartgridplatform.domain.core.entities.Ssld convertFrom(final Ssld source,
