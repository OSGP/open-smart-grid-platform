...
public class OutgoingDomainRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "wsPublicLightOutgoingDomainRequestsConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing wsPublicLightingOutgoingDomainRequestsConnectionFactory bean.");
        return this.jmsConfigurationFactory.getPooledConnectionFactory();
    }

    @Bean(name = "wsPublicLightingOutgoingDomainRequestsJmsTemplate")
    public JmsTemplate jmsTemplate() {
        LOGGER.info("Initializing wsPublicLightingOutgoingDomainRequestJmsTemplate bean.");
