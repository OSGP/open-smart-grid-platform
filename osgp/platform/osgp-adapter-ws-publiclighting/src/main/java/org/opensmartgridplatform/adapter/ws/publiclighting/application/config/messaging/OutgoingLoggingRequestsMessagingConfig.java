...
public class OutgoingLoggingRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "wsPublicLightingOutgoingLoggingRequestsConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing wsPublicLightingOutgoingLoggingRequestsConnectionFactory bean.");
