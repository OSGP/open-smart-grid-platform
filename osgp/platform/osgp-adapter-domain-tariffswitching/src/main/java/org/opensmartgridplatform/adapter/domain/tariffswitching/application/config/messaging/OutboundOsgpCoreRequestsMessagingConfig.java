...
public class OutboundOsgpCoreRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainTariffSwitchingOutboundOsgpCoreRequestsConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainTariffSwitchingOutboundOsgpCoreRequestsConnectionFactory bean.");
