...
public class InboundOsgpCoreRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainTariffSwitchingInboundOsgpCoreRequestsConnectionFactory")
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainTariffSwitchingInboundOsgpCoreRequestsMessageListener") final MessageListener messageListener) {
        LOGGER.info("Initializing domainTariffSwitchingInboundOsgpCoreRequestsMessageListenerContainer bean.");
