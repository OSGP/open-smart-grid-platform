...
public class OutboundWebServiceResponsesMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainTariffSwitchingOutboundWebServiceResponsesConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainTariffSwitchingOutboundWebServiceResponsesConnectionFactory bean.");
