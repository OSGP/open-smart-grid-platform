...
public class OutboundOsgpCoreResponsesMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainTariffSwitchingOutboundOsgpCoreResponsesConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainTariffSwitchingOutboundOsgpCoreResponsesConnectionFactory bean.");
        return this.jmsConfigurationFactory.getPooledConnectionFactory();
    }

    @Bean(name = "domainTariffSwitchingOutboundOsgpCoreResponsesJmsTemplate")
    public JmsTemplate jmsTemplate() {
        LOGGER.info("Initializing domainTariffSwitchingOutboundOsgpCoreResponsesJmsTemplate bean.");
