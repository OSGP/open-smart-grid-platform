...
public class DistributionAutomationMapper extends ConfigurableMapper {
    ...
    public void configure(final MapperFactory mapperFactory) {
        ...
        mapperFactory.classMap(GetDeviceModelResponse.class,
                ...
                .byDefault()
                .register();
        mapperFactory.classMap(PhysicalDevice.class,
        ...
        mapperFactory.classMap(LogicalDevice.class,
                ...
                .byDefault()
                .register();
        mapperFactory.classMap(LogicalNode.class,
        ...
        mapperFactory
                ...
                .byDefault()
                .register();
        mapperFactory.getConverterFactory().registerConverter(new MeterReadingMapping());
