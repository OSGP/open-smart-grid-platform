 ...
 */
package org.opensmartgridplatform.adapter.kafka.da.application.exceptionhandling;
...
public class ConnectionFailureExceptionConverter extends CustomConverter<ConnectionFailureException, TechnicalFault> {
    ...
    @Override
    public TechnicalFault convert(final ConnectionFailureException source, final Type<? extends TechnicalFault> destinationType, final MappingContext context) {
        if (source == null) {
            return null;
        }
