...
public class OutboundLoggingRequestsMessagingConfig {
  ...
  @Bean(
      destroyMethod = "stop",
      name = "kafkaDistributionAutomationOutboundLoggingRequestsConnectionFactory")
  public ConnectionFactory connectionFactory() {
    LOGGER.info(
        "Initializing kafkaDistributionAutomationOutboundLoggingRequestsConnectionFactory bean.");
