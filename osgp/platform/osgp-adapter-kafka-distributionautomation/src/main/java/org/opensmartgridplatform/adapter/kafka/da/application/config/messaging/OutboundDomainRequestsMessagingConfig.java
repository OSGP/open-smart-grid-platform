...
public class OutboundDomainRequestsMessagingConfig {
  ...
  @Bean(
      destroyMethod = "stop",
      name = "kafkaDistributionAutomationOutboundDomainRequestsConnectionFactory")
  public ConnectionFactory connectionFactory() {
    LOGGER.info(
        "Initializing kafkaDistributionAutomationOutboundDomainRequestsConnectionFactory bean.");
