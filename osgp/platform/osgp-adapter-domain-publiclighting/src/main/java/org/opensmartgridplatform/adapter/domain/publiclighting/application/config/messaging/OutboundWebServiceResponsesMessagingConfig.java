...
public class OutboundWebServiceResponsesMessagingConfig {
  ...
  @Bean(
      destroyMethod = "stop",
      name = "domainPublicLightingOutboundWebServiceResponsesConnectionFactory")
  public ConnectionFactory connectionFactory() {
    LOGGER.info(
        "Initializing domainPublicLightingOutboundWebServiceResponsesConnectionFactory bean.");
