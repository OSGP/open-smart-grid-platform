...
public class InboundOsgpCoreResponsesMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainPublicLightingInboundOsgpCoreResponsesConnectionFactory")
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainPublicLightingInboundOsgpCoreResponsesMessageListener") final OsgpCoreResponseMessageListener messageListener) {
        LOGGER.info("Initializing domainPublicLightingInboundOsgpCoreResponsesMessageListenerContainer bean.");
    ...
    public MessageProcessorMap messageProcessorMap() {
        return new BaseMessageProcessorMap("domainPublicLightingInboundOsgpCoreResponsesMessageProcessorMap");
    }
