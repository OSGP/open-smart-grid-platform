...
public class DeviceSpecifications<D extends Device> {
    ...
    public final Specification<D> hasDeviceIdentification(@NotNull final String deviceIdentification) {
        return (root, query, cb) -> cb.equal(root.<String> get("deviceIdentification"), deviceIdentification);
    }
    ...
    public final Specification<D> hasDeviceLifeCycleStatus(@NotNull final DeviceLifecycleStatus deviceLifecycleStatus) {
        return (root, query, cb) -> cb.equal(root.<DeviceLifecycleStatus> get("deviceLifecycleStatus"),
