...
/**
 * Configuration class for incoming OSGP core requests
 */
@Configuration
public class IncomingOsgpCoreRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainPublicLightingIncomingOsgpCoreRequestsConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainPublicLightingIncomingOsgpCoreRequestsConnectionFactory bean.");
        return this.jmsConfigurationFactory.getPooledConnectionFactory();
    }

    @Bean(name = "domainPublicLightingIncomingOsgpCoreRequestsMessageListenerContainer")
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainPublicLightingIncomingOsgpCoreRequestsMessageListener") final OsgpCoreRequestMessageListener incomingOsgpCoreRequestMessageListener) {
        LOGGER.info("Initializing domainPublicLightingIncomingOsgpCoreRequestsMessageListenerContainer bean.");
