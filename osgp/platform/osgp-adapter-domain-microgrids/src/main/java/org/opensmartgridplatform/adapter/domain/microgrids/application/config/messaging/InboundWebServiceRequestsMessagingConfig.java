...
public class InboundWebServiceRequestsMessagingConfig {
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainMicrogridsInboundWebServiceRequestsMessageListener") final MessageListener messageListener) {
        LOGGER.info("Initializing domainMicrogridsInboundWebServiceRequestsMessageListenerContainer bean.");
    ...
    public MessageProcessorMap messageProcessorMap() {
        ...
        return new BaseMessageProcessorMap("domainMicrogridsInboundWebServiceRequestsMessageProcessorMap");
    }
}
