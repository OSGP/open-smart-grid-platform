...
public class InboundOsgpCoreResponsesMessagingConfig {
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainMicrogridsInboundOsgpCoreResponsesMessageListener") final MessageListener messageListener) {
        LOGGER.info("Initializing domainMicrogridsInboundOsgpCoreResponsesMessageListenerContainer bean.");
    ...
    public MessageProcessorMap messageProcessorMap() {
        return new BaseMessageProcessorMap("domainMicrogridsInboundOsgpCoreResponsesMessageProcessorMap");
    }
