...
public class SetDataResponseMessageProcessor extends BaseNotificationMessageProcessor {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SetDataResponseMessageProcessor.class);
  ...
  public void processMessage(final ObjectMessage message) throws JMSException {
    ...
    try {
      ...
      this.adHocManagementService.handleSetDataResponse(
          emptyResponse, ids, messageType, responseMessageResultType, osgpException);
