...
public class InboundLoggingRequestsMessagingConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(InboundLoggingRequestsMessagingConfig.class);

    private JmsConfigurationFactory jmsConfigurationFactory;

    public InboundLoggingRequestsMessagingConfig(final Environment environment,
