...
public class DtoMeasurementsFactory {
    ...
    public static MeasurementDto measurementFrom(final List<MeasurementElementDto> measurementElements) {
    ...
    public static MeasurementGroupDto gasFlowMeasurementGroup(final String groupIdentifier,
