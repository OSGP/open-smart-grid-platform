...
public class DomainDistributionAutomationMapperTest {
    ...
    public void testBitmaskMeasurementElementMapping() {
        ...
        // Act
        final BitmaskMeasurementElement actual = this.mapper.map(dtoMeasurementElement,
    ...
    public void testTimestampMeasurementElementMapping() {
        ...
        // Act
        final TimestampMeasurementElement actual = this.mapper.map(dtoMeasurementElement,
    ...
    public void testMeasurementReportHeaderMapping() {
        ...
        final MeasurementReportHeaderDto dtoMeasurementReportHeader = DtoMeasurementsFactory
                .spontaneousReportHeader(commonAddress);

        // Act
        final MeasurementReportHeader actual = this.mapper.map(dtoMeasurementReportHeader,
