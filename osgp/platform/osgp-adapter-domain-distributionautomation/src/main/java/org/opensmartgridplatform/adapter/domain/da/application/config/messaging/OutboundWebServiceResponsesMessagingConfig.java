...
public class OutboundWebServiceResponsesMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainDistributionAutomationOutboundWebServiceResponsesConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainDistributionAutomationOutboundWebServiceResponsesConnectionFactory bean.");
        return this.jmsConfigurationFactory.getPooledConnectionFactory();
    }

    @Bean(name = "domainDistributionAutomationOutboundWebServiceResponsesJmsTemplate")
    public JmsTemplate jmsTemplate() {
        LOGGER.info("Initializing domainDistributionAutomationOutboundWebServiceResponsesJmsTemplate bean.");
