...
@Component(value = "domainDistributionAutomationOutgoingOsgpCoreRequestMessageSender")
public class OsgpCoreRequestMessageSender {

    @Autowired
    @Qualifier("domainDistributionAutomationOutgoingOsgpCoreRequestsJmsTemplate")
