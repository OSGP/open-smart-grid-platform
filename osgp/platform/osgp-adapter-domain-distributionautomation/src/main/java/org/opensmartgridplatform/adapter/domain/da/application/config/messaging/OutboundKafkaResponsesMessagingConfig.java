...
public class OutboundKafkaResponsesMessagingConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OutboundKafkaResponsesMessagingConfig.class);

    private final JmsConfigurationFactory jmsConfigurationFactory;

    public OutboundKafkaResponsesMessagingConfig(final Environment environment,
    ...
    @Bean(destroyMethod = "stop", name = "domainDistributionAutomationOutboundKafkaResponsesConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainDistributionAutomationOutboundKafkaResponsesConnectionFactory bean.");
