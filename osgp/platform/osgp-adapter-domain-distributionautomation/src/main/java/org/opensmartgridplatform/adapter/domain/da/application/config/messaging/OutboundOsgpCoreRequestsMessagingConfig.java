...
public class OutboundOsgpCoreRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainDistributionAutomationOutboundOsgpCoreRequestsConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainDistributionAutomationOutboundOsgpCoreRequestsConnectionFactory bean.");
