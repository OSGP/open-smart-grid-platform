...
public class BaseResponseMessageSender {
     ...
     *
     * @param jmsTemplate
     *            The jms template used for sending the message
     * @param responseMessage
     *            The response message to send.
     * @param timeToLive
     *            The custom time to live value in milliseconds.
     */
    protected void send(final JmsTemplate jmsTemplate, final ResponseMessage responseMessage, final Long timeToLive,
        ...
        jmsTemplate.send((final Session session) -> {
