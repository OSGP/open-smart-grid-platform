...
@Repository
public interface ScheduledTaskWithoutDataRepository extends JpaRepository<ScheduledTaskWithoutData, Long> {

    List<ScheduledTaskWithoutData> findByDeviceIdentification(String deviceIdentification);

    List<ScheduledTaskWithoutData> findByOrganisationIdentification(String organisationIdentification);
}
