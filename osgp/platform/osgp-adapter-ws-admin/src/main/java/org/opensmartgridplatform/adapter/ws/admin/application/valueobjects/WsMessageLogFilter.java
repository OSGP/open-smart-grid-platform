...
public class WsMessageLogFilter {
    ...
    public String toString() {
        return "WsMessageLogFilter [deviceIdentification=" + this.deviceIdentification + ", organisationIdentification="
                + this.organisationIdentification + ", startTime=" + this.startTime + ", endTime=" + this.endTime
                + ", pageRequested=" + this.pageRequested + ", sortBy=" + this.sortBy + ", sortDirection="
                + this.sortDirection + "]";
    }
