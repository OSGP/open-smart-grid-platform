...
public class WebServiceMonitorInterceptorCapabilities {
    ...
    public WebServiceMonitorInterceptorCapabilities(final boolean soapMessageLoggingEnabled,
    ...
    public String toString() {
        return "WebServiceMonitorInterceptorCapabilities [soapMessageLoggingEnabled=" + this.soapMessageLoggingEnabled
                + ", soapMessagePrintingEnabled=" + this.soapMessagePrintingEnabled + "]";
    }
