...
public class CommonUpdateDeviceCdmaSettingsRequestMessageProcessor extends BaseMessageProcessor {

  /** Logger for this class */
  private static final Logger LOGGER =
      LoggerFactory.getLogger(CommonUpdateDeviceCdmaSettingsRequestMessageProcessor.class);
  ...
  public CommonUpdateDeviceCdmaSettingsRequestMessageProcessor(
    ...
    super(
        ...
        messageProcessorMap,
        MessageType.UPDATE_DEVICE_CDMA_SETTINGS,
  ...
  public void processMessage(final ObjectMessage message) {
    ...
    try {
      ...
      this.deviceManagementService.updateDeviceCdmaSettings(
          organisationIdentification, deviceIdentification, correlationUid, cdmaSettings);
