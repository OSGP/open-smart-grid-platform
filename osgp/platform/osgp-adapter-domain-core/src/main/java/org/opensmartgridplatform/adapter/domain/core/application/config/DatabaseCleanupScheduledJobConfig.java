...
public class DatabaseCleanupScheduledJobConfig {
    ...
    private void initializeScheduledJob() throws SchedulerException {
        this.osgpScheduler.createAndScheduleJob(EventCleanupJob.class, this.cronExpressionDatabaseCleanupEvent);
        this.osgpScheduler.createAndScheduleJob(DeviceMessageCleanupJob.class,
                this.cronExpressionDatabaseCleanupDeviceMessage);
    }
