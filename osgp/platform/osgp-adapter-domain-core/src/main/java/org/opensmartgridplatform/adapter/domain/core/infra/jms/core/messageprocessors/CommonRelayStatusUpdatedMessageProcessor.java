...
@Component
public class CommonRelayStatusUpdatedMessageProcessor extends DomainCoreDeviceRequestMessageProcessor {
    ...
    public void processMessage(final ObjectMessage message) throws JMSException {
        ...
        final RequestMessage requestMsg = new RequestMessage(messageMetadata.getCorrelationUid(),
                messageMetadata.getOrganisationIdentification(), messageMetadata.getDeviceIdentification(), null);
