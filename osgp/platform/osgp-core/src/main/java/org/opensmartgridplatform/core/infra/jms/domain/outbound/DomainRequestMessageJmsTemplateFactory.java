...
public class DomainRequestMessageJmsTemplateFactory implements InitializingBean, DisposableBean {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DomainRequestMessageJmsTemplateFactory.class);
    ...
    private void init(final DomainInfo domainInfo) throws SSLException {
        ...
        final JmsConfigurationFactory jmsConfigurationFactory = new JmsConfigurationFactory(this.environment,
                this.defaultDomainJmsConfiguration, domainInfo.getOutgoingRequestsPropertyPrefix());
