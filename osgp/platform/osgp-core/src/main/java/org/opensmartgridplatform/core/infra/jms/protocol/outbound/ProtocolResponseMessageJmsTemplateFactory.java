...
public class ProtocolResponseMessageJmsTemplateFactory implements InitializingBean, DisposableBean {
    ...
    public ProtocolResponseMessageJmsTemplateFactory(final Environment environment,
    ...
    private void init(final ProtocolInfo protocolInfo) throws SSLException {
        ...
        final JmsConfigurationFactory jmsConfigurationFactory = new JmsConfigurationFactory(this.environment,
                this.defaultProtocolJmsConfiguration, protocolInfo.getOutgoingResponsesPropertyPrefix());
