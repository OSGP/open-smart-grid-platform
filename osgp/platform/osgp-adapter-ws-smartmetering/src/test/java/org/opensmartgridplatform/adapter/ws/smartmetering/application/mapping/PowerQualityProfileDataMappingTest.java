...
public class PowerQualityProfileDataMappingTest {
    ...
    private List<org.opensmartgridplatform.domain.core.valueobjects.smartmetering.CaptureObject> makeCaptureObjectsVo() {
        final List<org.opensmartgridplatform.domain.core.valueobjects.smartmetering.CaptureObject> captureObjectVos =
                new ArrayList<>();
    ...
    private ProfileEntry makeProfileEntryVo() {
        final List<org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ProfileEntryValue> entriesVo =
                new ArrayList<>();
    ...
    private PowerQualityProfileData makeresponseVo() {
        final PowerQualityProfileData result = new PowerQualityProfileData(this.makeObisCode(),
    ...
    public void testProfileEntry() {
        org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ProfileEntryValue profileEntryValueVo =
    ...
    public void testPowerQualityProfileDataResponse() {
        ...
        final org.opensmartgridplatform.adapter.ws.schema.smartmetering.monitoring.PowerQualityProfileData target = this.monitoringMapper
                .map(source,
                        org.opensmartgridplatform.adapter.ws.schema.smartmetering.monitoring.PowerQualityProfileData.class);
        ...
        for (final ProfileEntryValue profileEntryValue : target.getProfileEntryList().getProfileEntries().get(0)
            ...
            assertThat(profileEntryValue.getStringValueOrDateValueOrFloatValue() != null && !profileEntryValue
                    .getStringValueOrDateValueOrFloatValue().isEmpty()).isTrue();
        }
    }
