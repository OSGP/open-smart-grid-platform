...
public class GetPowerQualityProfileDataResponseMappingTest {
    ...
    private void assertObisCode(
        ...
        assertThat(actualObisCode.getA()).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceObisCode.getA());
        assertThat(actualObisCode.getB()).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceObisCode.getB());
        assertThat(actualObisCode.getC()).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceObisCode.getC());
        assertThat(actualObisCode.getD()).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceObisCode.getD());
        assertThat(actualObisCode.getE()).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceObisCode.getE());
        assertThat(actualObisCode.getF()).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceObisCode.getF());
    }
    ...
    private void assertProfileEntries(
        ...
        assertThat(actualProfileEntries.size()).as(MAPPED_LIST_SIZE_MESSAGE).isEqualTo(sourceProfileEntries.size());
    ...
    private void assertProfileEntryValue(
        ...
        if (actual instanceof XMLGregorianCalendar) {
            ...
            assertThat(actualDate).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceProfileEntryValue.getValue());
        } else {
            assertThat(actual).as(MAPPED_FIELD_VALUE_MESSAGE).isEqualTo(sourceProfileEntryValue.getValue());
        }
    }
    ...
    public void shouldConvertProfileGenericDataResponse() {
        ...
        final GetPowerQualityProfileResponseData source = new GetPowerQualityProfileResponseData(obisCode,
                captureObjects, profileEntries);
        ...
        // Assert
        this.assertObisCode(target.getPowerQualityProfileData().getLogicalName(), obisCode);
        this.assertCaptureObjects(target.getPowerQualityProfileData().getCaptureObjectList().getCaptureObjects(),
                captureObjects);
        this.assertProfileEntries(target.getPowerQualityProfileData().getProfileEntryList().getProfileEntries(),
                profileEntries);
