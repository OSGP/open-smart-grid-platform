...
public class ListEventMappingTest {
    ...
    private static final List<Event> STANDARD_EVENTS = Arrays.asList(
            new Event(DateTime.now(), EventType.EVENTLOG_CLEARED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.POWER_FAILURE, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.POWER_RETURNED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_UPDATE, null, EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_ADJUSTED_OLD_TIME, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_ADJUSTED_NEW_TIME, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_INVALID, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.REPLACE_BATTERY, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.BATTERY_VOLTAGE_LOW, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.TARIFF_ACTIVATED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.ERROR_REGISTER_CLEARED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.ALARM_REGISTER_CLEARED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.HARDWARE_ERROR_PROGRAM_MEMORY, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.HARDWARE_ERROR_RAM, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.HARDWARE_ERROR_NV_MEMORY, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.WATCHDOG_ERROR, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.HARDWARE_ERROR_MEASUREMENT_SYSTEM, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.FIRMWARE_READY_FOR_ACTIVATION, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.FIRMWARE_ACTIVATED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.PASSIVE_TARIFF_UPDATED, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.SUCCESSFUL_SELFCHECK_AFTER_FIRMWARE_UPDATE, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_231, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_232, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_233, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_234, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_235, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_236, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_237, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_238, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_239, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_240, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_241, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_242, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_243, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_244, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_245, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_246, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_247, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_248, null,
                    EventLogCategory.STANDARD_EVENT_LOG),
            new Event(DateTime.now(), EventType.MANUFACTURER_SPECIFIC_249, null,
                    EventLogCategory.STANDARD_EVENT_LOG));

    private static final List<Event> FRAUD_DETECTION_EVENTS = Arrays.asList(
            new Event(DateTime.now(), EventType.TERMINAL_COVER_REMOVED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.TERMINAL_COVER_CLOSED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.STRONG_DC_FIELD_DETECTED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.NO_STRONG_DC_FIELD_ANYMORE, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.METER_COVER_REMOVED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.METER_COVER_CLOSED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.FAILED_LOGIN_ATTEMPT, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.CONFIGURATION_CHANGE, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.MODULE_COVER_OPENED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.MODULE_COVER_CLOSED, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.MODULE_COVER_OPENED_ISKR, null,
                    EventLogCategory.FRAUD_DETECTION_LOG),
            new Event(DateTime.now(), EventType.MODULE_COVER_CLOSED_ISKR, null,
                    EventLogCategory.FRAUD_DETECTION_LOG));

    private static final List<Event> COMMUNICATION_SESSIONS_EVENTS = Arrays.asList(
            new Event(DateTime.now(), EventType.METROLOGICAL_MAINTENANCE, 0,
                    EventLogCategory.COMMUNICATION_SESSION_LOG),
            new Event(DateTime.now(), EventType.TECHNICAL_MAINTENANCE, 0,
                    EventLogCategory.COMMUNICATION_SESSION_LOG),
            new Event(DateTime.now(), EventType.RETRIEVE_METER_READINGS_E, 0,
                    EventLogCategory.COMMUNICATION_SESSION_LOG),
            new Event(DateTime.now(), EventType.RETRIEVE_METER_READINGS_G, 1,
                    EventLogCategory.COMMUNICATION_SESSION_LOG),
            new Event(DateTime.now(), EventType.RETRIEVE_INTERVAL_DATA_E, 3754,
                    EventLogCategory.COMMUNICATION_SESSION_LOG),
            new Event(DateTime.now(), EventType.RETRIEVE_INTERVAL_DATA_G, 65535,
                    EventLogCategory.COMMUNICATION_SESSION_LOG));

    private static final List<Event> M_BUS_EVENTS = Arrays.asList(
            new Event(DateTime.now(), EventType.COMMUNICATION_ERROR_M_BUS_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_OK_M_BUS_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.REPLACE_BATTERY_M_BUS_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.FRAUD_ATTEMPT_M_BUS_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_ADJUSTED_M_BUS_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.NEW_M_BUS_DEVICE_DISCOVERED_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.PERMANENT_ERROR_FROM_M_BUS_DEVICE_CHANNEL_1, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_ERROR_M_BUS_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_OK_M_BUS_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.REPLACE_BATTERY_M_BUS_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.FRAUD_ATTEMPT_M_BUS_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_ADJUSTED_M_BUS_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.NEW_M_BUS_DEVICE_DISCOVERED_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.PERMANENT_ERROR_FROM_M_BUS_DEVICE_CHANNEL_2, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_ERROR_M_BUS_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_OK_M_BUS_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.REPLACE_BATTERY_M_BUS_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.FRAUD_ATTEMPT_M_BUS_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_ADJUSTED_M_BUS_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.NEW_M_BUS_DEVICE_DISCOVERED_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.PERMANENT_ERROR_FROM_M_BUS_DEVICE_CHANNEL_3, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_ERROR_M_BUS_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.COMMUNICATION_OK_M_BUS_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.REPLACE_BATTERY_M_BUS_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.FRAUD_ATTEMPT_M_BUS_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.CLOCK_ADJUSTED_M_BUS_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.NEW_M_BUS_DEVICE_DISCOVERED_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG),
            new Event(DateTime.now(), EventType.PERMANENT_ERROR_FROM_M_BUS_DEVICE_CHANNEL_4, null,
                    EventLogCategory.M_BUS_EVENT_LOG));
    ...
    public void testFilledListEventMapping() {
        ...
        final Event event = new Event(timestamp, EVENT_TYPE, EVENT_COUNTER, EventLogCategory.STANDARD_EVENT_LOG);
        final List<Event> listOriginal = new ArrayList<>();
