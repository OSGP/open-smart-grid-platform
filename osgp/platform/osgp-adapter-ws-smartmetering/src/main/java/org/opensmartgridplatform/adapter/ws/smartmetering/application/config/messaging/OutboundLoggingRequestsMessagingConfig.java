  ...
  public OutboundLoggingRequestsMessagingConfig(
    ...
    this.jmsConfigurationFactory =
        new JmsConfigurationFactory(
            environment, defaultJmsConfiguration, JmsConfigurationNames.JMS_SMARTMETERING_LOGGING);
  }

  @Bean(destroyMethod = "stop", name = "wsSmartMeteringOutboundLoggingRequestsConnectionFactory")
  public ConnectionFactory connectionFactory() {
    LOGGER.info("Initializing wsSmartMeteringOutboundLoggingRequestsConnectionFactory bean.");
