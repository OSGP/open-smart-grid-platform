...
public class PowerQualityValueConverter extends
        CustomConverter<org.opensmartgridplatform.domain.core.valueobjects.smartmetering.PowerQualityValue, PowerQualityValue> {

    @Override
    public PowerQualityValue convert(
            final org.opensmartgridplatform.domain.core.valueobjects.smartmetering.PowerQualityValue source,
