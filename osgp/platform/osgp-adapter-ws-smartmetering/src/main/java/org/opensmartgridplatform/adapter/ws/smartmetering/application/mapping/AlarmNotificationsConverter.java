...
public class AlarmNotificationsConverter extends
        BidirectionalConverter<AlarmNotifications, org.opensmartgridplatform.adapter.ws.schema.smartmetering.configuration.AlarmNotifications> {

    @Override
    public org.opensmartgridplatform.adapter.ws.schema.smartmetering.configuration.AlarmNotifications convertTo(
            final AlarmNotifications source,
            final Type<org.opensmartgridplatform.adapter.ws.schema.smartmetering.configuration.AlarmNotifications> destinationType,
        ...
        final List<org.opensmartgridplatform.adapter.ws.schema.smartmetering.configuration.AlarmNotification> alarmNotifications = result
        ...
        for (final AlarmNotification sourceNotification : sourceNotifications) {
            ...
            alarmNotification.setAlarmType(org.opensmartgridplatform.adapter.ws.schema.smartmetering.common.AlarmType
    ...
    public AlarmNotifications convertFrom(
            final org.opensmartgridplatform.adapter.ws.schema.smartmetering.configuration.AlarmNotifications source,
        ...
        final List<org.opensmartgridplatform.adapter.ws.schema.smartmetering.configuration.AlarmNotification> sourceNotifications = source
                .getAlarmNotification();
