...
@Component
public class CleanUpMbusDeviceByChannelRequestMessageProcessor extends BaseRequestMessageProcessor {
    ...
    protected CleanUpMbusDeviceByChannelRequestMessageProcessor(
        ...
        super(messageProcessorMap, MessageType.CLEAN_UP_MBUS_DEVICE_BY_CHANNEL);
    }
    ...
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata, final Object dataObject)
        ...
        final CleanUpMbusDeviceByChannelRequestData cleanUpMbusDeviceByChannelRequest = (CleanUpMbusDeviceByChannelRequestData) dataObject;

        this.installationService.cleanUpMbusDeviceByChannel(deviceMessageMetadata, cleanUpMbusDeviceByChannelRequest);
    }
}
