...
public class GetModemInfoResponseMessageProcessor extends OsgpCoreResponseMessageProcessor {
    ...
    @Autowired
    protected GetModemInfoResponseMessageProcessor(WebServiceResponseMessageSender responseMessageSender,
            @Qualifier("domainSmartMeteringInboundOsgpCoreResponsesMessageProcessorMap") MessageProcessorMap messageProcessorMap) {
        super(responseMessageSender, messageProcessorMap, MessageType.GET_MODEM_INFO,
    ...
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        this.managementService.handleGetModemInfoResponse(deviceMessageMetadata,
