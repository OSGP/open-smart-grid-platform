...
@Component
public class SetClockConfigurationResponseMessageProcessor
  ...
  protected SetClockConfigurationResponseMessageProcessor(
    ...
    super(
        ...
        messageProcessorMap,
        MessageType.SET_CLOCK_CONFIGURATION,
  ...
  protected void handleMessage(
    ...
    this.configurationService.handleSetClockConfigurationResponse(
