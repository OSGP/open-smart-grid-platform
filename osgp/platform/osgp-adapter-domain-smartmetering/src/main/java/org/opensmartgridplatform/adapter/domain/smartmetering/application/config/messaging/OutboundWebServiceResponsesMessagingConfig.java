...
public class OutboundWebServiceResponsesMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainSmartMeteringOutboundWebServiceResponsesConnectionFactory")
    public ConnectionFactory connectionFactory() {
        LOGGER.info("Initializing domainSmartMeteringOutboundWebServiceResponsesConnectionFactory bean.");
