...
public class InboundOsgpCoreRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainSmartMeteringInboundOsgpCoreRequestsConnectionFactory")
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainSmartMeteringInboundOsgpCoreRequestsMessageListener") final MessageListener messageListener) {
        LOGGER.info("Initializing domainSmartMeteringInboundOsgpCoreRequestsMessageListenerContainer bean.");
