...
public class GetPowerQualityProfileRequestMessageProcessor extends BaseRequestMessageProcessor {
  ...
  protected void handleMessage(final MessageMetadata deviceMessageMetadata, final Object dataObject)
    ...
    final GetPowerQualityProfileRequest getPowerQualityProfileRequest =
        (GetPowerQualityProfileRequest) dataObject;

    this.monitoringService.requestPowerQualityProfile(
        deviceMessageMetadata, getPowerQualityProfileRequest);
  }
}
