...
@Component
public class SetAlarmNotificationsResponseMessageProcessor
  ...
  protected SetAlarmNotificationsResponseMessageProcessor(
    ...
    super(
        ...
        messageProcessorMap,
        MessageType.SET_ALARM_NOTIFICATIONS,
  ...
  protected void handleMessage(
    ...
    this.configurationService.handleSetAlarmNotificationsResponse(
