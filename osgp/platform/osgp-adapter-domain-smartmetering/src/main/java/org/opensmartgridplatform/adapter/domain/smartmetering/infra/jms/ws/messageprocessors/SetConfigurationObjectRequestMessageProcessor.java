...
@Component
public class SetConfigurationObjectRequestMessageProcessor extends BaseRequestMessageProcessor {
  ...
  protected void handleMessage(final MessageMetadata deviceMessageMetadata, final Object dataObject)
    ...
    final SetConfigurationObjectRequest setConfigurationObjectRequest =
        (SetConfigurationObjectRequest) dataObject;

    this.configurationService.setConfigurationObject(
        deviceMessageMetadata, setConfigurationObjectRequest);
  }
}
