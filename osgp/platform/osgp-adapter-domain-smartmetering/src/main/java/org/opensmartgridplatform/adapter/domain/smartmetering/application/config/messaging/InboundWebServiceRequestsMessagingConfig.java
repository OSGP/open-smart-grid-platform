...
public class InboundWebServiceRequestsMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainSmartMeteringInboundWebServiceRequestsConnectionFactory")
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainSmartMeteringInboundWebServiceRequestsMessageListener") final MessageListener messageListener) {
