...
public class MonitoringService {
    ...
    public void requestPeriodicMeterReads(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        if (periodicMeterReadsValueQuery.isMbusDevice()) {
            ...
            this.osgpCoreRequestMessageSender.send(new RequestMessage(deviceMessageMetadata.getCorrelationUid(),
                            ...
                            gatewayDevice.getIpAddress(), periodicMeterReadsQuery),
    ...
    public void handlePeriodicMeterReadsresponse(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        final ResponseMessage responseMessage = ResponseMessage.newResponseMessageBuilder().withCorrelationUid(
                ...
                deviceMessageMetadata.getDeviceIdentification()).withResult(result).withOsgpException(exception)
                                                               .withDataObject(this.monitoringMapper
    ...
    public void requestActualMeterReads(final DeviceMessageMetadata deviceMessageMetadata,
            final org.opensmartgridplatform.domain.core.valueobjects.smartmetering.ActualMeterReadsQuery actualMeterReadsQuery)
        ...
        if (actualMeterReadsQuery.isMbusDevice()) {
            ...
            this.osgpCoreRequestMessageSender.send(new RequestMessage(deviceMessageMetadata.getCorrelationUid(),
                            deviceMessageMetadata.getOrganisationIdentification(),
                            deviceMessageMetadata.getDeviceIdentification(), smartMeter.getIpAddress(),
                            new ActualMeterReadsQueryDto()), deviceMessageMetadata.getMessageType(),
                    deviceMessageMetadata.getMessagePriority(), deviceMessageMetadata.getScheduleTime());
        }
    }
    ...
    public void handleActualMeterReadsResponse(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        final ResponseMessage responseMessage = ResponseMessage.newResponseMessageBuilder().withCorrelationUid(
                ...
                deviceMessageMetadata.getDeviceIdentification()).withResult(result).withOsgpException(exception)
                                                               .withDataObject(this.monitoringMapper
                                                                       .map(actualMeterReadsDto, MeterReads.class))
                                                               .withMessagePriority(
                                                                       deviceMessageMetadata.getMessagePriority())
                                                               .build();
        this.webServiceResponseMessageSender.send(responseMessage, deviceMessageMetadata.getMessageType());
    ...
    public void handleActualMeterReadsResponse(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        final ResponseMessage responseMessage = ResponseMessage.newResponseMessageBuilder().withCorrelationUid(
                ...
                deviceMessageMetadata.getDeviceIdentification()).withResult(result).withOsgpException(exception)
                                                               .withDataObject(this.monitoringMapper
                                                                       .map(actualMeterReadsGas, MeterReadsGas.class))
                                                               .withMessagePriority(
                                                                       deviceMessageMetadata.getMessagePriority())
                                                               .build();
        this.webServiceResponseMessageSender.send(responseMessage, deviceMessageMetadata.getMessageType());
    ...
    public void requestActualPowerQuality(final DeviceMessageMetadata deviceMessageMetadata,
            final ActualPowerQualityRequestData request) throws FunctionalException {
        ...
        final ActualPowerQualityRequestDto requestDto = this.monitoringMapper
                .map(request, ActualPowerQualityRequestDto.class);
    ...
    public void handleActualPowerQualityResponse(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        LOGGER.info("handleGetActualPowerQualityResponse for MessageType: {}", deviceMessageMetadata.getMessageType());
        ...
        final ActualPowerQualityResponse actualPowerQualityResponse = this.monitoringMapper
                .map(actualPowerQualityResponseDto, ActualPowerQualityResponse.class);
    ...
    public void requestPowerQualityProfile(final DeviceMessageMetadata deviceMessageMetadata,
            final GetPowerQualityProfileRequest request) throws FunctionalException {

        LOGGER.info("requestPowerQualityProfile for organisationIdentification: {} for deviceIdentification: {}",
                deviceMessageMetadata.getOrganisationIdentification(), deviceMessageMetadata.getDeviceIdentification());

        final SmartMeter smartMeter = this.domainHelperService
                .findSmartMeter(deviceMessageMetadata.getDeviceIdentification());

        final ConfigureDefinableLoadProfileRequestDto requestDto = this.monitoringMapper
                .map(request, ConfigureDefinableLoadProfileRequestDto.class);
