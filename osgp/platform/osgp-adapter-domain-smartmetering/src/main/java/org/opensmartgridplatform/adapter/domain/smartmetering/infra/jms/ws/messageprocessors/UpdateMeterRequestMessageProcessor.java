...
@Component
public class UpdateMeterRequestMessageProcessor extends BaseRequestMessageProcessor {
    ...
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata, final Object dataObject)
        ...
        final UpdateSmartMeterRequest updateSmartMeterRequest = (UpdateSmartMeterRequest) dataObject;

        this.installationService.updateMeter(deviceMessageMetadata, updateSmartMeterRequest);
    }
}
