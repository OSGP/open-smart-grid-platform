...
public class SetPushSetupSmsResponseMessageProcessor extends OsgpCoreResponseMessageProcessor {
    ...
    @Autowired
    protected SetPushSetupSmsResponseMessageProcessor(WebServiceResponseMessageSender responseMessageSender,
            @Qualifier("domainSmartMeteringInboundOsgpCoreResponsesMessageProcessorMap") MessageProcessorMap messageProcessorMap) {
        super(responseMessageSender, messageProcessorMap, MessageType.SET_PUSH_SETUP_SMS,
    ...
    protected void handleMessage(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        this.configurationService.handleSetPushSetupSmsResponse(deviceMessageMetadata, responseMessage.getResult(),
                osgpException);
    }
}
