...
import org.opensmartgridplatform.dto.valueobjects.smartmetering.SetRandomizationSettingsRequestDataDto;
...
public class ActionMapperService {
    ...
    static {
        ...
        CLASS_MAP.put(SetRandomizationSettingsRequestData.class, SetRandomizationSettingsRequestDataDto.class);
    }
    ...
    private void postConstruct() {
        ...
        CLASS_TO_MAPPER_MAP.put(SetRandomizationSettingsRequestData.class, this.configurationMapper);
    }
