...
public class ManagementService {
    ...
    public void setDeviceCommunicationSettings(final DeviceMessageMetadata deviceMessageMetadata,
            final org.opensmartgridplatform.domain.core.valueobjects.smartmetering.SetDeviceCommunicationSettingsRequest setDeviceCommunicationSettingsRequest)
    ...
    public void getModemInfo(final DeviceMessageMetadata deviceMessageMetadata,
            final GetModemInfoRequestData request) throws FunctionalException {

        LOGGER.info("Get modem info for organisationIdentification: {} for deviceIdentification: {}",
                deviceMessageMetadata.getOrganisationIdentification(), deviceMessageMetadata.getDeviceIdentification());

        final GetModemInfoRequestDto requestDto = this.managementMapper.map(request,
                GetModemInfoRequestDto.class);
        final SmartMeter smartMeteringDevice = this.domainHelperService
                .findSmartMeter(deviceMessageMetadata.getDeviceIdentification());
    ...
    public void handleGetModemInfoResponse(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        LOGGER.info("handleGetModemInfoResponse for MessageType: {}",
                deviceMessageMetadata.getMessageType());

        final String deviceIdentification = deviceMessageMetadata.getDeviceIdentification();

        final GetModemInfoResponseData responseData = this.managementMapper.map(responseDto,
