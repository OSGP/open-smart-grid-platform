...
public class BundleService {
    ...
    private void checkIfAdditionalActionIsNeeded(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        for (final ActionResponseDto action : bundleResponseMessageDataContainerDto.getAllResponses()) {
            ...
            } else if (action instanceof DeCoupleMbusDeviceByChannelResponseDto) {
                    this.mBusGatewayService.handleDeCoupleMbusDeviceByChannelResponse(deviceMessageMetadata,
                            (DeCoupleMbusDeviceByChannelResponseDto) action);
