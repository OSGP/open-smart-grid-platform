...
public class InboundOsgpCoreResponsesMessagingConfig {
    ...
    @Bean(destroyMethod = "stop", name = "domainSmartMeteringInboundOsgpCoreResponsesConnectionFactory")
    ...
    public DefaultMessageListenerContainer messageListenerContainer(
            @Qualifier("domainSmartMeteringInboundOsgpCoreResponsesMessageListener") final MessageListener messageListener) {
        LOGGER.info("Initializing domainSmartMeteringInboundOsgpCoreResponsesMessageListenerContainer bean.");
