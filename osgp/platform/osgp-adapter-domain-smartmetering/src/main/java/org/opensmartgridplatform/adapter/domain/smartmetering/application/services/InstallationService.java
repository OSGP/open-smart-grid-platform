...
public class InstallationService {
    ...
    public void handleDeCoupleMbusDeviceByChannelResponse(final DeviceMessageMetadata deviceMessageMetadata,
        ...
        Optional<SmartMeter> mbusDeviceFoundOnChannel =
                this.mBusGatewayService.handleDeCoupleMbusDeviceResponse(deviceMessageMetadata,
                deCoupleMbusDeviceResponseDto);

        final String mbusDeviceDeviceIdentification = mbusDeviceFoundOnChannel.isPresent()?
                mbusDeviceFoundOnChannel.get().getDeviceIdentification():null;

        final DeCoupleMbusDeviceByChannelResponse response =
                new DeCoupleMbusDeviceByChannelResponse(mbusDeviceDeviceIdentification,
