...
public class JreEncryptionProviderTest {
  ...
  public void identityTest() throws EncrypterException {
    ...
    assertEquals("f2edbdc2ad1dab1458f1b866c5a5e6a6", encryptedSecretAsString);
  ...
  public void generateKeyAndCheckLengths() {
    ...
    assertEquals(16, encryptedSecretBytes.length);
    assertEquals(32, encryptedSecretAsString.length());
  }
