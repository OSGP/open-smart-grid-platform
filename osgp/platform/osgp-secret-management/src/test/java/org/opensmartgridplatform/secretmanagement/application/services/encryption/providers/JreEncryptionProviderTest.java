...
//    final EncryptedSecret encryptedSecret = this.jreEncryptionProvider.encrypt(secret,
// JRE_KEY_REF);
...
//
//    final byte[] decryptedSecret = this.jreEncryptionProvider.decrypt(encryptedSecret,
// JRE_KEY_REF);
...
// +
//   * 1 block (32 byte) encrypted secrets. Decrypting a PKCS5Padded secret using NoPadding results
// in
