...
public class MicrogridsRequestMessageSender {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(MicrogridsRequestMessageSender.class);
   ...
   *
   * @param requestMessage The MicrogridsRequestMessage request message to send.
   * @throws ArgumentNullOrEmptyException
   */
  public void send(final MicrogridsRequestMessage requestMessage)
      throws ArgumentNullOrEmptyException {
