...
public class WebServiceConfig extends AbstractConfig {
  ...
  private static final String PROPERTY_NAME_MARSHALLER_CONTEXT_PATH_MICROGRIDS_AD_HOC_MANAGEMENT =
      "jaxb2.marshaller.context.path.microgrids.adhocmanagement";
  ...
  public Jaxb2Marshaller microgridsAdHocManagementMarshaller() {
    ...
    marshaller.setContextPath(
        this.environment.getRequiredProperty(
            PROPERTY_NAME_MARSHALLER_CONTEXT_PATH_MICROGRIDS_AD_HOC_MANAGEMENT));
  ...
  public DefaultMethodEndpointAdapter defaultMethodEndpointAdapter() {
    ...
    methodReturnValueHandlers.add(
        this.microgridsAdHocManagementMarshallingPayloadMethodProcessor());
