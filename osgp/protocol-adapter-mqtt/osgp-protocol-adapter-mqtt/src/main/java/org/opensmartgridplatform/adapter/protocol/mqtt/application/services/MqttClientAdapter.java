...
public class MqttClientAdapter {
    ...
    public MqttClientAdapter(final MqttDevice device, final MessageMetadata messageMetadata,
    ...
    public void connect() {
        ...
        this.client.connectWith()
                .send()
                .whenComplete((ack, throwable) -> this.mqttClientEventHandler.onConnect(this, ack, throwable));
    }
    ...
    public void subscribe(final String topic, final MqttQos qos) {
        this.client.subscribeWith()
                ...
                .send()
                .whenComplete((subAck, throwable) -> this.mqttClientEventHandler.onSubscribe(this, subAck, throwable));
    }
