...
public class OutboundOsgpCoreRequestMessageSender {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OutboundOsgpCoreRequestMessageSender.class);

    private final JmsTemplate protocolMqttOutboundOsgpCoreRequestsJmsTemplate;

    public OutboundOsgpCoreRequestMessageSender(final JmsTemplate protocolMqttOutboundOsgpCoreRequestsJmsTemplate) {
        this.protocolMqttOutboundOsgpCoreRequestsJmsTemplate = protocolMqttOutboundOsgpCoreRequestsJmsTemplate;
    }
