...
public class JmsBrokerSslSettings {
    ...
    public JmsBrokerSslSettings(final String clientKeyStore, final String clientKeyStorePwd, final String trustKeyStore,
     ...
     *
     * @param factory
     *            The connection factory to which the SSL settings are applied.
     * @throws SSLException
     *             Thrown when applying the SSL settings fails or when the
     *             broker URL is null.
     */
    public void applyToFactory(final ActiveMQSslConnectionFactory factory) throws SSLException {
        try {
            ...
            throw new SSLException("Applying the SSL settings for the ActiveMQ connection factory failed", e);
        }
    }
