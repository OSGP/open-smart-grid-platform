...
public class AbstractClient {
    ...
    protected static final String HEADER_PARAM_REQUESTING_ORGANISATION_IDENTIFICATION = "requestingOrgId";
    protected static final String HEADER_PARAM_TOKEN = "token";

    protected static final String RESPONSE_IS_NULL = "response is null";
    protected static final String HTTP_STATUS_IS_NOT_200 = "httpStatusCode is not 200, httpStatusCode: ";
    ...
    protected WebClient getWebClientInstance() {
        ...
        return WebClient.fromClient(this.webClient).accept(MediaType.APPLICATION_JSON).type(MediaType.APPLICATION_JSON)
                .encoding(UTF_8);
    }
