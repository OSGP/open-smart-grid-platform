...
public enum WebServiceTemplateHostnameVerificationStrategy {
    ...
    /**
     * No verification of hostnames. Turns hostname verification off. This
     * implementation is a no-op, and never throws an SSLException.
     */
    ALLOW_ALL_HOSTNAMES,

    /**
     * The HostnameVerifier that works the same way as Curl and Firefox. The
