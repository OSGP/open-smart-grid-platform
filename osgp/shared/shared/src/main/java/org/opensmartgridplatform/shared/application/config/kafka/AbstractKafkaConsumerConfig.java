...
public abstract class AbstractKafkaConsumerConfig<K, V> extends KafkaConfig {
    ...
    public AbstractKafkaConsumerConfig(final Environment environment, final String propertiesPrefix, final String topic,
    ...
    private ConcurrentKafkaListenerContainerFactory<K, V> initKafkaListenerContainerFactory(final int concurrency,
    ...
    private Map<String, Object> consumerConfigs(final String propertiesPrefix) {
        ...
        KafkaProperties.consumerProperties()
                .forEach((k, v) -> this.addIfExist(properties, k, getConsumerPropertiesPrefix(propertiesPrefix), v));
        return properties;
    }
