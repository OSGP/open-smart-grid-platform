...
/**
 * Component that exposes custom metrics, created using Micrometer, for Prometheus.
 * Based on the example code <a href=https://micrometer.io/docs/registry/prometheus#_configuring>here</a>.
 * <p>
 * How to use:
 * <ol>
 ...
 * See <a href=https://micrometer.io/docs/concepts#_meters>the Micrometer documentation</a> for more.</li>
 * </ol>
 */
// Suppress warnings, since HttpServer and HttpExchange are "suitable for use outside of the JDK implementation itself".
