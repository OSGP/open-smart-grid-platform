...
public final class JmsPropertyNames {
    ...
    public static final String PROPERTY_NAME_CONNECTION_POOL_MAX_ACTIVE_SESSIONS = "connection.pool.max.active.sessions";
    public static final String PROPERTY_NAME_CONNECTION_POOL_BLOCK_IF_SESSION_POOL_IS_FULL = "connection.pool.block.if.session.pool.is.full";
    public static final String PROPERTY_NAME_CONNECTION_POOL_BLOCK_IF_SESSION_POOL_IS_FULL_TIMEOUT = "connection.pool.block.if.session.pool.is.full.timeout";
    public static final String PROPERTY_NAME_CONNECTION_POOL_EXPIRY_TIMEOUT = "connection.pool.expiry.timeout";
    public static final String PROPERTY_NAME_CONNECTION_POOL_TIME_BETWEEN_EXPIRATION_CHECK_MILLIS = "connection.pool.time.between.expiration.check.millis";
    public static final String PROPERTY_NAME_CONNECTION_POOL_IDLE_TIMEOUT = "connection.pool.idle.timeout";
    ...
    public static final String PROPERTY_NAME_BROKER_CLIENT_KEY_STORE_SECRET = "broker.client.key.store.pwd";
    public static final String PROPERTY_NAME_BROKER_CLIENT_TRUST_STORE = "broker.client.trust.store";
    public static final String PROPERTY_NAME_BROKER_CLIENT_TRUST_STORE_SECRET = "broker.client.trust.store.pwd";
