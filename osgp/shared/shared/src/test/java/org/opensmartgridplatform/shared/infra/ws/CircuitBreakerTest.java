...
/// LoggerFactory.getLogger(CircuitBreakerTest.class);
//
...
/// CircuitBreaker.Builder().withThreshold(2).withInitialDuration(30)
...
// try {
// new
/// CircuitBreaker.Builder().withThreshold(0).withInitialDuration(0).withMaximumDuration(0)
// .withMultiplier(0).build();
// } catch (final Exception e) {
// Assertions.fail("Exception should not occur for valid build call");
// }
// }
//
// private void failIllegalArgument(final String fieldName) {
// Assertions.fail(String.format("CircuitBreaker should not have been created
/// because of an illegal value for [%s]",
// fieldName));
// }
//
// private void checkIllegalArgumentExceptionMessage(final
/// IllegalArgumentException e) {
// // Checks an essential part of the error message instead
// // of the exact full text.
// final String exceptionMessage = e.getMessage();
// Assertions.assertTrue(exceptionMessage.contains("negative value"));
// }
//
// @Test
// public void testInitiallyClosed() {
// LOGGER.info("Test: expect initial status is CLOSED");
// Assertions.assertTrue("Initial status should be CLOSED",
...
// Assertions.assertFalse("Should be OPEN after explicit open circuit request",
/// this.circuitBreaker.isClosed());
// }
//
// @Test
...
// Assertions.assertTrue("Should be CLOSED after explicit close circuit
/// request", this.circuitBreaker.isClosed());
// }
//
// @Test
...
// this.markFailure();
// Assertions.assertTrue("Status should be CLOSED after 1 failure",
/// this.circuitBreaker.isClosed());
// }
//
// @Test
...
// this.markTwoFailures();
//
// Assertions.assertFalse("Status should be OPEN after 2 failures",
/// this.circuitBreaker.isClosed());
// }
//
// @Test
// public void testClosedAfter2FailuresAndWait() {
// LOGGER.info("Test: expect status is CLOSED after two failures and waiting
/// longer than the initial duration");
// // Trigger the circuit breaker to open
// this.markTwoFailures();
// // Wait until the circuit breaker is closed
// this.wait(35);
//
// Assertions.assertTrue("Status should be CLOSED after waiting for 35 ms",
/// this.circuitBreaker.isClosed());
// }
//
// @Test
// public void testDurationIncrease() {
// LOGGER.info("Test: expect status is OPEN after waiting shorter than the
/// current duration of 600 ms");
// this.circuitBreaker = new
/// CircuitBreaker.Builder().withThreshold(2).withInitialDuration(30)
...
// this.wait(100);
//
// Assertions.assertFalse("Status should be OPEN after waiting for 100 ms",
/// this.circuitBreaker.isClosed());
// }
//
// @Test
...
// this.wait(125);
//
// Assertions.assertTrue("Status should be CLOSED after waiting for 125 ms",
/// this.circuitBreaker.isClosed());
// }
//
// @Test
...
// this.markFailure();
//
// Assertions.assertTrue("Status should be CLOSED, when there's one failure
/// after a success",
// this.circuitBreaker.isClosed());
// }
//
