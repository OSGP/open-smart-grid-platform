...
// import
// org.opensmartgridplatform.shared.exceptionhandling.FunctionalException;
//
// public class EncryptionServiceTest {
//
// private static final String SRC_TEST_RESOURCES_SECRET =
...
// */
// @Test
// public void testKeyDecryption() throws NoSuchAlgorithmException, IOException,
// NoSuchProviderException,
// DecoderException, FunctionalException {
// // Load the secret key.
// final SecretKeySpec secretKey =
// this.createSecretKeySpec(SRC_TEST_RESOURCES_KEYS_SECRET_AES);
//
// // Test the authentication key.
// this.decryptKeyTest(secretKey, AUTH_KEY_ENCRYPTED_STRING,
// SRC_TEST_RESOURCES_KEYS_AUTH_KEY_DECRYPTED,
// "Authentication Key decryption failed");
//
// // Test the encryption key.
// this.decryptKeyTest(secretKey, ENC_KEY_ENCRYPTED_STRING,
// SRC_TEST_RESOURCES_KEYS_ENC_KEY_DECRYPTED,
// "Encryption Key decryption failed");
//
// // Test the master key.
// this.decryptKeyTest(secretKey, MASTER_KEY_ENCRYPTED_STRING,
// SRC_TEST_RESOURCES_KEYS_MASTER_KEY_DECRYPTED,
// "Master Key decryption failed");
// }
//
// private void decryptKeyTest(final SecretKeySpec secretKey, final String
// encryptedKey,
...
// final SecretKeySpec originalKey =
// this.createSecretKeySpec(originalKeyFilePath);
// final byte[] originalKeyBytes = originalKey.getEncoded();
//
// // Check if the decrypted key matches the original key.
// Assertions.assertTrue(assertMsg, Arrays.equals(originalKeyBytes,
// decryptedKeyBytes));
// }
//
// @Test
...
// final EncryptionService encryptionService = new
// TestableEncService(secretKey);
//
...
// Assertions.assertEquals(TEST_CONTENT, new String(decrypted));
// }
//
// @Test
...
// final SecretKeySpec secretKey = this.createSecretKeySpec(keyBytes);
// final byte[] enc = new
// TestableEncService(secretKey).encrypt(TEST_CONTENT.getBytes());
//
// Assertions.assertEquals(TEST_CONTENT, new String(new
// TestableEncService(secretKey).decrypt(enc)));
// }
//
// @Test
...
// throws NoSuchAlgorithmException, IOException, NoSuchProviderException,
// FunctionalException {
// final SecretKeySpec secretKey = this.createSecretKeySpec(new
// File(SRC_TEST_RESOURCES_SECRET));
// final byte[] enc = new
// TestableEncService(secretKey).encrypt(TEST_CONTENT.getBytes());
//
// Assertions.assertEquals(TEST_CONTENT, new String(new
...
// throws NoSuchAlgorithmException, IOException, NoSuchProviderException,
// FunctionalException {
// final byte[] encrypted = Files.readAllBytes(new
// File("src/test/resources/plain.enc").toPath());
// final SecretKeySpec secretKey = this.createSecretKeySpec(new
// File(SRC_TEST_RESOURCES_SECRET).getPath());
// final byte[] decrypted = new
// TestableEncService(secretKey).decrypt(encrypted);
//
// Assertions.assertEquals("hallo", new String(decrypted));
// }
//
// @Test
...
// throws NoSuchAlgorithmException, IOException, NoSuchProviderException,
// FunctionalException {
// final byte[] encrypted_prepended = Files.readAllBytes(new
// File("src/test/resources/prepended").toPath());
//
// final SecretKeySpec secretKey = this.createSecretKeySpec(new
// File(SRC_TEST_RESOURCES_SECRET).getPath());
// final byte[] decrypted_prepended = new
// TestableEncService(secretKey).decrypt(encrypted_prepended);
//
// // in this specific case the length of the decrypted bytes should become
// // 16, after 0 bytes are stripped of
// Assertions.assertEquals(16, decrypted_prepended.length);
//
// }
//
// private SecretKeySpec createSecretKeySpec(final byte[] bytes) throws
// IOException {
// return new SecretKeySpec(bytes, EncryptionService.SECRET_KEY_SPEC);
// }
//
// private SecretKeySpec createSecretKeySpec(final String filePath) throws
// IOException {
// return new SecretKeySpec(Files.readAllBytes(new File(filePath).toPath()),
// EncryptionService.SECRET_KEY_SPEC);
// }
//
// private SecretKeySpec createSecretKeySpec(final File file) throws IOException
// {
// return new SecretKeySpec(Files.readAllBytes(file.toPath()),
// EncryptionService.SECRET_KEY_SPEC);
// }
// }
