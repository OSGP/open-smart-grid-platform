...
/// "src/test/resources/keys/dlms_device_keys_private";
// private static final String PUBLIC_KEY_PATH =
/// "src/test/resources/keys/dlms_device_keys_public";
//
// /*
...
// private static final String AUTHENTICATION_KEY_PATH =
...
// private static final String ENCRYPTION_KEY_PATH =
...
// private static final String MASTER_KEY_PATH =
...
/// this.createRsaEncryptionServiceFromStoredKeys();
//
// this.assertDecryptionOfKey(rsaEncryptionService,
/// AUTHENTICATION_KEY_ENCRYPTED_HEX_STRING,
// AUTHENTICATION_KEY_PATH, "authentication key");
//
// this.assertDecryptionOfKey(rsaEncryptionService,
/// ENCRYPTION_KEY_ENCRYPTED_HEX_STRING,
// ENCRYPTION_KEY_PATH, "encryption key");
//
// this.assertDecryptionOfKey(rsaEncryptionService,
/// MASTER_KEY_ENCRYPTED_HEX_STRING, MASTER_KEY_PATH,
// "master key");
// }
//
// private void assertDecryptionOfKey(final RsaEncryptionService
/// rsaEncryptionService,
// final String encryptedHexString, final String keyPath, final String keyType)
/// throws Exception {
//
// final byte[] expected = Files.readAllBytes(Paths.get(keyPath));
// final byte[] actual =
/// rsaEncryptionService.decrypt(Hex.decodeHex(encryptedHexString.toCharArray()));
//
// assertEquals("decrypted " + keyType, Hex.encodeHexString(expected),
...
// final RsaEncryptionService rsaEncryptionService = new
/// RsaEncryptionService(freshKeyPair);
...
// final KeyPair keyPair = new
/// KeyPair(RsaEncryptionService.readPublicKeyFromFile(PUBLIC_KEY_PATH),
