...
// import
/// org.opensmartgridplatform.shared.mappers.XMLGregorianCalendarToDateTimeConverter;
//
...
// */
// private class DateTimeToStringConverter extends
/// BidirectionalConverter<DateTime, String> {
//
// @Override
// public String convertTo(final DateTime source, final Type<String>
/// destinationType,
...
//
// @Override
// public DateTime convertFrom(final String source, final Type<DateTime>
/// destinationType,
// final MappingContext mappingContext) {
// if (source == null) {
// return null;
...
// }
//
// private final MapperFactory mapperFactory = new
...
// @BeforeEach
// public void before() {
// this.mapperFactory.getConverterFactory().registerConverter(new
/// XMLGregorianCalendarToDateTimeConverter());
// this.mapperFactory.getConverterFactory().registerConverter(new
...
//
// @Test
// public void mapXMLGregorianCalenderWithTimeZoneToDateTime() throws
...
// final DateTime mappedJodaDateTime = this.mapper.map(xmlGregorianCalendar,
/// DateTime.class);
// Assertions.assertEquals(dateTime, mappedJodaDateTime);
// }
//
// @Test
// public void mapXMLGregorianWithoutTimeZoneCalenderToDateTime() throws
/// DatatypeConfigurationException {
...
/// this.mapper.map(dateTime,
// XMLGregorianCalendar.class);
// Assertions.assertEquals(xmlGregorianCalendar, mappedXMLGregorianCalendar);
...
// Assertions.assertNotNull("Not expecting NULL but a DateTime instance.",
/// mappedJodaTime);
// }
//
// @Test
...
// Assertions.assertNotNull("Not expecting NULL but a date time as string.",
/// mappedStringTime);
// }
// }
