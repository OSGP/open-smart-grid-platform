...
public class SetRandomisationSettingsRequestDataDto implements ActionRequestDto {
    ...
    public String toString() {
        ...
        return String.format("directAttach = %s, randomisationStartWindow = %s, multiplicationFactor = %s, "
                        + "numberOfRetries = %s ", this.directAttach, this.randomisationStartWindow,
