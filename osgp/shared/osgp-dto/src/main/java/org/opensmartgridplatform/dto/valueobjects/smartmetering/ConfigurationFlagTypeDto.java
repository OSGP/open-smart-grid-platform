...
public enum ConfigurationFlagTypeDto {
  ...
  PO_ENABLE(3, 3, false),
  HLS_3_ON_P3_ENABLE(4, null, false),
  HLS_4_ON_P3_ENABLE(5, null, false),
  HLS_5_ON_P3_ENABLE(6, 6, false),
  HLS_3_ON_P0_ENABLE(7, null, false),
  HLS_4_ON_P0_ENABLE(8, null, false),
  HLS_5_ON_P0_ENABLE(9, 9, false),
