...
public class ModemInfoDto implements Serializable {
    ...
    public ModemInfoDto(final String operator,
            final ModemRegistrationStatusDto modemRegistrationStatusDto,
            final CircuitSwitchedStatusDto circuitSwitchedStatusDto,
            final PacketSwitchedStatusDto packetSwitchedStatusDto, final byte[] cellId, final byte[] locationId,
            final SignalQualityDto signalQuality, final BitErrorRateDto bitErrorRate, final int mobileCountryCode,
            final int mobileNetworkCode, final Long channelNumber, final int numberOfAdjacentCells,
            final byte[] adjacentCellId, final SignalQualityDto adjacentCellSignalQuality, final DateTime captureTime) {
    ...
    public String toString() {
        return String
                .format("ModemInfoDto[operator=%s, modemRegistrationStatus=%s', circuitSwitchedStatus=%s, packetSwitchedStatus=%s, cellId=%s]",
                        this.operator,
