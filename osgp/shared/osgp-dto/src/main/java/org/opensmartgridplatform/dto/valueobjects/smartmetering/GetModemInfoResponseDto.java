...
public class GetModemInfoResponseDto extends ActionResponseDto {
    ...
    private SignalQualityDto adjacantCellSignalQuality;
    ...
    public GetModemInfoResponseDto(final String operator,
            ...
            final SignalQualityDto adjacantCellSignalQuality, final Date captureTime) {
        super();
    ...
    public SignalQualityDto getAdjacantCellSignalQuality() {
