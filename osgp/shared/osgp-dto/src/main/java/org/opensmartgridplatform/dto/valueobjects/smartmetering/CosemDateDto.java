...
public class CosemDateDto implements Serializable, Comparable<CosemDateDto> {
  ...
  /**
   * @return the day of the week for this {@link CosemDateDto} (Monday=1 .. Sunday=7).
  ...
  /**
   * Returns this {@link CosemDateDto} as {@link LocalDate} if {@code year}, {@code month} and
   * {@code dayOfMonth} do not contain wildcard values.
   *
   * @return this {@link CosemDateDto} as {@link LocalDate}, or {@code null} if not {@link
