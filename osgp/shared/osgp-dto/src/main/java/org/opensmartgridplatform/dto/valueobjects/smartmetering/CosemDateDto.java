...
public class CosemDateDto implements Serializable, Comparable<CosemDateDto> {
    ...
    public CosemDateDto(final int year, final int month, final int dayOfMonth, final int dayOfWeek) {
    ...
    public CosemDateDto(final int year, final int month, final int dayOfMonth) {
    ...
    private void checkInputs(final int year, final int month, final int dayOfMonth, final int dayOfWeek) {
        this.checkYear(year);
    ...
    private boolean isSpecialMonth(final int month) {
        return MONTH_DAYLIGHT_SAVINGS_END == month || MONTH_DAYLIGHT_SAVINGS_BEGIN == month
    ...
    private boolean isSpecialDayOfMonth(final int dayOfMonth) {
        return DAY_OF_MONTH_2ND_LAST_DAY == dayOfMonth || DAY_OF_MONTH_LAST_DAY == dayOfMonth
                || DAY_OF_MONTH_NOT_SPECIFIED == dayOfMonth || this.isReservedDayOfMonth(dayOfMonth);
    }
    ...
    /**
     * @return the year for this {@link CosemDateDto}.
     *
    ...
    /**
     * @return the month for this {@link CosemDateDto} (January=1 .. December=12).
     *
    ...
    /**
     * @return the day of month for this {@link CosemDateDto} (1..31).
     *
    ...
    /**
     * @return the day of the week for this {@link CosemDateDto} (Monday=1 ..
     *         Sunday=7).
     *
    ...
    /**
     * @return {@code true} if the values for {@code year}, {@code month} and
     *         {@code dayOfMonth} contain values for regular dates;
     *         {@code false} if wildcards are used in the fields mentioned.
     */
    public boolean isLocalDateSpecified() {
        return YEAR_NOT_SPECIFIED != this.year && this.isSpecificMonth(this.month)
                && this.isSpecificDayOfMonth(this.dayOfMonth);
    }

    /**
     * Returns this {@link CosemDateDto} as {@link LocalDate} if {@code year},
     * {@code month} and {@code dayOfMonth} do not contain wildcard values.
     *
     * @return this {@link CosemDateDto} as {@link LocalDate}, or {@code null} if
    ...
    public boolean equals(final Object obj) {
        ...
        final CosemDateDto other = (CosemDateDto) obj;
    ...
    @Override
    public int compareTo(final CosemDateDto o) {
