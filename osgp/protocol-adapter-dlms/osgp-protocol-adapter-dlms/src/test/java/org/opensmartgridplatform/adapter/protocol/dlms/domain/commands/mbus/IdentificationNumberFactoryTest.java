...
public class IdentificationNumberFactoryTest {
    ...
    public void testFromIdentificationDsmr4() {
        ...
        final IdentificationNumber identificationNumber = IdentificationNumberFactory.create(Protocol.DSMR_4_2_2)
    ...
    public void testFromNullIdentificationSmr51() {
        ...
        final IdentificationNumber identificationNumber = IdentificationNumberFactory.create(Protocol.SMR_5_1)
                .fromIdentification(null);
