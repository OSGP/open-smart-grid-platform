...
public class DlmsHelperTest {
    ...
    public void testDateTimeSummerTime() {
        ...
        final DataObject dateInSummerTimeDataObject = DlmsHelper.asDataObject(this.dateTimeSummerTime());
    ...
    public void testDateTimeSummerTimeWithDeviationAndDst() {
        ...
        final DataObject dateInSummerTimeDataObject = DlmsHelper.asDataObject(this.dateTimeSummerTime(), -120, true);
    ...
    public void testDateTimeSummerTimeWithDeviationAndDstFromOtherTimeZone() {
         ...
         */
        final DataObject dateInSummerTimeDataObject = DlmsHelper.asDataObject(this.dateTimeSummerTimeUtc(), -120, true);
    ...
    public void testDateTimeWinterTime() {
        ...
        final DataObject dateInWinterTimeDataObject = DlmsHelper.asDataObject(this.dateTimeWinterTime());
    ...
    public void testDateTimeWinterTimeWithDeviationAndDst() {
        ...
        final DataObject dateInWinterTimeDataObject = DlmsHelper.asDataObject(this.dateTimeWinterTime(), -60, false);
    ...
    public void testDateTimeWinterTimeWithDeviationAndDstFromOtherTimeZone() {
         ...
         */
        final DataObject dateInWinterTimeDataObject = DlmsHelper
    ...
    public void testFromByteArraySummerTime() throws Exception {
        ...
        final CosemDateTimeDto cosemDateTime = DlmsHelper.fromDateTimeValue(this.byteArraySummerTime());
    ...
    public void testFromByteArrayWinterTime() throws Exception {
        ...
        final CosemDateTimeDto cosemDateTime = DlmsHelper.fromDateTimeValue(this.byteArrayWinterTime());
    ...
    public void testFromByteArrayUnspecifiedTime() throws Exception {
        ...
        final CosemDateTimeDto cosemDateTime = DlmsHelper.fromDateTimeValue(this.byteArrayUnspecifiedTime());
    ...
    public void testCorrectLogMessageForBitStringObject() {
        ...
        final String logMessage = DlmsHelper.getDebugInfoBitStringBytes(new byte[] { -110, 64 });
