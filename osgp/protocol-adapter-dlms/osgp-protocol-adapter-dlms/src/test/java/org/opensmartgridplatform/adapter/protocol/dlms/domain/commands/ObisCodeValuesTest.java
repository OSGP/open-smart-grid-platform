...
public class ObisCodeValuesTest {
    ...
    public void testObisCodeValues() {
        ...
        final ObisCode obisCode = new ObisCode(this.toInt(obisCodeValues.getA()), this.toInt(obisCodeValues.getB()),
                this.toInt(obisCodeValues.getC()), this.toInt(obisCodeValues.getD()), this.toInt(obisCodeValues.getE()),
