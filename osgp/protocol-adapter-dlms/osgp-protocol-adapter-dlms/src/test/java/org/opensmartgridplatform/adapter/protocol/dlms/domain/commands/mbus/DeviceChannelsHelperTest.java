...
public class DeviceChannelsHelperTest {
    ...
    void testDeinstallSlave() throws ProtocolAdapterException {
        ...
        final MethodResultCode methodResultCode = this.deviceChannelsHelper.deinstallSlave(this.conn, this.device,
                (short) 1, this.mBusSetup);
