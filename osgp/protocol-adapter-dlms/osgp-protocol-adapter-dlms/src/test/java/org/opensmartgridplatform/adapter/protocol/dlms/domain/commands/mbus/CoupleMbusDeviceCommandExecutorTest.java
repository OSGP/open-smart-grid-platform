...
public class CoupleMbusDeviceCommandExecutorTest {
    ...
    public void testExactMatch() throws ProtocolAdapterException {
        ...
        final MbusChannelElementsDto mbusChannelElementsDto = new MbusChannelElementsDto(this.primaryAddress,
                this.mbusDeviceIdentification, this.identificationNumber, this.manufacturerIdentification, this.version,
                this.deviceTypeIdentification);

        when(this.deviceChannelsHelper.findCandidateChannelsForDevice(eq(this.conn), eq(this.device),
                any(MbusChannelElementsDto.class))).thenReturn(this.candidateChannelElementValues);

        final MbusChannelElementsResponseDto responseDto = this.commandExecutor.execute(this.conn, this.device,
        ...
        verify(this.deviceChannelsHelper, times(1)).findCandidateChannelsForDevice(eq(this.conn), eq(this.device),
                any(MbusChannelElementsDto.class));
    ...
    public void testBestMatch() throws ProtocolAdapterException {
        ...
        final MbusChannelElementsDto mbusChannelElementsDto = new MbusChannelElementsDto((short) 8,
                this.mbusDeviceIdentification, this.identificationNumber, this.manufacturerIdentification, this.version,
                this.deviceTypeIdentification);
    ...
    public void testNoMatchAndNoEmptyChannel() throws ProtocolAdapterException {
        ...
        final MbusChannelElementsDto mbusChannelElementsDto = new MbusChannelElementsDto((short) -1, "noMatch",
                "noMatch", "noMatch", (short) -1, (short) -1);
    ...
    public void testNoMatchButEmptyChannel() throws ProtocolAdapterException {
        ...
        final ChannelElementValuesDto emptyChannel = new ChannelElementValuesDto((short) 2, (short) 0, "00000000", null,
                (short) 0, (short) 0);
        final List<ChannelElementValuesDto> candidateChannelElementValuesWithEmptyChannel = Arrays
                .asList(this.candidateChannelElementValues.get(0), emptyChannel);

        final MbusChannelElementsDto mbusChannelElementsDto = new MbusChannelElementsDto((short) -1, "noMatch",
                "noMatch", "noMatch", (short) -1, (short) -1);

        when(this.deviceChannelsHelper.findCandidateChannelsForDevice(eq(this.conn), eq(this.device),
                any(MbusChannelElementsDto.class))).thenReturn(candidateChannelElementValuesWithEmptyChannel);
        when(this.deviceChannelsHelper.findEmptyChannel(candidateChannelElementValuesWithEmptyChannel))
                .thenReturn(emptyChannel);
        when(this.deviceChannelsHelper.writeUpdatedMbus(eq(this.conn), eq(mbusChannelElementsDto),
                eq(emptyChannel.getChannel()), any(Protocol.class), any(String.class)))
                        .thenReturn(new ChannelElementValuesDto(emptyChannel.getChannel(),
