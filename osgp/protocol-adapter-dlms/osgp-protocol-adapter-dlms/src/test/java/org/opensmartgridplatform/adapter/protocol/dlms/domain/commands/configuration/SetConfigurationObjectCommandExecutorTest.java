...
public class SetConfigurationObjectCommandExecutorTest {
    ...
    public void execute() throws IOException, ProtocolAdapterException {
        ...
        final ConfigurationObjectDto configurationToSet = this.createConfigurationObjectDto(
                GprsOperationModeTypeDto.ALWAYS_ON, ConfigurationFlagTypeDto.DISCOVER_ON_OPEN_COVER,
        ...
        final DataObject resultData = this.createResultData(flagsOnDevice, GprsOperationModeTypeDto.ALWAYS_ON);
        ...
        System.out.println(setParameterData);
    }
