...
public class GetFirmwareFileResponseMessageProcessorTest {
  ...
  //
  //    // assert
  //    //    verify(this.responseMessageSender,
  //    // times(1)).send(responseMessageArgumentCaptor.capture());
  //
  ...
  @Test
  //  public void
  // processMessageShouldSendNotOkResponseMessageContainingOriginalFirmwareUpdateRequest()
  //      throws OsgpException, JMSException {
  //    // arrange
  //    final FirmwareFileDto firmwareFileDto = this.setupFirmwareFileDto();
  //    final ResponseMessage responseMessage = this.setupResponseMessage(firmwareFileDto);
  ...
  // capturedValue.getDataObject()).getFirmwareIdentification())
