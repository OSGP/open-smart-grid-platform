...
public class DataObjectAttrExecutor {
    ...
    public DataObjectAttrExecutor(final String name, final AttributeAddress attrAddress, final DataObject value,
     ...
     *
     * @return a {@link String} that contains all member information from the
     *         object. This can be used to send error notifications back to the
     *         caller
     */
