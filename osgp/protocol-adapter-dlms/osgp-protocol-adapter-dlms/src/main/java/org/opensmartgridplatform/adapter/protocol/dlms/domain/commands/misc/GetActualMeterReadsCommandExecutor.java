...
public class GetActualMeterReadsCommandExecutor
    ...
    public MeterReadsResponseDto execute(final DlmsConnectionManager conn, final DlmsDevice device,
        ...
        final DlmsMeterValueDto activeEnergyImport = DlmsHelper
        ...
        final DlmsMeterValueDto activeEnergyExport = DlmsHelper
        ...
        final DlmsMeterValueDto activeEnergyImportRate1 = DlmsHelper
        ...
        final DlmsMeterValueDto activeEnergyImportRate2 = DlmsHelper
        ...
        final DlmsMeterValueDto activeEnergyExportRate1 = DlmsHelper
                .getScaledMeterValue(getResultList.get(INDEX_ACTIVE_ENERGY_EXPORT_RATE_1),
                        ...
                        "Actual Energy Reads -A rate 1");
        final DlmsMeterValueDto activeEnergyExportRate2 = DlmsHelper
