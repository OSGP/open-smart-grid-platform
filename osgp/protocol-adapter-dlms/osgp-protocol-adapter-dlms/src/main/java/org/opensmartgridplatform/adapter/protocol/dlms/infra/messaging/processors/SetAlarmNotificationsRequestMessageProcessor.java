...
@Component
public class SetAlarmNotificationsRequestMessageProcessor
    extends DeviceRequestMessageProcessor<AlarmNotificationsDto> {
  ...
  protected Serializable handleMessage(
      ...
      final RequestWithMetadata<AlarmNotificationsDto> request)
