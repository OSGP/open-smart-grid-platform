...
public class UpdateFirmwareCommandExecutor extends AbstractCommandExecutor<String, UpdateFirmwareResponseDto> {
    ...
    @Value("${command.firmware.activationstatuscheck.interval}")
    private int activationStatusCheckInterval;

    @Value("${command.firmware.activationstatuscheck.timeout}")
    private int activationStatusCheckTimeout;

    @Value("${command.firmware.verificationstatuscheck.interval}")
    private int verificationStatusCheckInterval;

    @Value("${command.firmware.verificationstatuscheck.timeout}")
    private int verificationStatusCheckTimeout;

    @Value("${command.firmware.initiationstatuscheck.interval}")
    private int initiationStatusCheckInterval;

    @Value("${command.firmware.initiationstatuscheck.timeout}")
