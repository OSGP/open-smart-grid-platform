...
@Component
public class GetPowerQualityProfileCommandExecutorNoSelectiveAccess
        extends AbstractGetPowerQualityProfileCommandExecutor {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(GetPowerQualityProfileCommandExecutorNoSelectiveAccess.class);

    public GetPowerQualityProfileCommandExecutorNoSelectiveAccess(final DlmsHelper dlmsHelper) {
        super(dlmsHelper);
    }
    ...
    public GetPowerQualityProfileResponseDto execute(final DlmsConnectionManager conn, final DlmsDevice device,
        ...
        LOGGER.info("----- EXECUTE GetPowerQualityProfileCommandExecutor "
                + "GetPowerQualityProfileCommandExecutorNoSelectiveAccess ----");
