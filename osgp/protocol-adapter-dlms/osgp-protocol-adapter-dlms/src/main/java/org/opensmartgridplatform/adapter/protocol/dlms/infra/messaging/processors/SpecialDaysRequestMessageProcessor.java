...
@Component
public class SpecialDaysRequestMessageProcessor
    extends DeviceRequestMessageProcessor<SpecialDaysRequestDto> {
  ...
  protected Serializable handleMessage(
      ...
      final RequestWithMetadata<SpecialDaysRequestDto> request)
