...
public class InvocationCounterManager {
   ...
   */
  public void initializeInvocationCounter(final String correlationUid, final DlmsDevice device)
  ...
  private void initializeWithInvocationCounterStoredOnDevice(
      final String correlationUid, final DlmsDevice device) throws OsgpException {
    try (final DlmsConnectionManager connectionManager =
        this.connectionFactory.getPublicClientConnection(correlationUid, device, null)) {
