...
public class DataObjectDefinitions {
    ...
    public static DataObject getClockDefinition() {
        ...
        return DataObject.newStructureData(Arrays.asList(DataObject.newUInteger16Data(CLASS_ID_CLOCK),
    ...
    public static DataObject getAMRProfileDefinition() {
        ...
        return DataObject.newStructureData(Arrays.asList(DataObject.newUInteger16Data(CLASS_ID_DATA),
