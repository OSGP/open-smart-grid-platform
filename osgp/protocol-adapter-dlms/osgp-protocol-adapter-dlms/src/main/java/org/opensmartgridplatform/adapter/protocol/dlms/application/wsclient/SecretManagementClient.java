...
public class SecretManagementClient {
    ...
    return message -> {
      try {
        ...
        final String headerXml =
            String.format(
                "<%1$s xmlns=\"%2$s\">%3$s</%1$s>", CORRELATION_UID, NAMESPACE_URI, correlationUid);
  ...
  public GetSecretsResponse getSecretsRequest(
      final String correlationUid, final GetSecretsRequest request) {
    ...
    return (GetSecretsResponse)
        this.webServiceTemplate.marshalSendAndReceive(
            request, this.createCorrelationHeaderCallback(correlationUid));
  }

  public GetNewSecretsResponse getNewSecretsRequest(
      final String correlationUid, final GetNewSecretsRequest request) {
  ...
  public StoreSecretsResponse storeSecretsRequest(
      final String correlationUid, final StoreSecretsRequest request) {
    LOGGER.info(
  ...
  public ActivateSecretsResponse activateSecretsRequest(
      final String correlationUid, final ActivateSecretsRequest request) {
    LOGGER.info(
  ...
  public HasNewSecretResponse hasNewSecretRequest(
      final String correlationUid, final HasNewSecretRequest request) {
    LOGGER.info(
  ...
  public GenerateAndStoreSecretsResponse generateAndStoreSecrets(
      final String correlationUid, final GenerateAndStoreSecretsRequest request) {
    LOGGER.info(
