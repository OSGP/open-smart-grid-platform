...
public class DlmsSecurityKeyService implements SecurityKeyService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DlmsSecurityKeyService.class);
    ...
    public DlmsSecurityKeyService(DlmsDeviceRepository dlmsDeviceRepository, EncryptionService encryptionService,
