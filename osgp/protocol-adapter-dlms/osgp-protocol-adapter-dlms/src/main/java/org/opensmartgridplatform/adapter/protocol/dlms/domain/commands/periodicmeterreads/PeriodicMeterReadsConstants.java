...
public class PeriodicMeterReadsConstants {
    ...
    static final byte[] OBIS_BYTES_ACTIVE_ENERGY_IMPORT_RATE_1 = OBIS_CODE_MONTHLY_DAILY_IMPORT_RATE_1.bytes();
    static final byte[] OBIS_BYTES_ACTIVE_ENERGY_IMPORT_RATE_2 = OBIS_CODE_MONTHLY_DAILY_IMPORT_RATE_2.bytes();
    static final byte[] OBIS_BYTES_ACTIVE_ENERGY_EXPORT_RATE_1 = OBIS_CODE_MONTHLY_DAILY_EXPORT_RATE_1.bytes();
    static final byte[] OBIS_BYTES_ACTIVE_ENERGY_EXPORT_RATE_2 = OBIS_CODE_MONTHLY_DAILY_EXPORT_RATE_2.bytes();
    static final byte ATTRIBUTE_ID_VALUE = 2;

    static final int ACCESS_SELECTOR_RANGE_DESCRIPTOR = 1;

    static final AttributeAddress ATTRIBUTE_INTERVAL_IMPORT_SCALER_UNIT = new AttributeAddress(CLASS_ID_REGISTER,
            OBIS_CODE_INTERVAL_IMPORT_SCALER_UNIT,
            ATTRIBUTE_ID_SCALER_UNIT);
    static final AttributeAddress ATTRIBUTE_INTERVAL_EXPORT_SCALER_UNIT = new AttributeAddress(CLASS_ID_REGISTER,
            OBIS_CODE_INTERVAL_EXPORT_SCALER_UNIT,
            ATTRIBUTE_ID_SCALER_UNIT);

    static final AttributeAddress ATTRIBUTE_DAILY_OR_MONTHLY_IMPORT_RATE_1_SCALER_UNIT =
            new AttributeAddress(CLASS_ID_REGISTER, OBIS_CODE_MONTHLY_DAILY_IMPORT_RATE_1,
            ATTRIBUTE_ID_SCALER_UNIT);
    static final AttributeAddress ATTRIBUTE_DAILY_OR_MONTHLY_IMPORT_RATE_2_SCALER_UNIT =
            new AttributeAddress(CLASS_ID_REGISTER, OBIS_CODE_MONTHLY_DAILY_IMPORT_RATE_2,
            ATTRIBUTE_ID_SCALER_UNIT);
    static final AttributeAddress ATTRIBUTE_DAILY_OR_MONTHLY_EXPORT_RATE_1_SCALER_UNIT =
            new AttributeAddress(CLASS_ID_REGISTER, OBIS_CODE_MONTHLY_DAILY_EXPORT_RATE_1,
            ATTRIBUTE_ID_SCALER_UNIT);
