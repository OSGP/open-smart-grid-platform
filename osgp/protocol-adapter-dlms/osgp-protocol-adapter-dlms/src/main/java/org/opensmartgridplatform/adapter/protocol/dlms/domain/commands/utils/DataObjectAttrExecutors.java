    ...
    private void handleNoSuccess(final DataObjectAttrExecutor dataObjectAttrExecutor) throws ProtocolAdapterException {
        ...
        if (this.stopOnNoSuccess) {
            ...
            throw new ProtocolAdapterException(
                    this.errString + ". Stopping execution after element: " + this.dataObjectAttrExecutorList
                            .indexOf(dataObjectAttrExecutor) + " (total elements: " + this.dataObjectAttrExecutorList
                            .size() + ")");
        }
    }
