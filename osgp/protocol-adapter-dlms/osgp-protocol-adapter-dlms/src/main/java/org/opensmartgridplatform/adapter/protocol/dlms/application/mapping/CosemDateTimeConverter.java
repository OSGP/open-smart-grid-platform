...
public class CosemDateTimeConverter
    ...
    public CosemDateTimeDto convertFrom(final org.openmuc.jdlms.datatypes.CosemDateTime source,
        ...
        final org.opensmartgridplatform.dto.valueobjects.smartmetering.CosemDateDto date = new org.opensmartgridplatform.dto.valueobjects.smartmetering.CosemDateDto(
        ...
        final org.opensmartgridplatform.dto.valueobjects.smartmetering.CosemTimeDto time = new org.opensmartgridplatform.dto.valueobjects.smartmetering.CosemTimeDto(
        ...
        final org.opensmartgridplatform.dto.valueobjects.smartmetering.ClockStatusDto clockStatus = new org.opensmartgridplatform.dto.valueobjects.smartmetering.ClockStatusDto(
                clockStatusValue);

        return new org.opensmartgridplatform.dto.valueobjects.smartmetering.CosemDateTimeDto(date, time, deviation,
                clockStatus);
    }
