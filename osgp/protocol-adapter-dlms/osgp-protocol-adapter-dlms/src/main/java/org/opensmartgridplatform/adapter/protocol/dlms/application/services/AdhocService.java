...
import org.opensmartgridplatform.adapter.protocol.dlms.domain.commands.GetAllAttributeValuesCommandExecutor;
import org.opensmartgridplatform.adapter.protocol.dlms.domain.commands.GetAssociationLnObjectsCommandExecutor;
import org.opensmartgridplatform.adapter.protocol.dlms.domain.commands.GetSpecificAttributeValueCommandExecutor;
import org.opensmartgridplatform.adapter.protocol.dlms.domain.commands.ScanMbusChannelsCommandExecutor;
import org.opensmartgridplatform.adapter.protocol.dlms.domain.commands.SynchronizeTimeCommandExecutor;
...
public class AdhocService {
    ...
    public String getAllAttributeValues(final DlmsConnectionManager conn, final DlmsDevice device) throws OsgpException {
