...
public class SetConfigurationObjectServiceDsmr4 extends SetConfigurationObjectService {
    ...
    private void addGprsOperationMode(final ConfigurationObjectDto configurationToSet,
    ...
    private void addGprsOperationMode(final GprsOperationModeTypeDto type, final List<DataObject> dataObjects) {
