...
@Component
public class FindEventsRequestMessageProcessor
    extends DeviceRequestMessageProcessor<FindEventsRequestList> {
  ...
  protected Serializable handleMessage(
      ...
      final RequestWithMetadata<FindEventsRequestList> request)
