...
public class SetDeviceLifecycleStatusByChannelRequestMessageProcessor
    extends DeviceRequestMessageProcessor<SetDeviceLifecycleStatusByChannelRequestDataDto> {
  ...
  protected Serializable handleMessage(
      ...
      final RequestWithMetadata<SetDeviceLifecycleStatusByChannelRequestDataDto> request)
