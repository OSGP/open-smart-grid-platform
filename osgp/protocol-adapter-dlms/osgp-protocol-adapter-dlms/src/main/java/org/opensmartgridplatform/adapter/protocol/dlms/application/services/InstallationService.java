...
public class InstallationService {
  ...
  public void addMeter(
      final String correlationUid, final SmartMeteringDeviceDto smartMeteringDevice)
  ...
  private void storeAndActivateKeys(
      final String correlationUid, final SmartMeteringDeviceDto deviceDto)
      throws FunctionalException {
    ...
    this.secretManagementService.storeNewKeys(
        correlationUid, deviceDto.getDeviceIdentification(), keysByType);
    this.secretManagementService.activateNewKeys(
        correlationUid, deviceDto.getDeviceIdentification(), keyTypesToStore);
  }
