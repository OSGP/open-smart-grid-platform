...
public class InstallationService {
  ...
  private void storeAndActivateKeys(
    ...
    if ((deviceDto.getDeviceIdentification() != null
        && deviceDto.getDeviceIdentification().startsWith("GLLS"))) {
      keysByType.put(G_METER_ENCRYPTION, new byte[] {49, 50, 51, 52, 53, 54, 55, 56});
    }
