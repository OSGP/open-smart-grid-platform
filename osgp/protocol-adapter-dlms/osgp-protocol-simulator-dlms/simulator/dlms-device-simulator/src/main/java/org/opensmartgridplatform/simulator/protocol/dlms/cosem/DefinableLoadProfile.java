...
public class DefinableLoadProfile extends DynamicProfile {
  ...
  static {
    ...
    PROCESSORS_BY_CAPTURE_OBJECT.put(CDMA_DIAGNOSTIC_SIGNAL_QUALITY, UNSIGNED_PROCESSOR);
    PROCESSORS_BY_CAPTURE_OBJECT.put(GPRS_DIAGNOSTIC_SIGNAL_QUALITY, UNSIGNED_PROCESSOR);
    PROCESSORS_BY_CAPTURE_OBJECT.put(CDMA_DIAGNOSTIC_BER, UNSIGNED_PROCESSOR);
    PROCESSORS_BY_CAPTURE_OBJECT.put(GPRS_DIAGNOSTIC_BER, UNSIGNED_PROCESSOR);
