...
@CosemClass(id = 3)
public class MinDurationCurrentTHDOverlimitOverToNormal extends CosemInterfaceObject {
  ...
  public MinDurationCurrentTHDOverlimitOverToNormal(final long value) {
