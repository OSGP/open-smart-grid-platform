...
public enum Protocol {
  ...
  DSMR_4_2_2("DSMR", "4.2.2", 62, 11, 27, 6, 14, 6, 13, 5, 6, true, false),
  SMR_4_3("SMR", "4.3", 63, 11, 27, 6, 14, 6, 13, 6, 7, true, false),
  SMR_5_0_0("SMR", "5.0.0", 70, 11, 27, 6, 14, 6, 15, 9, 14, true, true),
  SMR_5_1("SMR", "5.1", 72, 11, 27, 6, 14, 6, 15, 9, 14, true, true),
  SMR_5_2("SMR", "5.2", 75, 11, 27, 6, 14, 6, 15, 10, 15, true, true),
  SMR_5_5("SMR", "5.5", 79, 11, 27, 6, 14, 6, 15, 10, 15, true, true);
