...
public class Iec61850ImpedanceCommand implements RtuReadCommand<MeasurementDto> {

  private final LogicalNode logicalNode;
  private final DataAttribute dataAttribute;
  private final int index;

  public Iec61850ImpedanceCommand(final int index, final DataAttribute dataAttribute) {
