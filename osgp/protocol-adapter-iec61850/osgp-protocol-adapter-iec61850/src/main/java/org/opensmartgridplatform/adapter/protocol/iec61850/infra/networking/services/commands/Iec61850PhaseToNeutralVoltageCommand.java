...
public class Iec61850PhaseToNeutralVoltageCommand implements RtuReadCommand<MeasurementDto> {

  private final LogicalNode logicalNode;
  private final DataAttribute dataAttribute;
  private final int index;

  public Iec61850PhaseToNeutralVoltageCommand(final int index, final DataAttribute dataAttribute) {
