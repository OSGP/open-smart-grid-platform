...
public class Iec61850GetConfigurationCommand {
    ...
    public ConfigurationDto getConfigurationFromDevice(final Iec61850Client iec61850Client,
        ...
        final Function<ConfigurationDto> function = deviceMessageLog -> makeMessageLogConfiguration(deviceMessageLog,
                ssld, iec61850Client, deviceConnection, mapper);

        return iec61850Client.sendCommandWithRetry(function, "GetConfiguration",
                deviceConnection.getDeviceIdentification());
    }

    private ConfigurationDto makeMessageLogConfiguration(DeviceMessageLog deviceMessageLog, Ssld ssld,
            Iec61850Client iec61850Client, DeviceConnection deviceConnection, Iec61850Mapper mapper)
            throws ProtocolAdapterException {
