...
public class DistributionAutomationGetHealthStatusRequestMessageProcessor extends DaRtuDeviceRequestMessageProcessor {
    ...
    @Override
    public Function<GetHealthStatusResponseDto> getDataFunction(final Iec61850Client client,
        ...
        return (final DeviceMessageLog deviceMessageLog) -> {
            ...
            final NodeContainer containingNode = connection.getFcModelNode(
                    org.opensmartgridplatform.adapter.protocol.iec61850.infra.networking.helper.LogicalDevice.RTU,
                    logicalDeviceIndex,
                    org.opensmartgridplatform.adapter.protocol.iec61850.infra.networking.helper.LogicalNode.PHYSICAL_DEVICE_ONE,
