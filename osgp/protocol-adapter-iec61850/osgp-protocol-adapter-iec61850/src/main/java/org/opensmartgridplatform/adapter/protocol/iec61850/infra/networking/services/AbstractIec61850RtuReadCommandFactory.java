...
public abstract class AbstractIec61850RtuReadCommandFactory
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractIec61850RtuReadCommandFactory.class);
    ...
    private final Set<DataAttribute> dataAttributesUsingFilterId = EnumSet.noneOf(DataAttribute.class);

    protected AbstractIec61850RtuReadCommandFactory(final Map<String, RtuReadCommand<MeasurementDto>> rtuCommandMap,
    ...
    protected static final class CommandsByAttributeBuilder {
        ...
        private static final Map<DataAttribute, RtuReadCommand<MeasurementDto>> READ_COMMANDS_BY_ATTRIBUTE = new EnumMap<>(
                DataAttribute.class);

        private static final Map<DataAttribute, IntFunction<RtuReadCommand<MeasurementDto>>> READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE = new EnumMap<>(
                DataAttribute.class);

        private static final Map<DataAttribute, Map<Integer, RtuReadCommand<MeasurementDto>>> readCommandsByAttributeByIndex = new EnumMap<>(
                DataAttribute.class);
        ...
        static {
            ...
            for (final DataAttribute dataAttribute : DataAttribute.values()) {
                ...
                case ACTUAL_POWER:
                    ...
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850LoadActualPowerCommand::new);
                    break;
                ...
                case FREQUENCY:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute,
                            i -> new Iec61850FrequencyCommand(i, DataAttribute.FREQUENCY));
                    break;
                ...
                case MASTER_CONTROL:
                    break;
                case MATERIAL_FLOW:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850MaterialFlowCommand::new);
                    break;
                case MATERIAL_STATUS:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850MaterialStatusCommand::new);
                    break;
                case MATERIAL_TYPE:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850MaterialTypeCommand::new);
                    break;
                ...
                case PHASE_TO_NEUTRAL_VOLTAGE_PHASE_A:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute,
                            i -> new Iec61850PhaseToNeutralVoltageCommand(i,
                ...
                case SCHEDULE_ABS_TIME:
                    ...
                    break;
                case SCHEDULE_CAT:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850ScheduleCatCommand::new);
                    break;
                case SCHEDULE_CAT_RTU:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850ScheduleCatCommand::new);
                    break;
                case SCHEDULE_ID:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850ScheduleIdCommand::new);
                    break;
                case SCHEDULE_TYPE:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850ScheduleTypeCommand::new);
                    break;
                ...
                case TOTAL_ENERGY:
                    ...
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute, Iec61850LoadTotalEnergyCommand::new);
                    break;
                case VLMCAP:
                ...
                case VOLTAGE_DIPS:
                    READ_COMMAND_FACTORY_INDEXED_BY_ATTRIBUTE.put(dataAttribute,
                            i -> new Iec61850VoltageDipsCommand(i, dataAttribute));
                    break;
                case WARNING_FOUR:
                ...
                case WARNING_TWO:
                    ...
                    break;
                default:
                    throw new AssertionError("No RtuReadCommand configured for DataAttribute " + dataAttribute);
                }
            }
        }
        ...
        public CommandsByAttributeBuilder withSimpleCommandsFor(final Set<DataAttribute> attributes) {
            final Map<String, RtuReadCommand<MeasurementDto>> commandsByAttributeName = attributes.stream()
        ...
        public CommandsByAttributeBuilder withIndexedCommandsFor(final Set<DataAttribute> indexedCommandAttributes,
                final int indexStart, final int indexEnd) {
