...
public class Iec61850FrequencyCommand implements RtuReadCommand<MeasurementDto> {

  private final LogicalNode logicalNode;
  private final DataAttribute dataAttribute;
  private final int index;

  public Iec61850FrequencyCommand(final int index, final DataAttribute dataAttribute) {
