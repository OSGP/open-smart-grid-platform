...
public class Iec61850PowerFactorCommand implements RtuReadCommand<MeasurementDto> {

  private final LogicalNode logicalNode;
  private final DataAttribute dataAttribute;
  private final int index;

  public Iec61850PowerFactorCommand(final int index, final DataAttribute dataAttribute) {
