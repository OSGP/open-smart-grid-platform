...
public final class Iec61850WindCommandFactory extends AbstractIec61850RtuReadCommandFactory {
    ...
    private static final Set<DataAttribute> dataAttributesUsingFilterId() {
        return EnumSet.of(DataAttribute.ACTIVE_POWER_PHASE_A, DataAttribute.ACTIVE_POWER_PHASE_B,
    ...
    private static Map<String, RtuReadCommand<MeasurementDto>> rtuCommandMap() {
        ...
        final Set<DataAttribute> simpleCommandAttributes = EnumSet.of(DataAttribute.BEHAVIOR, DataAttribute.HEALTH,
                ...
                DataAttribute.TOTAL_ENERGY, DataAttribute.AVERAGE_POWER_FACTOR, DataAttribute.STATE,
                DataAttribute.ALARM_ONE, DataAttribute.ALARM_TWO, DataAttribute.ALARM_THREE, DataAttribute.ALARM_FOUR,
                DataAttribute.ALARM_OTHER, DataAttribute.WARNING_ONE, DataAttribute.WARNING_TWO,
                DataAttribute.WARNING_THREE, DataAttribute.WARNING_FOUR, DataAttribute.WARNING_OTHER);
        builder.withSimpleCommandsFor(simpleCommandAttributes);

        final Set<DataAttribute> activePowerPhaseCommandAttributes = EnumSet.of(DataAttribute.ACTIVE_POWER_PHASE_A,
                DataAttribute.ACTIVE_POWER_PHASE_B, DataAttribute.ACTIVE_POWER_PHASE_C);
        builder.withIndexedCommandsFor(activePowerPhaseCommandAttributes, ACTIVE_POWER_PHASE_ID_START,
                ACTIVE_POWER_PHASE_ID_END);
