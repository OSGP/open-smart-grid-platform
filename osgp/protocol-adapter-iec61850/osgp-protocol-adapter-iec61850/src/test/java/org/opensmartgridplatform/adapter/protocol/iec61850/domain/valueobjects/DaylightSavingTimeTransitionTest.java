...
public class DaylightSavingTimeTransitionTest {
    ...
    public void testJulianIgnoringFebTransitionValidationExceedsRangeOfUnit() {
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("J0"))
                .isFalse();
        // A year (without feb 29) doesn't have more than 365 days
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("J366"))
                .isFalse();
        // Time unit may not equal or exceed 7 days
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("J88/-168"))
                .isFalse();
        // Time unit may not equal or exceed 7 days
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("J88/168"))
                .isFalse();
    ...
    public void testJulianIgnoringFebTransitionValidation() {
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("J88"))
                .isTrue();

        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid(null))
                .isFalse();
        // Invalid format
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("M3.5.0/2"))
                .isFalse();
        // No day count defined
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("J/2"))
                .isFalse();
        // Invalid number as day count
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29.isValid("Jd/2"))
                .isFalse();
    ...
    public void testJulianTransitionValidationExceedsRangeOfUnit() {
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("-1"))
                .isFalse();
        // There aren't more than 365 days (0 indexed)
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("366"))
                .isFalse();
        // Time unit may not equal or exceed 7 days
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("88/-168"))
                .isFalse();
        // Time unit may not equal or exceed 7 days
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("88/168"))
                .isFalse();
    ...
    public void testJulianTransitionValidation() {
        // Valid transition without time
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("88"))
                .isTrue();

        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid(null))
                .isFalse();
        // Invalid format
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("M3.5.0/2"))
                .isFalse();
        // No day count defined
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("/2"))
                .isFalse();
        // Invalid number as day count
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("d/2"))
                .isFalse();
        // Time is signaled but not provided
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid("88/"))
                .isFalse();
        // Invalid format (empty string)
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29.isValid(""))
                .isFalse();
    ...
    public void testDayOfWeekOfMonthTransitionValidationExceedsRangeOfUnit() {
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.isValid("M3.5.7/23"))
                .isFalse();
        // Hours are 0 indexed therefore the hour count cannot be lower than 0
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.isValid("M3.5.7/-1"))
                .isFalse();
    }
    ...
    public void testGetDateTime() {
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29
                .getDateTime(amsterdamDTZ, DST_START_J_COUNTING_FEB29_AMSTERDAM_2015, 2015))
                        .isEqualByComparingTo(DST_START_DATE_TIME_AMSTERDAM_2015);
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.getDateTime(amsterdamDTZ,
                DST_START_MWD_AMSTERDAM, 2015)).isEqualByComparingTo(DST_START_DATE_TIME_AMSTERDAM_2015);
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29
                .getDateTime(amsterdamDTZ, "326", 2015))
                        .isEqualByComparingTo(DateTime.parse("2015-11-23T00:00:00.000+01:00"));
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.getDateTime(amsterdamDTZ,
                "M11.4.1", 2015)).isEqualByComparingTo(DateTime.parse("2015-11-23T00:00:00.000+01:00"));
    ...
    public void testGetDaylightSavingTimeTransition() {
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_IGNORING_FEBRUARY_29
                ...
                .getTransition()).isEqualTo("J1");
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.JULIAN_DAY_COUNTING_FEBRUARY_29
                .getDaylightSavingTimeTransition(midNight)
                .getTransition()).isEqualTo("0");
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH
                .getDaylightSavingTimeTransition(midNight)
                .getTransition()).isEqualTo("M1.1.4");
    }

    @Test
    public void testIsValidTime() {
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.isValidTime("2:30")).isTrue();
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.isValidTime("2:30:30"))
                .isTrue();
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.isValidTime("2:30:30:900"))
                .isFalse();
    }
    ...
    public void testGetTime() {
        ...
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.getTime("M3.5.0/2"))
                .isEqualTo(2);
        assertThat(DaylightSavingTimeTransition.DstTransitionFormat.DAY_OF_WEEK_OF_MONTH.getTime("M3.5.0/2:30"))
                .isEqualTo(2);
    }
    ...
    public void testGetDateTimeForNextTransition() {
        ...
        assertThat((new DaylightSavingTimeTransition("30")).getDateTimeForNextTransition(dateTimeBeforeDay30))
                .isEqualByComparingTo(dateTimeOfDay30ThisYear);
        assertThat((new DaylightSavingTimeTransition("30")).getDateTimeForNextTransition(dateTimeAfterDay30))
