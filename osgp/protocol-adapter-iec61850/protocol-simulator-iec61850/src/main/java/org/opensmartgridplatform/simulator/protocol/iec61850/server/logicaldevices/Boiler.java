...
public class Boiler extends LogicalDevice {
  ...
  public List<BasicDataAttribute> getAttributesAndSetValues(final Date timestamp) {
    ...
    values.add(this.setQuality(LogicalDeviceNode.TTMP2_TMPSV_Q, QualityType.VALIDITY_GOOD));
    ...
    values.add(this.setQuality(LogicalDeviceNode.TTMP3_TMPSV_Q, QualityType.VALIDITY_GOOD));
    values.add(this.setTime(LogicalDeviceNode.TTMP3_TMPSV_T, timestamp));
    values.add(this.setFixedFloat(LogicalDeviceNode.TTMP4_TMPSV_INSTMAG_F, 344));
    values.add(this.setQuality(LogicalDeviceNode.TTMP4_TMPSV_Q, QualityType.VALIDITY_GOOD));
    values.add(this.setTime(LogicalDeviceNode.TTMP4_TMPSV_T, timestamp));

    values.add(this.setFixedFloat(LogicalDeviceNode.MFLW1_FLWRTE_MAG_F, 314));
    values.add(this.setQuality(LogicalDeviceNode.MFLW1_FLWRTE_Q, QualityType.VALIDITY_GOOD));
