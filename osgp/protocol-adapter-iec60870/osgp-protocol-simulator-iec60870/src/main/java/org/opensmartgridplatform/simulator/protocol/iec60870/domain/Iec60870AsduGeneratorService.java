...
public class Iec60870AsduGeneratorService {
    ...
    /**
     * Creates a generator, which generates a value exactly once. It generates
     * the value without a delay.
     *
     * @param connectionRegistry
     *            Contains the connections to which the generated value needs to
     *            be sent.
     * @param asduGenerator
     ...
     *            be sent.
     * @param cronTrigger
     *            The schedule when to generate values.
     * @param asduGenerator
