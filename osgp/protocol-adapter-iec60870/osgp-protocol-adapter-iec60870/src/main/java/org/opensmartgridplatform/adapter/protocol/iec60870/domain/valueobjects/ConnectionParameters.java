...
public class ConnectionParameters {
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(this.ipAddress, that.ipAddress)
                ...
                && Objects.equals(this.commonAddress, that.commonAddress) && Objects.equals(this.port, that.port);
    }
    ...
    public String toString() {
        return "ConnectionParameters [ipAddress=" + this.ipAddress + ", deviceIdentification="
                + this.deviceIdentification + ", commonAddress=" + this.commonAddress + ", port=" + this.port + "]";
    }
