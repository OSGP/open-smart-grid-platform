...
public class ClientConnectionEventListener implements ConnectionEventListener {
    ...
    public static final class Builder {
        ...
        public Builder withClientAsduHandlerRegistry(final ClientAsduHandlerRegistry asduHandlerRegistry) {
        ...
        public Builder withResponseMetadataFactory(final ResponseMetadataFactory responseMetadataFactory) {
