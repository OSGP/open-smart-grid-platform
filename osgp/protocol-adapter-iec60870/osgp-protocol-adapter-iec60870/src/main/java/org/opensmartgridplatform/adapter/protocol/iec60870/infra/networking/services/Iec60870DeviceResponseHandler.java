...
public class Iec60870DeviceResponseHandler implements DeviceResponseHandler {
    ...
    public Iec60870DeviceResponseHandler(final BaseMessageProcessor messageProcessor, final Integer jmsxDeliveryCount,
     ...
     * (non-Javadoc)
     *
     * @see org.opensmartgridplatform.adapter.protocol.iec60870.device.
     * DeviceResponseHandler
     * #handleResponse(org.opensmartgridplatform.adapter.protocol.iec60870.
     ...
     * org.opensmartgridplatform.adapter.protocol.iec60870.device.
     * DeviceResponse)
     */
    @Override
    ...
    private OsgpException ensureOsgpException(final Throwable t) {
        ...
        return new TechnicalException(ComponentType.PROTOCOL_IEC60870,
