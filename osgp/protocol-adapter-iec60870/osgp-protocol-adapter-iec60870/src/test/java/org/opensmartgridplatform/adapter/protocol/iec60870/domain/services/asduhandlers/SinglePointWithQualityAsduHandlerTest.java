...
public class SinglePointWithQualityAsduHandlerTest {
    ...
    @Mock
    private Iec60870AsduConverterService converterService;
    ...
    private MeasurementReportDto createMeasurementReportDto() {
        final MeasurementReportHeaderDto mrh = new MeasurementReportHeaderDto(MEASUREMENT_TYPE, MEASUREMENT_REASON,
                MEASUREMENT_ORIGINATOR_ADDRESS, MEASUREMENT_COMMON_ADDRESS);
