...
public class InformationElementFactory {
    ...
    private static Map<Iec60870InformationObjectType, Function<Object, InformationElement[][]>> factoryMap = new EnumMap<>(
            Iec60870InformationObjectType.class);
    static {
        factoryMap.put(Iec60870InformationObjectType.QUALIFIER_OF_INTERROGATION,
                InformationElementFactory::createQualityOfInterrogationInformationElement);
        factoryMap.put(Iec60870InformationObjectType.SHORT_FLOAT, InformationElementFactory::createShortFloat);
        factoryMap.put(Iec60870InformationObjectType.SINGLE_POINT_INFORMATION_WITH_QUALITY,
                InformationElementFactory::createSinglePointInformationWithQuality);
        factoryMap.put(Iec60870InformationObjectType.TIME56, InformationElementFactory::createTimestamp56);
    }
    ...
    private static InformationElement[][] createQualityOfInterrogationInformationElement(final Object value) {
    ...
    private static InformationElement[][] createSinglePointInformationWithQuality(final Object value) {
        return new InformationElement[][] {
    ...
    private static InformationElement[][] createTimestamp56(final Object value) {
        return new InformationElement[][] { { new IeTime56(((ZonedDateTime) value).toInstant().toEpochMilli()) } };
    }
}
