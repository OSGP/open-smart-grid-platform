...
public class SigningService {
  ...
  @Autowired private SigningServerResponseMessageSender signingServerResponseMessageSender;
  ...
  public void sign(
    ...
    LOGGER.info(
        "Received message to sign for device: {} with correlationId: {}",
    ...
    if (oslpEnvelope == null) {
      ...
      responseMessage =
          ResponseMessage.newResponseMessageBuilder()
              ...
              .withOsgpException(
                  new OsgpException(
                      ComponentType.UNKNOWN, "Failed to build signed OslpEnvelope", null))
      ...
      LOGGER.info(
          "Message for device: {} with correlationId: {} signed, sending response to protocol-adapter",
          deviceIdentification,
          correlationUid);
