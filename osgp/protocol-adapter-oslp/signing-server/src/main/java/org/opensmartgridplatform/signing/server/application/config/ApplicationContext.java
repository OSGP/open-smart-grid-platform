...
public class ApplicationContext extends AbstractConfig {
  ...
  private static final String PROPERTY_NAME_SIGNING_SERVER_SECURITY_SIGNKEY_PATH =
      "signing.server.security.signkey.path";
  private static final String PROPERTY_NAME_SIGNING_SERVER_SECURITY_KEYTYPE =
      "signing.server.security.keytype";
  private static final String PROPERTY_NAME_SIGNING_SERVER_SECURITY_SIGNATURE =
      "signing.server.security.signature";
  private static final String PROPERTY_NAME_SIGNING_SERVER_SECURITY_PROVIDER =
      "signing.server.security.provider";
