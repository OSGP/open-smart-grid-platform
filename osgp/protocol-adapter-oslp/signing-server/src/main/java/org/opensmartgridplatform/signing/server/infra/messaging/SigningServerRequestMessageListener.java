...
public class SigningServerRequestMessageListener implements MessageListener {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SigningServerRequestMessageListener.class);
  ...
  public void onMessage(final Message message) {
    try {
      ...
      final UnsignedOslpEnvelopeDto unsignedOslpEnvelopeDto =
          (UnsignedOslpEnvelopeDto) requestMessage.getRequest();
      ...
      LOGGER.info(
          "Received message of type: {}, for device: {} with correlationId: {} and replyToQueue: {}",
          objectMessage.getJMSType(),
      ...
      this.signingService.sign(
          unsignedOslpEnvelopeDto, correlationUid, deviceIdentification, replyToQueue);
