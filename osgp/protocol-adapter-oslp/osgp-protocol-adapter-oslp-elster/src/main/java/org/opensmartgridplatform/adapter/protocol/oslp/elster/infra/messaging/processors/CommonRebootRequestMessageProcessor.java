...
public class CommonRebootRequestMessageProcessor extends DeviceRequestMessageProcessor
  ...
  public void processSignedOslpEnvelope(
    ...
    final DeviceResponseHandler deviceResponseHandler =
        this.createSetRebootDeviceResponseHandler(
    ...
    try {
      this.deviceService.doSetReboot(legacyOslpEnvelope, deviceRequest, deviceResponseHandler, ipAddress);
  ...
  protected DeviceResponseHandler createSetRebootDeviceResponseHandler(
      final String domain,
    ...
    final DeviceResponseHandler deviceResponseHandler =
        new DeviceResponseHandler() {
          ...
          public void handleResponse(final DeviceResponse deviceResponse) {
            CommonRebootRequestMessageProcessor.this.handleEmptyDeviceResponse(
                deviceResponse,
