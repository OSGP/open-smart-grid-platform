...
public class SequenceNumberTest {
  ...
  private final TestableDeviceRegistrationService testableDeviceRegistrationService =
      new TestableDeviceRegistrationService();
  ...
  private void callFunction(
      final int currentSeqNum, final int newSeqNum, final boolean exceptionExpected) {
    try {
