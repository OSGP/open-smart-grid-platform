...
public class SetRebootDeviceResponse extends EmptyDeviceResponse {

    ConfigurationDto configuration;

    public SetRebootDeviceResponse(final DeviceRequest deviceRequest, final DeviceMessageStatus status,
