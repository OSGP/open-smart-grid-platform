...
public class OslpDevice extends AbstractEntity {
  ...
  public OslpDevice(
      final String deviceUid, final String deviceIdentification, final String deviceType) {
  ...
  public void updateRegistrationData(
      final byte[] deviceUid, final String deviceType, final Integer randomDevice) {
  ...
  public boolean equals(final Object o) {
    ...
    if (this.deviceIdentification != null
        ? !this.deviceIdentification.equals(device.deviceIdentification)
        : device.deviceIdentification != null) {
      return false;
    }
    if (this.deviceType != null
        ? !this.deviceType.equals(device.deviceType)
        : device.deviceType != null) {
      return false;
    }
    return !(this.deviceUid != null
        ? !this.deviceUid.equals(device.deviceUid)
        : device.deviceUid != null);
  }
  ...
  public int hashCode() {
    ...
    result =
        31 * result
            + (this.deviceIdentification != null ? this.deviceIdentification.hashCode() : 0);
