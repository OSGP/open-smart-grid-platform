...
public class CommonSetConfigurationRequestMessageProcessor extends DeviceRequestMessageProcessor
  ...
  @Autowired private CommonRebootRequestMessageProcessor commonRebootRequestMessageProcessor;
  ...
  public void processMessage(final ObjectMessage message) {
    ...
    try {
      ...
      final SetConfigurationDeviceRequest deviceRequest =
          new SetConfigurationDeviceRequest(
  ...
  public void processSignedOslpEnvelope(
        ...
        new DeviceResponseHandler() {
          ...
          public void handleResponse(final DeviceResponse deviceResponse) {
            if (((EmptyDeviceResponse) deviceResponse).getStatus().equals(DeviceMessageStatus.OK)) {
              ...
              LOGGER.info(
                  "setConfiguration() successful for device : {}",
    ...
    final DeviceResponseHandler setRebootDeviceResponseHandler =
        this.commonRebootRequestMessageProcessor.createSetRebootDeviceResponseHandler(
