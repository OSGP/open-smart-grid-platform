...
public class DeviceRegistrationService {
  ...
  public OslpDevice findDevice(final byte[] deviceId) throws ProtocolAdapterException {
    ...
    final var deviceUid = Base64.encodeBase64String(deviceId);

    final var oslpDevice = this.oslpDeviceSettingsService.getDeviceByUid(deviceUid);
    if (oslpDevice == null) {
  ...
  public void sendDeviceRegisterRequest(
    ...
    final var deviceRegistrationData =
        new DeviceRegistrationDataDto(inetAddress, deviceType, hasSchedule);
  ...
  public void confirmRegisterDevice(
    ...
    final var oslpDevice = this.findDevice(deviceId);
