  ...
  public void processMessage(final ObjectMessage message) {
    ...
    final GetStatusDeviceRequest deviceRequest =
        new GetStatusDeviceRequest(
            ...
            DomainTypeDto.TARIFF_SWITCHING);
    ...
    final DeviceResponseHandler deviceResponseHandler =
        new DeviceResponseHandler() {
          ...
          public void handleResponse(final DeviceResponse deviceResponse) {
            TariffSwitchingGetStatusRequestMessageProcessor.this.handleGetStatusDeviceResponse(
                deviceResponse,
          ...
          public void handleException(final Throwable t, final DeviceResponse deviceResponse) {
            TariffSwitchingGetStatusRequestMessageProcessor.this
