...
public class CommonUpdateDeviceSslCertificationRequestMessageProcessor
  ...
  public void processMessage(final ObjectMessage message) {
    ...
    try {
      ...
      final UpdateDeviceSslCertificationDeviceRequest deviceRequest =
          new UpdateDeviceSslCertificationDeviceRequest(
  ...
  public void processSignedOslpEnvelope(
    ...
    final DeviceResponseHandler deviceResponseHandler =
        new DeviceResponseHandler() {
          ...
          public void handleResponse(final DeviceResponse deviceResponse) {
            CommonUpdateDeviceSslCertificationRequestMessageProcessor.this
                .handleEmptyDeviceResponse(
                    deviceResponse,
                    CommonUpdateDeviceSslCertificationRequestMessageProcessor.this
    ...
    try {
      this.deviceService.doUpdateDeviceSslCertification(
