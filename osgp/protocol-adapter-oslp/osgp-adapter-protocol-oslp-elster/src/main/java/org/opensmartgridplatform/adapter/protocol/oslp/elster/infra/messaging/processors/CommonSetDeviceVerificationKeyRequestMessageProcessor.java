...
public class CommonSetDeviceVerificationKeyRequestMessageProcessor
    extends DeviceRequestMessageProcessor implements OslpEnvelopeProcessor {
  /** Logger for this class */
  private static final Logger LOGGER =
      LoggerFactory.getLogger(CommonSetDeviceVerificationKeyRequestMessageProcessor.class);
  ...
  public void processMessage(final ObjectMessage message) {
    ...
    final SetDeviceVerificationKeyDeviceRequest deviceRequest =
        new SetDeviceVerificationKeyDeviceRequest(
  ...
  public void processSignedOslpEnvelope(
    ...
    final DeviceResponseHandler deviceResponseHandler =
        new DeviceResponseHandler() {
          ...
          public void handleResponse(final DeviceResponse deviceResponse) {
            CommonSetDeviceVerificationKeyRequestMessageProcessor.this.handleEmptyDeviceResponse(
                deviceResponse,
          ...
          public void handleException(final Throwable t, final DeviceResponse deviceResponse) {
            CommonSetDeviceVerificationKeyRequestMessageProcessor.this
    ...
    try {
      this.deviceService.doSetDeviceVerificationKey(
