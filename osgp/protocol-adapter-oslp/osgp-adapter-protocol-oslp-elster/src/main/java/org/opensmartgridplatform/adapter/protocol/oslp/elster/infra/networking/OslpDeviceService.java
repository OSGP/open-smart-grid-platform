...
public class OslpDeviceService implements DeviceService {
  ...
  @Autowired private OslpChannelHandlerClient oslpChannelHandler;

  @Autowired private OslpMapper mapper;

  @Autowired private int oslpPortClient;

  @Autowired private int oslpPortClientLocal;

  @Autowired private boolean executeResumeScheduleAfterSetLight;

  @Autowired private boolean executeRebootAfterSetConfiguration;
  ...
  @Autowired private String failedMessagesMetric;
        ...
        new OslpResponseHandler() {
          ...
          public void handleResponse(final OslpEnvelope oslpResponse) {
            OslpDeviceService.this.handleOslpResponseSetLight(
                ...
                resumeScheduleDeviceResponseHandler);
          }

          @Override
          public void handleException(final Throwable t) {
            OslpDeviceService.this.handleException(
                t, setLightDeviceRequest, setLightDeviceResponseHandler);
          }
        };
  ...
  public void doSetEventNotifications(
      ...
      throws IOException {
    LOGGER.info(
        "doSetEventNotifications() for device: {}.", deviceRequest.getDeviceIdentification());
  ...
  private void buildOslpRequestSwitchFirmware(final SwitchFirmwareDeviceRequest deviceRequest) {
    final Oslp.SwitchFirmwareRequest switchFirmwareRequest =
        Oslp.SwitchFirmwareRequest.newBuilder()
  ...
  public void updateDeviceSslCertification(
    ...
    LOGGER.info(
        "UpdateDeviceSslCertification() for device: {}.", deviceRequest.getDeviceIdentification());
  ...
  private void buildOslpRequestUpdateDeviceSslCertification(
      final UpdateDeviceSslCertificationDeviceRequest deviceRequest) {
    final Oslp.UpdateDeviceSslCertificationRequest updateDeviceSslCertificationRequest =
        Oslp.UpdateDeviceSslCertificationRequest.newBuilder()
  ...
  public void doUpdateDeviceSslCertification(
    ...
    LOGGER.info(
        "doUpdateDeviceSslCertification() for device: {}.",
  ...
  public void setDeviceVerificationKey(final SetDeviceVerificationKeyDeviceRequest deviceRequest) {
    LOGGER.info(
        "SetDeviceVerificationKey() for device: {}.", deviceRequest.getDeviceIdentification());
  ...
  public void doSetDeviceVerificationKey(
    ...
    LOGGER.info(
        "doSetDeviceVerificationKey() for device: {}.", deviceRequest.getDeviceIdentification());
  ...
  private void processOslpRequestGetConfigurationForSetScheduleAstronomicalOffsets(
      final SetScheduleDeviceRequest deviceRequest) {
    LOGGER.debug(
        "Processing get configuration before set schedule request for device: {}.",
        deviceRequest.getDeviceIdentification());

    this.buildOslpRequestGetConfigurationForSetScheduleAstronomicalOffsets(deviceRequest);
  }

  private void processOslpRequestSetScheduleAstronomicalOffsets(
      final SetScheduleDeviceRequest deviceRequest) {
    LOGGER.debug(
        "Processing set schedule astronomical offsets request for device: {}.",
        deviceRequest.getDeviceIdentification());

    this.buildOslpRequestSetScheduleAstronomicalOffsets(deviceRequest);
  }

  private void processOslpRequestSetRebootForSetScheduleAstronomicalOffsets(
      final SetScheduleDeviceRequest deviceRequest) {
    LOGGER.debug(
        "Processing set reboot before set schedule request for device: {}.",
        deviceRequest.getDeviceIdentification());
  ...
  public void doSetSchedule(
    ...
    switch (deviceRequest.getScheduleMessageDataContainer().getScheduleMessageType()) {
      case RETRIEVE_CONFIGURATION:
        this.doProcessOslpRequestSetScheduleGetConfiguration(
            oslpRequest, deviceRequest, deviceResponseHandler, ipAddress);
        break;
      case SET_ASTRONOMICAL_OFFSETS:
        this.doProcessOslpRequestSetScheduleAstronomicalOffsets(
            oslpRequest, deviceRequest, deviceResponseHandler, ipAddress);
        break;
      case SET_REBOOT:
        this.doProcessOslpRequestSetReboot(
            oslpRequest, deviceRequest, deviceResponseHandler, ipAddress);
        break;
      case SET_SCHEDULE:
      default:
        this.doProcessOslpRequestSetSchedule(
            oslpRequest,
            deviceRequest,
  ...
  private void doProcessOslpRequestSetSchedule(
      ...
      throws IOException {
    if (pageInfo == null) {
      this.doProcessOslpRequestSetScheduleSingle(
          oslpRequest, deviceRequest, deviceResponseHandler, ipAddress);
    } else {
      final Pager pager =
          new Pager(
      ...
      this.doProcessOslpRequestSetSchedulePaged(
          oslpRequest,
          deviceRequest,
          deviceResponseHandler,
          ipAddress,
  ...
  private void processOslpRequestSetScheduleSingle(final SetScheduleDeviceRequest deviceRequest) {
    ...
    LOGGER.debug(
        "Processing single set schedule request for device: {}.",
        deviceRequest.getDeviceIdentification());
  ...
  private void doProcessOslpRequestSetScheduleGetConfiguration(
    ...
    LOGGER.debug(
        "Processing a get configuration before setting schedule with astronomical offsets to device: {}.",
        deviceRequest.getDeviceIdentification());
  ...
  private void doProcessOslpRequestSetReboot(
    ...
    LOGGER.debug(
        "Processing set reboot before setting schedule with astronomical offsets to request for device: {}.",
        deviceRequest.getDeviceIdentification());
  ...
  protected void handleException(
    ...
    if (t instanceof IOException) {
      ...
      final ConnectionFailureException ex =
          new ConnectionFailureException(ComponentType.PROTOCOL_OSLP, "Connection failure");
  ...
  private void handleOslpResponseSetScheduleAstronomicalOffsets(
    ...
    if (oslpResponse.getPayloadMessage().hasSetConfigurationResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getSetConfigurationResponse().getStatus();
  ...
  private void handleOslpResponseSetReboot(
    ...
    if (oslpResponse.getPayloadMessage().hasSetScheduleResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getSetScheduleResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void buildOslpRequestGetConfigurationForSetScheduleAstronomicalOffsets(
      final SetScheduleDeviceRequest deviceRequest) {

    final ScheduleMessageDataContainerDto scheduleMessageDataContainer =
        deviceRequest.getScheduleMessageDataContainer();
  ...
  private void buildOslpRequestSetRebootForAstronomicalOffsets(
      final SetScheduleDeviceRequest deviceRequest) {
  ...
  private void buildOslpRequestSetScheduleAstronomicalOffsets(
      final SetScheduleDeviceRequest deviceRequest) {
    ...
    final Oslp.SetConfigurationRequest request =
        this.mapper.map(configuration, Oslp.SetConfigurationRequest.class);

    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setSetConfigurationRequest(request).build(),
        scheduleMessageDataContainer);
  }

  private void buildOslpRequestSetScheduleSingle(final SetScheduleDeviceRequest deviceRequest) {
    final List<Oslp.Schedule> oslpSchedules =
        this.convertToOslpSchedules(
            deviceRequest.getScheduleMessageDataContainer().getSchedule().getScheduleList());

    final Oslp.SetScheduleRequest.Builder request =
        SetScheduleRequest.newBuilder()
    ...
    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setSetScheduleRequest(request.build()).build(),
        scheduleMessageDataContainer);
  }

  private void processOslpRequestSetSchedulePaged(
      final SetScheduleDeviceRequest deviceRequest, final Pager pager) {
    LOGGER.debug(
        "Processing paged set schedule request for device: {}, page {} of {}",
        deviceRequest.getDeviceIdentification(),
  ...
  private void buildOslpRequestSetSchedulePaged(
      final SetScheduleDeviceRequest deviceRequest, final Pager pager) {
    ...
    final Oslp.SetScheduleRequest.Builder oslpRequestBuilder =
        SetScheduleRequest.newBuilder()
            .addAllSchedules(oslpSchedules)
            .setScheduleType(
                this.mapper.map(
                    ...
                    org.opensmartgridplatform.oslp.Oslp.RelayType.class))
            .setPageInfo(
                Oslp.PageInfo.newBuilder()
                    .setCurrentPage(pager.getCurrentPage())
                    .setPageSize(pager.getPageSize())
                    .setTotalPages(pager.getNumberOfPages()));

    final PageInfoDto pageInfo =
        new PageInfoDto(pager.getCurrentPage(), pager.getPageSize(), pager.getNumberOfPages());
    final ScheduleDto schedule =
        new ScheduleDto(
            deviceRequest.getScheduleMessageDataContainer().getSchedule().getScheduleList());
    final ScheduleMessageDataContainerDto scheduleMessageDataContainer =
        new ScheduleMessageDataContainerDto.Builder(schedule).withPageInfo(pageInfo).build();
  ...
  private Oslp.Schedule convertToOslpSchedule(final ScheduleEntryDto schedule) {
    Oslp.Schedule.Builder scheduleBuilder =
        Oslp.Schedule.newBuilder()
    ...
    if (StringUtils.isNotBlank(schedule.getTime())) {
      scheduleBuilder.setTime(
          JavaTimeHelpers.formatTemporal(
              LocalTime.parse(schedule.getTime()), DateTimeFormatter.ofPattern(TIME_FORMAT)));
    }

    if (schedule.getTriggerWindow() != null) {
      scheduleBuilder =
          scheduleBuilder.setWindow(
              Oslp.Window.newBuilder()
    ...
    if (schedule.getTriggerType() != null) {
      scheduleBuilder.setTriggerType(
          Oslp.TriggerType.valueOf(schedule.getTriggerType().ordinal() + 1));
    }
  ...
  public void doSetConfiguration(
    ...
    final OslpResponseHandler oslpResponseHandler =
        new OslpResponseHandler() {
          ...
          public void handleException(final Throwable t) {
            OslpDeviceService.this.handleException(
                t, setConfigurationDeviceRequest, setConfigurationDeviceResponseHandler);
          }
        };
  ...
  private DeviceResponse buildDeviceResponseGetConfiguration(
    ...
    if (oslpResponse.getPayloadMessage().hasGetConfigurationResponse()) {
      final Oslp.GetConfigurationResponse getConfigurationResponse =
          oslpResponse.getPayloadMessage().getGetConfigurationResponse();
  ...
  private DeviceResponse buildDeviceResponseSwitchConfiguration(
    ...
    if (oslpResponse.getPayloadMessage().hasSwitchConfigurationResponse()) {
      final Oslp.SwitchConfigurationResponse switchConfigurationResponse =
          oslpResponse.getPayloadMessage().getSwitchConfigurationResponse();
  ...
  private DeviceResponse buildDeviceResponseSwitchFirmware(
    ...
    if (oslpResponse.getPayloadMessage().hasSwitchFirmwareResponse()) {
      final Oslp.SwitchFirmwareResponse switchFirmwareResponse =
          oslpResponse.getPayloadMessage().getSwitchFirmwareResponse();
  ...
  private DeviceResponse buildDeviceResponseUpdateDeviceSslCertification(
    ...
    if (oslpResponse.getPayloadMessage().hasUpdateDeviceSslCertificationResponse()) {
      final Oslp.UpdateDeviceSslCertificationResponse updateDeviceSslCertificationResponse =
          oslpResponse.getPayloadMessage().getUpdateDeviceSslCertificationResponse();

      status =
          this.mapper.map(
              updateDeviceSslCertificationResponse.getStatus(), DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private DeviceResponse buildDeviceResponseSetDeviceVerificationKey(
    ...
    if (oslpResponse.getPayloadMessage().hasSetDeviceVerificationKeyResponse()) {
      final Oslp.SetDeviceVerificationKeyResponse setDeviceVerificationKeyResponse =
          oslpResponse.getPayloadMessage().getSetDeviceVerificationKeyResponse();

      status =
          this.mapper.map(setDeviceVerificationKeyResponse.getStatus(), DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void buildOslpRequestGetConfiguration(final DeviceRequest deviceRequest) {
    ...
    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setGetConfigurationRequest(getConfigurationRequest).build(),
        null);
  }

  private void buildOslpRequestSwitchConfiguration(
      final SwitchConfigurationBankRequest deviceRequest) {
    final Oslp.SwitchConfigurationRequest switchConfigurationRequest =
        Oslp.SwitchConfigurationRequest.newBuilder()
            .setNewConfigurationSet(
                ByteString.copyFrom(deviceRequest.getConfigurationBank().getBytes()))
            .build();
  ...
  private void buildOslpRequestGetFirmwareVersion(final DeviceRequest deviceRequest) {
    final Oslp.GetFirmwareVersionRequest getFirmwareVersionRequest =
        GetFirmwareVersionRequest.newBuilder().build();

    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setGetFirmwareVersionRequest(getFirmwareVersionRequest).build(),
        null);
  }
  ...
  private void buildOslpRequestGetStatus(final DeviceRequest deviceRequest) {
    ...
    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setGetStatusRequest(getStatusRequest).build(),
        null);
  }

  private void buildOslpRequestResumeSchedule(final ResumeScheduleDeviceRequest deviceRequest) {
    final Oslp.ResumeScheduleRequest.Builder resumeScheduleRequestBuilder =
        Oslp.ResumeScheduleRequest.newBuilder();
    if (deviceRequest.getResumeScheduleContainer().getIndex() != null) {
      resumeScheduleRequestBuilder.setIndex(
          ByteString.copyFrom(
              new byte[] {deviceRequest.getResumeScheduleContainer().getIndex().byteValue()}));
    }
    resumeScheduleRequestBuilder.setImmediate(
        deviceRequest.getResumeScheduleContainer().isImmediate());

    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder()
            .setResumeScheduleRequest(resumeScheduleRequestBuilder.build())
            .build(),
  ...
  private void buildOslpRequestSetEventNotifications(
      final SetEventNotificationsDeviceRequest deviceRequest) {
    final Oslp.SetEventNotificationsRequest.Builder builder =
        Oslp.SetEventNotificationsRequest.newBuilder();

    int bitMask = 0;
    for (final EventNotificationTypeDto ent :
  ...
  private void buildOslpRequestSetLight(final SetLightDeviceRequest deviceRequest) {
    ...
    for (final LightValueDto lightValue :
  ...
  private void buildOslpRequestSetRebootForAstronomicalOffsets(final DeviceRequest deviceRequest) {
    ...
    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setSetRebootRequest(setRebootRequest).build(),
        null);
  }

  private void buildOslpRequestSetTransition(final SetTransitionDeviceRequest deviceRequest) {
    final Oslp.SetTransitionRequest.Builder setTransitionBuilder =
        Oslp.SetTransitionRequest.newBuilder()
            .setTransitionType(
                this.mapper.map(
                    deviceRequest.getTransitionTypeContainer().getTransitionType(),
  ...
  private void buildOslpRequestStartSelfTest(final DeviceRequest deviceRequest) {
    final Oslp.StartSelfTestRequest startSelftestRequest =
        Oslp.StartSelfTestRequest.newBuilder().build();

    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setStartSelfTestRequest(startSelftestRequest).build(),
        null);
  }

  private void buildOslpRequestStopSelfTest(final DeviceRequest deviceRequest) {
    final Oslp.StopSelfTestRequest stopSelftestRequest =
        Oslp.StopSelfTestRequest.newBuilder().build();

    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setStopSelfTestRequest(stopSelftestRequest).build(),
        null);
  }

  private void buildOslpRequestUpdateFirmware(final UpdateFirmwareDeviceRequest deviceRequest) {
    final Oslp.UpdateFirmwareRequest updateFirmwareRequest =
        Oslp.UpdateFirmwareRequest.newBuilder()
    ...
    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder().setUpdateFirmwareRequest(updateFirmwareRequest).build(),
        null);
  }

  private void buildOslpRequestSetDeviceVerificationKey(
      final SetDeviceVerificationKeyDeviceRequest deviceRequest) {
    final Oslp.SetDeviceVerificationKeyRequest setDeviceVerificationKey =
        Oslp.SetDeviceVerificationKeyRequest.newBuilder()
    ...
    this.buildAndSignEnvelope(
        deviceRequest,
        Oslp.Message.newBuilder()
            .setSetDeviceVerificationKeyRequest(setDeviceVerificationKey)
            .build(),
  ...
  private void handleOslpResponseGetConfiguration(
    ...
    final DeviceResponse deviceResponse =
        this.buildDeviceResponseGetConfiguration(deviceRequest, oslpResponse);
  ...
  private void handleOslpResponseSwitchConfiguration(
    ...
    final DeviceResponse deviceResponse =
        this.buildDeviceResponseSwitchConfiguration(deviceRequest, oslpResponse);
  ...
  private void handleOslpResponseGetFirmwareVersion(
    ...
    if (oslpResponse.getPayloadMessage().hasGetFirmwareVersionResponse()) {
      firmwareVersion =
          oslpResponse.getPayloadMessage().getGetFirmwareVersionResponse().getFirmwareVersion();
    }

    final DeviceResponse deviceResponse =
        new GetFirmwareVersionDeviceResponse(deviceRequest, firmwareVersion);
    deviceResponseHandler.handleResponse(deviceResponse);
  }
  ...
  private void handleOslpResponseSwitchFirmware(
    ...
    final DeviceResponse deviceResponse =
        this.buildDeviceResponseSwitchFirmware(deviceRequest, oslpResponse);
  ...
  private void handleOslpResponseUpdateDeviceSslCertification(
    ...
    final DeviceResponse deviceResponse =
        this.buildDeviceResponseUpdateDeviceSslCertification(deviceRequest, oslpResponse);
  ...
  private void handleOslpResponseSetDeviceVerificationKey(
    ...
    final DeviceResponse deviceResponse =
        this.buildDeviceResponseSetDeviceVerificationKey(deviceRequest, oslpResponse);
  ...
  private void handleOslpResponseGetStatus(
    ...
    if (oslpResponse.getPayloadMessage().hasGetStatusResponse()) {
      final Oslp.GetStatusResponse getStatusResponse =
          oslpResponse.getPayloadMessage().getGetStatusResponse();
      ...
      if (oslpStatus == Oslp.Status.OK) {
        ...
        deviceStatus =
            new DeviceStatusDto(
                lightValues, preferredType, actualLinkType, lightType, eventNotificationMask);
  ...
  private LinkTypeDto getPreferredLinktype(final Oslp.GetStatusResponse getStatusResponse) {
    return getStatusResponse.getPreferredLinktype().equals(Oslp.LinkType.LINK_NOT_SET)
        ? null
  ...
  private LinkTypeDto getActualLinktype(final Oslp.GetStatusResponse getStatusResponse) {
    return getStatusResponse.getActualLinktype().equals(Oslp.LinkType.LINK_NOT_SET)
        ? null
  ...
  private LightTypeDto getLightType(final Oslp.GetStatusResponse getStatusResponse) {
    return getStatusResponse.getLightType().equals(Oslp.LightType.LT_NOT_SET)
        ? null
        : this.mapper.map(getStatusResponse.getLightType(), LightTypeDto.class);
  }

  private void setBootLoaderVersion(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
    if (getStatusResponse.hasBootLoaderVersion()) {
      deviceStatus.setBootLoaderVersion(getStatusResponse.getBootLoaderVersion());
    }
  }

  private void setCurrentConfigurationBankUsed(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
    if (getStatusResponse.getCurrentConfigurationBackUsed() != null
      ...
      deviceStatus.setCurrentConfigurationBackUsed(
          this.convertCurrentConfigurationBankUsed(
              getStatusResponse.getCurrentConfigurationBackUsed()));
    }
  }
  ...
  private void setDcOutputVoltageCurrent(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setDcOutputVoltageMaximum(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setEventNotificationsMask(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setExternalFlashMemSize(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setInternalFlashMemSize(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setLastInternalTestResultCode(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setMaximumOutputPowerOnDcOutput(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
    if (getStatusResponse.hasMaximumOutputPowerOnDcOutput()) {
      deviceStatus.setMaximumOutputPowerOnDcOutput(
          getStatusResponse.getMaximumOutputPowerOnDcOutput());
    }
  }
  ...
  private void setNumberOfOutputs(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void setStartupCounter(
      final DeviceStatusDto deviceStatus, final Oslp.GetStatusResponse getStatusResponse) {
  ...
  private void handleOslpResponseResumeSchedule(
    ...
    if (oslpResponse.getPayloadMessage().hasResumeScheduleResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getResumeScheduleResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void handleOslpResponseSetConfiguration(
    ...
    this.updateSequenceNumber(
        setConfigurationDeviceRequest.getDeviceIdentification(), oslpResponse);
    ...
    final DeviceResponse deviceResponse =
        new EmptyDeviceResponse(
            ...
            setConfigurationDeviceRequest.getMessagePriority(),
            status);
    ...
    if (this.executeRebootAfterSetConfiguration && status.equals(DeviceMessageStatus.OK)) {
      LOGGER.info(
          "Sending SetRebootRequest for device: {}",
          setConfigurationDeviceRequest.getDeviceIdentification());
      ...
      final DeviceResponse emptyDeviceResponse =
          new EmptyDeviceResponse(
              setConfigurationDeviceRequest.getOrganisationIdentification(),
              setConfigurationDeviceRequest.getDeviceIdentification(),
              setConfigurationDeviceRequest.getCorrelationUid(),
  ...
  private void handleOslpResponseSetEventNotifications(
    ...
    if (oslpResponse.getPayloadMessage().hasSetEventNotificationsResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getSetEventNotificationsResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void handleOslpResponseSetLight(
    ...
    if (oslpResponse.getPayloadMessage().hasSetLightResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getSetLightResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
    ...
    if (this.executeResumeScheduleAfterSetLight && status.equals(DeviceMessageStatus.OK)) {
      LOGGER.info(
          "Sending ResumeScheduleRequest for device: {}", deviceRequest.getDeviceIdentification());
  ...
  private void handleOslpResponseSetReboot(
    ...
    if (oslpResponse.getPayloadMessage().hasSetRebootResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getSetRebootResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void handleOslpResponseSetTransition(
    ...
    if (oslpResponse.getPayloadMessage().hasSetTransitionResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getSetTransitionResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void handleOslpResponseStartSelfTest(
    ...
    if (oslpResponse.getPayloadMessage().hasStartSelfTestResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getStartSelfTestResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void handleOslpResponseStopSelfTest(
    ...
    if (oslpResponse.getPayloadMessage().hasStopSelfTestResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getStopSelfTestResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void handleOslpResponseUpdateFirmware(
    ...
    if (oslpResponse.getPayloadMessage().hasUpdateFirmwareResponse()) {
      final Oslp.Status oslpStatus =
          oslpResponse.getPayloadMessage().getUpdateFirmwareResponse().getStatus();
      status = this.mapper.map(oslpStatus, DeviceMessageStatus.class);
    } else {
      status = DeviceMessageStatus.FAILURE;
    }
  ...
  private void buildAndSignEnvelope(
      final DeviceRequest deviceRequest,
  ...
  private void saveOslpResponseLogEntry(
    ...
    final OslpLogItemRequestMessage oslpLogItemRequestMessage =
        new OslpLogItemRequestMessage(
            deviceRequest.getOrganisationIdentification(),
            oslpDevice.getDeviceUid(),
            deviceRequest.getDeviceIdentification(),
            true,
            oslpResponse.isValid(),
            oslpResponse.getPayloadMessage(),
