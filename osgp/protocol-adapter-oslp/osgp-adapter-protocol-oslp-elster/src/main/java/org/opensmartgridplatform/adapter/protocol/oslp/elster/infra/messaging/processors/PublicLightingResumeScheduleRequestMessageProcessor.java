...
public class PublicLightingResumeScheduleRequestMessageProcessor
  ...
  public void processMessage(final ObjectMessage message) {
    ...
    try {
      ...
      resumeScheduleMessageDataContainer =
          (ResumeScheduleMessageDataContainerDto) message.getObject();
    ...
    try {
      ...
      final ResumeScheduleDeviceRequest deviceRequest =
  ...
  public void processSignedOslpEnvelope(
    ...
    final DeviceResponseHandler deviceResponseHandler =
        this.createResumeScheduleDeviceResponseHandler(
            domain, domainVersion, messageType, retryCount, isScheduled);

    final ResumeScheduleMessageDataContainerDto resumeScheduleMessageDataContainer =
        (ResumeScheduleMessageDataContainerDto) unsignedOslpEnvelopeDto.getExtraData();
    final ResumeScheduleDeviceRequest deviceRequest =
        new ResumeScheduleDeviceRequest(
    ...
    try {
      this.deviceService.doResumeSchedule(
  ...
  protected DeviceResponseHandler createResumeScheduleDeviceResponseHandler(
      final String domain,
    ...
    return new DeviceResponseHandler() {
      ...
      public void handleException(final Throwable t, final DeviceResponse deviceResponse) {
        PublicLightingResumeScheduleRequestMessageProcessor.this
