...
/** Utility class for converting sequence number value from Integer to byte array and vice versa. */
public class SequenceNumberUtils {
  ...
  /**
   * Convert an Integer object's value into a byte array of size 2. The range of the value can be
   * from 0 to 65535, equal to a 16 bit unsigned value.
   *
   * @param value The integer value to convert into the byte array.
  ...
  /**
   * Convert a byte array of size 2 into an Integer object. The range of the value can be from 0 to
   * 65535, equal to a 16 bit unsigned value.
   *
   * @param array The byte array of size 2 to convert into an Integer object.
