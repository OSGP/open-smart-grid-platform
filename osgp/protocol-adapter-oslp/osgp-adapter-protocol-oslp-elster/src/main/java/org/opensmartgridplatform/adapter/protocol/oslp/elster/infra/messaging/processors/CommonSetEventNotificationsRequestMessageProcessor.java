...
public class CommonSetEventNotificationsRequestMessageProcessor
  ...
  public void processMessage(final ObjectMessage message) {
    ...
    try {
      ...
      eventNotificationMessageDataContainer =
          (EventNotificationMessageDataContainerDto) message.getObject();
    ...
    try {
      ...
      final SetEventNotificationsDeviceRequest deviceRequest =
          new SetEventNotificationsDeviceRequest(
  ...
  public void processSignedOslpEnvelope(
    ...
    final DeviceResponseHandler deviceResponseHandler =
        new DeviceResponseHandler() {
          ...
          public void handleException(final Throwable t, final DeviceResponse deviceResponse) {
            CommonSetEventNotificationsRequestMessageProcessor.this
    ...
    try {
      this.deviceService.doSetEventNotifications(
