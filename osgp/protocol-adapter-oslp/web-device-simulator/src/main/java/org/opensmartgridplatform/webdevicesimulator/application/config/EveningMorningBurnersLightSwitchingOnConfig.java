...
public class EveningMorningBurnersLightSwitchingOnConfig implements SchedulingConfigurer {
    ...
    public void configureTasks(final ScheduledTaskRegistrar taskRegistrar) {
        ...
        taskRegistrar.addCronTask(new CronTask(this.eveningMorningBurnersLightSwitchingOn,
    ...
    public TaskScheduler eveningMorningBurnerslightSwitchingOnTaskScheduler() {
        ...
        eveningMorningBurnerslightSwitchingOnTaskScheduler.setThreadNamePrefix(this.environment.getRequiredProperty(
