...
public class OslpTestHandler extends SimpleChannelInboundHandler<LegacyOslpEnvelope> {

  private static final Logger LOGGER = LoggerFactory.getLogger(OslpTestHandler.class);

  private final Consumer<LegacyOslpEnvelope> oslpEnvelopeConsumer;
  ...
  public OslpTestHandler(final Consumer<LegacyOslpEnvelope> oslpEnvelopeConsumer) {
