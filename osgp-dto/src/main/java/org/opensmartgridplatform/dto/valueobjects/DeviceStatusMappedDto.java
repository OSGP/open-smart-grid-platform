...
public class DeviceStatusMappedDto extends DeviceStatusDto {
     ...
     * @param lightValues
     *            light values to use
     * @param preferredLinkType
     *            preferred linktype to use
     * @param actualLinkType
     *            actuallink type to use
     * @param lightType
     *            light type to use
     * @param eventNotificationsMask
     *            eventmask to use
     */
    public DeviceStatusMappedDto(final List<TariffValueDto> tariffValues, final List<LightValueDto> lightValues,
            final LinkTypeDto preferredLinkType, final LinkTypeDto actualLinkType, final LightTypeDto lightType,
