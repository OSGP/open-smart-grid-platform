...
public class SetDeviceCommunicationSettingsRequestDataDto implements ActionRequestDto {
    ...
    public SetDeviceCommunicationSettingsRequestDataDto(final int challengeLength, final boolean withListSupported,
            final boolean selectiveAccessSupported, final boolean ipAddressIsStatic, final boolean useSn,
