...
public class DeviceStatusDto implements Serializable {
    ...
    public DeviceStatusDto(final List<LightValueDto> lightValues, final LinkTypeDto preferredLinkType,
            final LinkTypeDto actualLinkType, final LightTypeDto lightType, final int eventNotificationsMask) {
    ...
    public List<EventNotificationTypeDto> getEventNotifications() {
        final List<EventNotificationTypeDto> events = new ArrayList<EventNotificationTypeDto>();
