...
public enum EventType {
    ...
    MONITOR_EVENTS_TEST_RELAY_ON(21),
    MONITOR_EVENTS_TEST_RELAY_OFF(22),
    MONITOR_EVENTS_LOSS_OF_POWER(23),
    MONITOR_EVENTS_LOCAL_MODE(24),
    MONITOR_EVENTS_REMOTE_MODE(25),
    FIRMWARE_EVENTS_CONFIGURATION_CHANGED(26);
