 ...
 * @author dev
 */
public class PeriodicMeterReadsRequest implements ActionRequestDto {
    ...
    public PeriodicMeterReadsRequest(final PeriodTypeDto periodType, final Date beginDate, final Date endDate,
