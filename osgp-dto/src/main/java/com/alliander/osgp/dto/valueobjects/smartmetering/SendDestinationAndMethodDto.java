...
public class SendDestinationAndMethodDto implements Serializable {
    ...
    public SendDestinationAndMethodDto(final TransportServiceTypeDto transportService, final String destination,
    ...
    public String toString() {
        return "SendDestinationAndMethod[service=" + this.transportService + ", destination=" + this.destination
