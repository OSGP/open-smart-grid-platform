...
public class ProfileGenericDataResponseItemDto extends MeterReadsResponseDto {
     ...
     */
    public ProfileGenericDataResponseItemDto(final Date logTime, final DlmsMeterValueDto activeEnergyImport,
     ...
     * @param activeEnergyExportTariffTwo
     */
    public ProfileGenericDataResponseItemDto(final Date logTime, final DlmsMeterValueDto activeEnergyImportTariffOne,
            final DlmsMeterValueDto activeEnergyImportTariffTwo, final DlmsMeterValueDto activeEnergyExportTariffOne,
