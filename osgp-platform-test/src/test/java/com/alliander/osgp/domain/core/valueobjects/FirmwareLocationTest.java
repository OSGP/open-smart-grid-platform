...
public class FirmwareLocationTest {
    ...
    public void getDomainTest() {
        final FirmwareLocation subject = new FirmwareLocation("flexovltest.cloudapp.net", "firmware", "zip");
    ...
    public void getFullPathTest() {
        ...
        assertThat(subject.getFullPath("ame-v1.0"), equalTo("/firmware/ame-v1.0.zip"));
    }
    ...
    public void getFullPathWithEmptyPartialPath() {
        final FirmwareLocation subject = new FirmwareLocation("flexovltest.cloudapp.net", "", ".zip");

        assertThat(subject.getFullPath("ame-v1.0"), equalTo("/ame-v1.0.zip"));
    }
    ...
    public void createFirmwareLocationWithEmptyDomain() {
        new FirmwareLocation("", "/firmware", "zip");
    }
    ...
    public void createFirmwareLocationWithNullDomain() {
        new FirmwareLocation(null, "/firmware", "zip");
    }
}
