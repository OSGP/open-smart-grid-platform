...
public class VerifyAuthorizeDeviceFunctionSteps {
    ...
    public void andDifferentOrganisation(final String different) {
        ...
        this.differentOrganisation = new OrganisationBuilder().withOrganisationIdentification(different)
                .withFunctionGroup(PlatformFunctionGroup.USER).build();

        when(
                this.organisationRepositoryMock.findByOrganisationIdentification(this.differentOrganisation
                        .getOrganisationIdentification())).thenReturn(this.differentOrganisation);
    }

    @DomainStep("device function SET_DEVICE_AUTHORIZATION is called to associate (.*) with (.*)")
    public void whenDeviceFunctionSetDeviceAuthorizationIsCalled(final String different, final String group)
            throws OperationNotSupportedException, ArgumentNullOrEmptyException, UnknownEntityException,
            NotAuthorizedException, NotSupportedException {
        LOGGER.info("Creating device authorization: {}", different);

        try {
            this.setDeviceAuthorization(com.alliander.osgp.adapter.ws.schema.admin.devicemanagement.DeviceFunctionGroup
    ...
    private void startSelfTest() throws OsgpException {
        ...
        final com.alliander.osgp.oslp.Oslp.StartSelfTestResponse oslpResponse = com.alliander.osgp.oslp.Oslp.StartSelfTestResponse
        ...
        this.response = this.coreDeviceInstallationEndpoint.startDeviceTest(
    ...
    private void stopSelfTest() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.StopSelfTestResponse oslpResponse = com.alliander.osgp.oslp.Oslp.StopSelfTestResponse
        ...
        this.response = this.coreDeviceInstallationEndpoint.stopDeviceTest(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setLight() throws OsgpException {
        ...
        this.response = this.lightAdHocManagementEndpoint.setLight(this.organisation.getOrganisationIdentification(),
                request);
    }
    ...
    private void getStatus() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.GetStatusResponse oslpResponse = com.alliander.osgp.oslp.Oslp.GetStatusResponse
                .newBuilder().setStatus(Status.OK).setPreferredLinktype(LinkType.CDMA).setActualLinktype(LinkType.CDMA)
                .setLightType(LightType.DALI).setEventNotificationMask(0).addValue(LightValue.newBuilder().setOn(true))
                .build();
        ...
        this.response = this.lightAdHocManagementEndpoint.getStatus(this.organisation.getOrganisationIdentification(),
                request);
    }
    ...
    private void removeDevice() throws OsgpException {
        ...
        request.setDeviceIdentification(this.device.getDeviceIdentification());
        this.response = this.adminDeviceManagementEndpoint.removeDevice(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setDeviceAuthorization(
        ...
        this.response = this.adminDeviceManagementEndpoint.updateDeviceAuthorisations(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void getDeviceAuthorization() throws OsgpException {
        ...
        request.setDeviceIdentification(this.device.getDeviceIdentification());
        this.response = this.adminDeviceManagementEndpoint.findDeviceAuthorisations(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setEventNotifications() throws OsgpException {
        ...
        this.response = this.coreDeviceManagementEndpoint.setEventNotifications(
                this.organisation.getOrganisationIdentification(), request);
    }

    @SuppressWarnings("unchecked")
    private void getEventNotifications() throws OsgpException {
        when(this.eventRepositoryMock.findAll(any(Specification.class), any(Pageable.class))).thenReturn(
                new PageImpl<Event>(new ArrayList<Event>()));
        final FindEventsRequest request = new FindEventsRequest();
        request.setDeviceIdentification(this.device.getDeviceIdentification());
        this.response = this.coreDeviceManagementEndpoint.findEventsRequest(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void updateFirmware() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.UpdateFirmwareResponse oslpResponse = com.alliander.osgp.oslp.Oslp.UpdateFirmwareResponse
                .newBuilder().setStatus(Status.OK).build();
        ...
        this.response = this.coreFirmwareManagementEndpoint.updateFirmware(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void getFirmwareVersion() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.GetFirmwareVersionResponse oslpResponse = com.alliander.osgp.oslp.Oslp.GetFirmwareVersionResponse
                .newBuilder().setFirmwareVersion("dummy").build();
        ...
        this.response = this.coreFirmwareManagementEndpoint.getFirmwareVersion(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setSchedule() throws OsgpException {
        ...
        this.response = this.lightScheduleManagementEndpoint.setLightSchedule(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setTariffSchedule() throws OsgpException {
        ...
        this.response = this.tariffScheduleManagementEndpoint.setSchedule(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setConfiguration() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.SetConfigurationResponse oslpResponse = com.alliander.osgp.oslp.Oslp.SetConfigurationResponse
                .newBuilder().setStatus(Status.OK).build();
        ...
        this.response = this.coreConfigurationManagementEndpoint.setConfiguration(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void getConfiguration() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.GetConfigurationResponse oslpResponse = com.alliander.osgp.oslp.Oslp.GetConfigurationResponse
                .newBuilder().setStatus(Status.OK).build();
        ...
        this.response = this.coreConfigurationManagementEndpoint.getConfiguration(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void getActualPowerUsage() throws OsgpException {
        ...
        this.response = this.lightDeviceMonitoringEndpoint.getActualPowerUsage(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void getPowerUsageHistory() throws OsgpException {
        ...
        this.response = this.lightDeviceMonitoringEndpoint.getPowerUsageHistory(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void resumeSchedule() throws OsgpException {
        ...
        // device always responds ok
        final com.alliander.osgp.oslp.Oslp.ResumeScheduleResponse oslpResponse = com.alliander.osgp.oslp.Oslp.ResumeScheduleResponse
                .newBuilder().setStatus(Status.OK).build();
        ...
        this.response = this.lightAdHocManagementEndpoint.resumeSchedule(
                this.organisation.getOrganisationIdentification(), request);
    }
    ...
    private void setReboot() throws OsgpException {
        ...
        this.response = this.coreAdHocManagementEndpoint.setReboot(this.organisation.getOrganisationIdentification(),
                request);
    }
    ...
    private void setTransition() throws OsgpException {
        ...
        this.response = this.lightAdHocManagementEndpoint.setTransition(
                this.organisation.getOrganisationIdentification(), request);
    }

    private void setUp() {
        Mockito.reset(new Object[] { this.deviceRepositoryMock, this.authorizationRepositoryMock,
                this.organisationRepositoryMock, this.eventRepositoryMock, this.channelMock,
        ...
        this.coreAdHocManagementEndpoint = new AdHocManagementEndpoint(this.adHocManagementService);
        this.coreConfigurationManagementEndpoint = new ConfigurationManagementEndpoint(
                this.configurationManagementService, new ConfigurationManagementMapper());
        ...
        this.lightAdHocManagementEndpoint = new com.alliander.osgp.adapter.ws.publiclighting.endpoints.PublicLightingAdHocManagementEndpoint(
                this.lightAdHocManagementService,
                new com.alliander.osgp.adapter.ws.publiclighting.application.mapping.AdHocManagementMapper());
        ...
        this.tariffAdHocManagementEndpoint = new com.alliander.osgp.adapter.ws.tariffswitching.endpoints.TariffSwitchingAdHocManagementEndpoint(
                this.tariffAdHocManagementService,
                new com.alliander.osgp.adapter.ws.tariffswitching.application.mapping.AdHocManagementMapper());
        this.tariffScheduleManagementEndpoint = new com.alliander.osgp.adapter.ws.tariffswitching.endpoints.TariffSwitchingScheduleManagementEndpoint(
                this.tariffScheduleManagementService,
                new com.alliander.osgp.adapter.ws.tariffswitching.application.mapping.ScheduleManagementMapper());
