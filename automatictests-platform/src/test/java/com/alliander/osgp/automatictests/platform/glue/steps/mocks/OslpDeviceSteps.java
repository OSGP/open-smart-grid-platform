...
public class OslpDeviceSteps extends StepsBase {
    ...
    public void theDeviceReturnsAGetStatusResponseOverOSLP(final String result,
        ...
        int eventNotificationTypes = 0;
        if (getString(requestParameters, Keys.EVENTNOTIFICATIONTYPES, Defaults.EVENTNOTIFICATIONTYPES)
                .trim().split(",").length > 0) {
        ...
        if (!getString(requestParameters, Keys.LIGHTVALUES, Defaults.LIGHTVALUES).isEmpty()
            ...
            for (final String lightValueString : getString(requestParameters, Keys.LIGHTVALUES,
                    Defaults.LIGHTVALUES).split(Keys.SEPARATOR)) {
        ...
        this.oslpMockServer.mockGetStatusResponse(
                getEnum(requestParameters, Keys.PREFERRED_LINKTYPE, LinkType.class,
                        Defaults.PREFERRED_LINKTYPE),
                getEnum(requestParameters, Keys.ACTUAL_LINKTYPE, LinkType.class, Defaults.ACTUAL_LINKTYPE),
                getEnum(requestParameters, Keys.LIGHTTYPE, LightType.class, Defaults.LIGHTTYPE),
