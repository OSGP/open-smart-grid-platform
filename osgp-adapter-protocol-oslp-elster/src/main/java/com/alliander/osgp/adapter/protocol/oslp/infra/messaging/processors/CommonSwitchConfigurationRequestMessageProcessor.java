...
public class CommonSwitchConfigurationRequestMessageProcessor extends DeviceRequestMessageProcessor implements
OslpEnvelopeProcessor {
    ...
    public CommonSwitchConfigurationRequestMessageProcessor() {
        super(DeviceRequestMessageType.SWITCH_CONFIGURATION_BANK);
    }
