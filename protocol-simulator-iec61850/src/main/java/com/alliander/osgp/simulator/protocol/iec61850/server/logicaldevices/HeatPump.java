...
public class HeatPump extends LogicalDevice {
    ...
    public List<BasicDataAttribute> getAttributesAndSetValues(final Date timestamp) {
        ...
        values.add(this.setRandomInt(Node.DSCH1_SCHDID_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH1_SCHDTYP_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH1_SCHDCAT_SETVAL, 1, 100));
        values.add(this.setRandomFloat(Node.DSCH1_SCHDABSTM_VAL_0, 0, 1000));
        values.add(this.setTime(Node.DSCH1_SCHDABSTM_TIME_0, timestamp));
        values.add(this.setRandomFloat(Node.DSCH1_SCHDABSTM_VAL_1, 0, 1000));
        values.add(this.setTime(Node.DSCH1_SCHDABSTM_TIME_1, timestamp));
        values.add(this.setRandomFloat(Node.DSCH1_SCHDABSTM_VAL_2, 0, 1000));
        values.add(this.setTime(Node.DSCH1_SCHDABSTM_TIME_2, timestamp));
        values.add(this.setRandomFloat(Node.DSCH1_SCHDABSTM_VAL_3, 0, 1000));
        values.add(this.setTime(Node.DSCH1_SCHDABSTM_TIME_3, timestamp));

        values.add(this.setRandomInt(Node.DSCH2_SCHDID_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH2_SCHDTYP_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH2_SCHDCAT_SETVAL, 1, 100));
        values.add(this.setRandomFloat(Node.DSCH2_SCHDABSTM_VAL_0, 0, 1000));
        values.add(this.setTime(Node.DSCH2_SCHDABSTM_TIME_0, timestamp));
        values.add(this.setRandomFloat(Node.DSCH2_SCHDABSTM_VAL_1, 0, 1000));
        values.add(this.setTime(Node.DSCH2_SCHDABSTM_TIME_1, timestamp));
        values.add(this.setRandomFloat(Node.DSCH2_SCHDABSTM_VAL_2, 0, 1000));
        values.add(this.setTime(Node.DSCH2_SCHDABSTM_TIME_2, timestamp));
        values.add(this.setRandomFloat(Node.DSCH2_SCHDABSTM_VAL_3, 0, 1000));
        values.add(this.setTime(Node.DSCH2_SCHDABSTM_TIME_3, timestamp));

        values.add(this.setRandomInt(Node.DSCH3_SCHDID_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH3_SCHDTYP_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH3_SCHDCAT_SETVAL, 1, 100));
        values.add(this.setRandomFloat(Node.DSCH3_SCHDABSTM_VAL_0, 0, 1000));
        values.add(this.setTime(Node.DSCH3_SCHDABSTM_TIME_0, timestamp));
        values.add(this.setRandomFloat(Node.DSCH3_SCHDABSTM_VAL_1, 0, 1000));
        values.add(this.setTime(Node.DSCH3_SCHDABSTM_TIME_1, timestamp));
        values.add(this.setRandomFloat(Node.DSCH3_SCHDABSTM_VAL_2, 0, 1000));
        values.add(this.setTime(Node.DSCH3_SCHDABSTM_TIME_2, timestamp));
        values.add(this.setRandomFloat(Node.DSCH3_SCHDABSTM_VAL_3, 0, 1000));
        values.add(this.setTime(Node.DSCH3_SCHDABSTM_TIME_3, timestamp));

        values.add(this.setRandomInt(Node.DSCH4_SCHDID_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH4_SCHDTYP_SETVAL, 1, 100));
        values.add(this.setRandomInt(Node.DSCH4_SCHDCAT_SETVAL, 1, 100));
        values.add(this.setRandomFloat(Node.DSCH4_SCHDABSTM_VAL_0, 0, 1000));
        values.add(this.setTime(Node.DSCH4_SCHDABSTM_TIME_0, timestamp));
        values.add(this.setRandomFloat(Node.DSCH4_SCHDABSTM_VAL_1, 0, 1000));
        values.add(this.setTime(Node.DSCH4_SCHDABSTM_TIME_1, timestamp));
        values.add(this.setRandomFloat(Node.DSCH4_SCHDABSTM_VAL_2, 0, 1000));
        values.add(this.setTime(Node.DSCH4_SCHDABSTM_TIME_2, timestamp));
        values.add(this.setRandomFloat(Node.DSCH4_SCHDABSTM_VAL_3, 0, 1000));
        values.add(this.setTime(Node.DSCH4_SCHDABSTM_TIME_3, timestamp));
        ...
        values.add(this.setRandomFloat(Node.MMXU1_TOTPF_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_TOTPF_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_TOTPF_T, timestamp));
        ...
        values.add(this.setQuality(Node.TTMP1_TMPSV_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.TTMP1_TMPSV_T, timestamp));
        values.add(this.setFixedFloat(Node.TTMP2_TMPSV_INSTMAG_F, 324));
        values.add(this.setQuality(Node.TTMP2_TMPSV_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.TTMP2_TMPSV_T, timestamp));
        values.add(this.setFixedFloat(Node.TTMP3_TMPSV_INSTMAG_F, 334));
        values.add(this.setQuality(Node.TTMP3_TMPSV_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.TTMP3_TMPSV_T, timestamp));
        values.add(this.setFixedFloat(Node.TTMP4_TMPSV_INSTMAG_F, 344));
        values.add(this.setQuality(Node.TTMP4_TMPSV_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.TTMP4_TMPSV_T, timestamp));

        values.add(this.setFixedFloat(Node.MFLW1_FLWRTE_MAG_F, 314));
        values.add(this.setQuality(Node.MFLW1_FLWRTE_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MFLW1_FLWRTE_T, timestamp));
