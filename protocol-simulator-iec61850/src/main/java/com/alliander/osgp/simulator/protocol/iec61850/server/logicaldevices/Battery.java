...
public class Battery extends LogicalDevice {
    ...
    public List<BasicDataAttribute> getValues(final Date timestamp) {
        ...
        values.add(this.setRandomFloat("MMXU1.TotPF.mag.f", Fc.MX, 0, 1000));
        values.add(this.setQuality("MMXU1.TotPF.q", Fc.MX, QualityType.VALIDITY_GOOD.getValue()));
        values.add(this.setTime("MMXU1.TotPF.t", Fc.MX, timestamp));
