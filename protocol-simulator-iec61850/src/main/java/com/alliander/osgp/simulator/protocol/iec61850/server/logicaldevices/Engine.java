...
public class Engine extends LogicalDevice {
    ...
    private static final Set<String> FLOAT32_NODES = Collections
            .unmodifiableSet(new TreeSet<>(Arrays.asList(MMXU1_TOTW_MAG_F, MMXU1_MINWPHS_MAG_F, MMXU1_MAXWPHS_MAG_F,
                    DRCC1_OUTWSET_SUBVAL_F, DGEN1_TOTWH_MAG_F, DSCH1_SCHDABSTM_VAL_0, DSCH1_SCHDABSTM_VAL_1,
                    DSCH1_SCHDABSTM_VAL_2, DSCH1_SCHDABSTM_VAL_3, DSCH2_SCHDABSTM_VAL_0, DSCH2_SCHDABSTM_VAL_1,
                    DSCH2_SCHDABSTM_VAL_2, DSCH2_SCHDABSTM_VAL_3, DSCH3_SCHDABSTM_VAL_0, DSCH3_SCHDABSTM_VAL_1,
    ...
    private static final Set<String> INT32_NODES = Collections.unmodifiableSet(new TreeSet<>(
            Arrays.asList(GGIO1_INTIN1_STVAL, GGIO1_INTIN2_STVAL, DSCH1_SCHDID_SETVAL, DGEN1_OPTMSRS_STVAL,
    ...
    private static final Set<String> QUALITY_NODES = Collections
            .unmodifiableSet(new TreeSet<>(Arrays.asList(LLN0_HEALTH_Q, LLN0_BEH_Q, LLN0_MOD_Q, GGIO1_ALM1_Q,
                    ...
                    DRCC1_OUTWSET_SUBQ, DGEN1_TOTWH_Q, DGEN1_GNOPST_Q, DGEN1_OPTMSRS_Q)));
    ...
    private static final Set<String> TIMESTAMP_NODES = Collections.unmodifiableSet(new TreeSet<>(
            Arrays.asList(LLN0_HEALTH_T, LLN0_BEH_T, LLN0_MOD_T, GGIO1_ALM1_T, GGIO1_ALM2_T, GGIO1_ALM3_T, GGIO1_ALM4_T,
                    ...
                    MMXU1_TOTW_T, MMXU1_MINWPHS_T, MMXU1_MAXWPHS_T, DGEN1_TOTWH_T, DGEN1_GNOPST_T, DGEN1_OPTMSRS_T,
