...
public class Boiler extends LogicalDevice {
    ...
    private static final Set<String> FLOAT32_NODES = Collections.unmodifiableSet(
            new TreeSet<>(Arrays.asList(TTMP1_TMPSV_INSTMAG_F, TTMP2_TMPSV_INSTMAG_F, TTMP3_TMPSV_INSTMAG_F,
                    ...
                    MMXU1_MAXWPHS_MAG_F, DRCC1_OUTWSET_SUBVAL_F, DGEN1_TOTWH_MAG_F, KTNK1_VLMCAP_SETMAG_F,
                    DSCH1_SCHDABSTM_VAL_0, DSCH1_SCHDABSTM_VAL_1, DSCH1_SCHDABSTM_VAL_2, DSCH1_SCHDABSTM_VAL_3,
    ...
    private static final Set<String> QUALITY_NODES = Collections.unmodifiableSet(new TreeSet<>(
            Arrays.asList(LLN0_HEALTH_Q, LLN0_BEH_Q, LLN0_MOD_Q, GGIO1_ALM1_Q, GGIO1_ALM2_Q, GGIO1_ALM3_Q, GGIO1_ALM4_Q,
                    ...
                    MMXU1_TOTW_Q, MMXU1_MINWPHS_Q, MMXU1_MAXWPHS_Q, DRCC1_OUTWSET_SUBQ, DGEN1_TOTWH_Q, DGEN1_GNOPST_Q,
                    DGEN1_OPTMSRS_Q, TTMP1_TMPSV_Q, TTMP2_TMPSV_Q, TTMP3_TMPSV_Q, TTMP4_TMPSV_Q, MFLW1_FLWRTE_Q)));

    private static final Set<String> TIMESTAMP_NODES = Collections.unmodifiableSet(new TreeSet<>(
            Arrays.asList(LLN0_HEALTH_T, LLN0_BEH_T, LLN0_MOD_T, MFLW1_FLWRTE_T, GGIO1_ALM1_T, GGIO1_ALM2_T,
                    GGIO1_ALM3_T, GGIO1_ALM4_T, GGIO1_INTIN1_T, GGIO1_INTIN2_T, GGIO1_WRN1_T, GGIO1_WRN2_T,
                    GGIO1_WRN3_T, GGIO1_WRN4_T, MMXU1_TOTW_T, MMXU1_MINWPHS_T, MMXU1_MAXWPHS_T, DGEN1_TOTWH_T,
                    DGEN1_GNOPST_T, DGEN1_OPTMSRS_T, TTMP1_TMPSV_T, TTMP2_TMPSV_T, TTMP3_TMPSV_T, TTMP4_TMPSV_T,
    ...
    public List<BasicDataAttribute> getAttributesAndSetValues(final Date timestamp) {
        ...
        values.add(this.setRandomFloat(DSCH1_SCHDABSTM_VAL_0, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH1_SCHDABSTM_TIME_0, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH1_SCHDABSTM_VAL_1, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH1_SCHDABSTM_TIME_1, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH1_SCHDABSTM_VAL_2, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH1_SCHDABSTM_TIME_2, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH1_SCHDABSTM_VAL_3, Fc.MX, 500, 1000));
        ...
        values.add(this.setRandomFloat(DSCH2_SCHDABSTM_VAL_0, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH2_SCHDABSTM_TIME_0, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH2_SCHDABSTM_VAL_1, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH2_SCHDABSTM_TIME_1, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH2_SCHDABSTM_VAL_2, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH2_SCHDABSTM_TIME_2, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH2_SCHDABSTM_VAL_3, Fc.MX, 500, 1000));
        ...
        values.add(this.setRandomFloat(DSCH3_SCHDABSTM_VAL_0, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH3_SCHDABSTM_TIME_0, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH3_SCHDABSTM_VAL_1, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH3_SCHDABSTM_TIME_1, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH3_SCHDABSTM_VAL_2, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH3_SCHDABSTM_TIME_2, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH3_SCHDABSTM_VAL_3, Fc.MX, 500, 1000));
        ...
        values.add(this.setRandomFloat(DSCH4_SCHDABSTM_VAL_0, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH4_SCHDABSTM_TIME_0, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH4_SCHDABSTM_VAL_1, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH4_SCHDABSTM_TIME_1, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH4_SCHDABSTM_VAL_2, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH4_SCHDABSTM_TIME_2, Fc.MX, timestamp));
        values.add(this.setRandomFloat(DSCH4_SCHDABSTM_VAL_3, Fc.MX, 500, 1000));
        values.add(this.setTime(DSCH1_SCHDABSTM_TIME_3, Fc.MX, timestamp));
