...
public class Boiler extends LogicalDevice {
    ...
    private static final Set<String> FLOAT32_NODES = Collections.unmodifiableSet(
            new TreeSet<>(Arrays.asList(TTMP1_TMPSV_INSTMAG_F, TTMP2_TMPSV_INSTMAG_F, TTMP3_TMPSV_INSTMAG_F,
                    ...
                    DSCH1_SCHDABSTM_VAL_0, DSCH1_SCHDABSTM_VAL_2, DSCH1_SCHDABSTM_VAL_3)));
    ...
    private static final Set<String> TIMESTAMP_NODES = Collections.unmodifiableSet(new TreeSet<>(
            Arrays.asList(LLN0_HEALTH_T, LLN0_BEH_T, LLN0_MOD_T, MFLW1_FLWRTE_T, GGIO1_ALM1_T, GGIO1_ALM2_T,
                    ...
                    DSCH1_SCHDABSTM_TIME_0, DSCH1_SCHDABSTM_VAL_1, DSCH1_SCHDABSTM_TIME_1, DSCH1_SCHDABSTM_TIME_2,
                    DSCH1_SCHDABSTM_TIME_3)));
