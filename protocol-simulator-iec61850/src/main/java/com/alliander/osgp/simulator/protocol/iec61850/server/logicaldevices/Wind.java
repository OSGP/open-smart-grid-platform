...
public class Wind extends LogicalDevice {
    ...
    static {
        ...
        fcByNode.put(Node.MMXU1_TOTPF_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU1_TOTPF_Q, Fc.MX);
        fcByNode.put(Node.MMXU1_TOTPF_T, Fc.MX);

        fcByNode.put(Node.MMXU1_W_PHSA_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU1_W_PHSA_Q, Fc.MX);
        fcByNode.put(Node.MMXU1_W_PHSA_T, Fc.MX);

        fcByNode.put(Node.MMXU1_W_PHSB_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU1_W_PHSB_Q, Fc.MX);
        fcByNode.put(Node.MMXU1_W_PHSB_T, Fc.MX);

        fcByNode.put(Node.MMXU1_W_PHSC_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU1_W_PHSC_Q, Fc.MX);
        fcByNode.put(Node.MMXU1_W_PHSC_T, Fc.MX);

        fcByNode.put(Node.MMXU2_W_PHSA_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU2_W_PHSA_Q, Fc.MX);
        fcByNode.put(Node.MMXU2_W_PHSA_T, Fc.MX);

        fcByNode.put(Node.MMXU2_W_PHSB_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU2_W_PHSB_Q, Fc.MX);
        fcByNode.put(Node.MMXU2_W_PHSB_T, Fc.MX);

        fcByNode.put(Node.MMXU2_W_PHSC_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU2_W_PHSC_Q, Fc.MX);
        fcByNode.put(Node.MMXU2_W_PHSC_T, Fc.MX);

        fcByNode.put(Node.MMXU3_W_PHSA_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU3_W_PHSA_Q, Fc.MX);
        fcByNode.put(Node.MMXU3_W_PHSA_T, Fc.MX);

        fcByNode.put(Node.MMXU3_W_PHSB_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU3_W_PHSB_Q, Fc.MX);
        fcByNode.put(Node.MMXU3_W_PHSB_T, Fc.MX);

        fcByNode.put(Node.MMXU3_W_PHSC_CVAL_MAG_F, Fc.MX);
        fcByNode.put(Node.MMXU3_W_PHSC_Q, Fc.MX);
        fcByNode.put(Node.MMXU3_W_PHSC_T, Fc.MX);
    ...
    public List<BasicDataAttribute> getAttributesAndSetValues(final Date timestamp) {
        ...
        values.add(this.setRandomFloat(Node.MMXU1_TOTPF_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_TOTPF_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_TOTPF_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU1_W_PHSA_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_W_PHSA_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_W_PHSA_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU1_W_PHSB_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_W_PHSB_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_W_PHSB_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU1_W_PHSC_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_W_PHSC_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_W_PHSC_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU2_W_PHSA_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU2_W_PHSA_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU2_W_PHSA_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU2_W_PHSB_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU2_W_PHSB_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU2_W_PHSB_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU2_W_PHSC_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU2_W_PHSC_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU2_W_PHSC_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU3_W_PHSA_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU3_W_PHSA_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU3_W_PHSA_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU3_W_PHSB_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU3_W_PHSB_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU3_W_PHSB_T, Fc.MX, timestamp));

        values.add(this.setRandomFloat(Node.MMXU3_W_PHSC_CVAL_MAG_F, Fc.MX, 0, 1000));
        values.add(this.setQuality(Node.MMXU3_W_PHSC_Q, Fc.MX, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU3_W_PHSC_T, Fc.MX, timestamp));
