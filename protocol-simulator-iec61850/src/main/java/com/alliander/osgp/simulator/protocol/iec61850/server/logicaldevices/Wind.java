...
public class Wind extends LogicalDevice {
    ...
    public List<BasicDataAttribute> getAttributesAndSetValues(final Date timestamp) {
        ...
        values.add(this.setRandomFloat(Node.MMXU1_W_PHSA_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_W_PHSA_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_W_PHSA_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU1_W_PHSB_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_W_PHSB_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_W_PHSB_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU1_W_PHSC_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU1_W_PHSC_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU1_W_PHSC_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU2_W_PHSA_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU2_W_PHSA_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU2_W_PHSA_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU2_W_PHSB_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU2_W_PHSB_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU2_W_PHSB_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU2_W_PHSC_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU2_W_PHSC_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU2_W_PHSC_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU3_W_PHSA_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU3_W_PHSA_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU3_W_PHSA_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU3_W_PHSB_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU3_W_PHSB_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU3_W_PHSB_T, timestamp));

        values.add(this.setRandomFloat(Node.MMXU3_W_PHSC_CVAL_MAG_F, 0, 1000));
        values.add(this.setQuality(Node.MMXU3_W_PHSC_Q, QualityType.VALIDITY_GOOD));
        values.add(this.setTime(Node.MMXU3_W_PHSC_T, timestamp));
