...
import org.openmuc.openiec61850.BdaTapCommand.TapCommand;
...
public class BasicDataAttributesHelper {
    ...
    private static final Map<BdaType, ValueSetter> VALUE_SETTER_BY_TYPE = new EnumMap<>(
            BdaType.class);
    ...
    private static class BdaCheckComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaCheck) o1).getValue(),
    ...
    private static class BdaDoubleBitPosComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaDoubleBitPos) o1).getValue(),
    ...
    private static class BdaOctetStringComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaOctetString) o1).getValue(),
    ...
    private static class BdaOptFldsComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaOptFlds) o1).getValue(),
    ...
    private static class BdaQualityComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaQuality) o1).getValue(),
    ...
    private static class BdaReasonForInclusionComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaReasonForInclusion) o1).getValue(),
    ...
    private static class BdaTimestampComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaTimestamp) o1).getValue(),
    ...
    private static class BdaTriggerConditionsComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaTriggerConditions) o1).getValue(),
    ...
    private static class BdaUnicodeStringComparator implements Comparator<BasicDataAttribute> {
        @Override
        public int compare(final BasicDataAttribute o1, final BasicDataAttribute o2) {
            return BasicDataAttributesHelper.compareByteArray(((BdaUnicodeString) o1).getValue(),
