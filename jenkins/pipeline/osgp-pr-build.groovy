    ...
    stages {
        ...
        stage ('Maven Build') {
            steps {
                ...
                sh "cd release && plays/download-artifacts.yml -e artifactstodownload='{{ dlms_simulator_artifacts }}' -e deployment_type=snapshots -e osgp_version=${POMVERSION} -e tmp_artifacts_directory=../../target/artifacts"
