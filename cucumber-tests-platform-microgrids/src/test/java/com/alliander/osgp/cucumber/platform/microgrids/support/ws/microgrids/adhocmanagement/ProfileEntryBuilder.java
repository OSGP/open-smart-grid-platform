...
public class ProfileEntryBuilder {
    ...
    public ProfileEntryBuilder withSettings(final Map<String, String> settings, final int systemIndex,
        ...
        final int numberOfProfileEntries = SettingsHelper.getIntegerValue(settings, PlatformKeys.KEY_NUMBER_OF_PROFILE_ENTRIES,
                indexes);
    ...
    private ProfileEntryBuilder withSettings(final Map<String, String> settings, final int systemIndex,
        ...
        this.withId(SettingsHelper.getIntegerValue(settings, PlatformKeys.KEY_PROFILE_ENTRY_ID, indexes));
        this.withTime(SettingsHelper.getXmlGregorianCalendarValue(settings, PlatformKeys.KEY_PROFILE_ENTRY_TIME, indexes));
        this.withValue(SettingsHelper.getDoubleValue(settings, PlatformKeys.KEY_PROFILE_ENTRY_VALUE, indexes));
