Feature: SetSchedule
  ...
  Scenario Outline: Set light schedule with 51 schedules # Fail
    ...
    Then the set light schedule response contains soap fault
      ...
      | ValidationErrors | cvc-complex-type.2.4.a: Invalid content was found starting with element 'ns3:Schedules'. One of '{"http://www.alliander.com/schemas/osgp/publiclighting/schedulemanagement/2014/10":scheduled_time}' is expected. |
