 ...
 */
package com.alliander.osgp.platform.cucumber.glue.steps.database.adapterprotocoloslp;
...
import com.alliander.osgp.platform.cucumber.glue.steps.database.core.DeviceSteps;
...
public class OslpDeviceSteps {
    ...
    public void anOslpDevice(final Map<String, String> settings) throws Throwable {
        ...
        final OslpDevice device = new OslpDevice(getString(settings, Keys.DEVICE_UID, DEFAULT_DEVICE_UID),
                deviceIdentification, getString(settings, Keys.DEVICE_TYPE, Defaults.DEVICE_TYPE));
