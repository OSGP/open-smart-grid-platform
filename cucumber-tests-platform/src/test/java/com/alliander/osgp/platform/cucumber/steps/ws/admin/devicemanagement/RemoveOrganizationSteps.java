...
public class RemoveOrganizationSteps {
    ...
    public void receiving_a_remove_organization_request(final Map<String, String> requestSettings) throws Throwable {
    ...
    /**
     * Verify that the remove organization response is successful.
     *
     * @throws Throwable
     */
    ...
    public void the_remove_organization_response_is_successfull() throws Throwable {
        Assert.assertTrue(ScenarioContext.Current().get(Keys.RESPONSE) instanceof RemoveOrganizationResponse);
    }
