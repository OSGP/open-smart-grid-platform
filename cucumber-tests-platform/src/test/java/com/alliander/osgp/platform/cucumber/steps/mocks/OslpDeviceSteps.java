...
public class OslpDeviceSteps {
    ...
    public void aRegisterDeviceOSLPMessageIsSentToDevice(final String deviceIdentification) throws Throwable {
    ...
    public void aReceiveEventNotificationOSLPMessageIsSentToDevice(final String deviceIdentification)
            throws Throwable {
