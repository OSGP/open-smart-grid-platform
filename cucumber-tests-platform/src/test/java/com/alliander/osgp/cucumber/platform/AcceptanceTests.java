...
@CucumberOptions(features = "src/test/resources/features", tags = { "@Iec61850MockServer", "~@Skip" }, glue = {
        "classpath:com.alliander.osgp.cucumber.platform.glue" }, plugin = { "pretty",
