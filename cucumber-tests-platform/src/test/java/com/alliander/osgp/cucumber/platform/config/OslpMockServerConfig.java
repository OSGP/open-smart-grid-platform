...
public class OslpMockServerConfig {
    ...
    public MockOslpServer mockOslpServer() {
        return new MockOslpServer(configuration, oslpPortServer, oslpElsterPortServer, oslpSignature, oslpSignatureProvider, 
                connectionTimeout, signKeyPath, verifyKeyPath, keytype, sequenceNumberWindow, sequenceNumberMaximum, 
                responseDelayTime, reponseDelayRandomRange);
    }
}
