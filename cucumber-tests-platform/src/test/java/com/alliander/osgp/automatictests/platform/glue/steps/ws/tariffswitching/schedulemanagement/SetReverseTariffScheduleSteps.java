 ...
 */
package com.alliander.osgp.automatictests.platform.glue.steps.ws.tariffswitching.schedulemanagement;
...
public class SetReverseTariffScheduleSteps {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SetReverseTariffScheduleSteps.class);
