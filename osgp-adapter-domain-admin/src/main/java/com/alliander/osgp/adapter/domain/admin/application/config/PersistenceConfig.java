...
@Configuration
@PropertySources({ @PropertySource("classpath:osgp-adapter-domain-admin.properties"),
...
public class PersistenceConfig extends AbstractConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws ClassNotFoundException {
        ...
        entityManagerFactoryBean.setPersistenceUnitName("OSGP_DOMAIN_ADAPTER_ADMIN");
