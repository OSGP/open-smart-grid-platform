...
public class DaliConfigurationConverter
        extends BidirectionalConverter<org.opensmartgridplatform.dto.valueobjects.DaliConfigurationDto, DaliConfiguration> {

    @Override
    public DaliConfiguration convertTo(final org.opensmartgridplatform.dto.valueobjects.DaliConfigurationDto source,
    ...
    @Override
    public org.opensmartgridplatform.dto.valueobjects.DaliConfigurationDto convertFrom(final DaliConfiguration source,
        ...
        return new org.opensmartgridplatform.dto.valueobjects.DaliConfigurationDto(numberOfLights, indexAddressMap);
    }
}
