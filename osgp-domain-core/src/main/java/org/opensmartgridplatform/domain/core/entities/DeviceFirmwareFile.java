...
public class DeviceFirmwareFile extends AbstractEntity implements Comparable<DeviceFirmwareFile> {
    ...
    public DeviceFirmwareFile(final Device device, final FirmwareFile firmwareFile, final Date installationDate,
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(this.device, other.device) && Objects.equals(this.firmwareFile, other.firmwareFile)
