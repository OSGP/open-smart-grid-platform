...
public class DeviceStatusMapped extends DeviceStatus {
     ...
     *            eventmask to use
     */
    public DeviceStatusMapped(final List<TariffValue> tariffValues, final List<LightValue> lightValues,
            final LinkType preferredLinkType, final LinkType actualLinkType, final LightType lightType,
