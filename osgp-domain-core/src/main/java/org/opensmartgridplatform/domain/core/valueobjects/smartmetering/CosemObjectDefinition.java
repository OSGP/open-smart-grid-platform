...
public class CosemObjectDefinition implements Serializable {
    ...
    public CosemObjectDefinition(final int classId, final CosemObisCode logicalName, final int attributeIndex,
            final int dataIndex) {
    ...
    private void checkFields(final int classId, final CosemObisCode logicalName, final int attributeIndex,
            final int dataIndex) {
