...
public class SetDeviceLifecycleStatusByChannelResponseData extends ActionResponse {
    ...
    public SetDeviceLifecycleStatusByChannelResponseData(final String gatewayDeviceIdentification, final short channel,
            final String mbusDeviceIdentification, final DeviceLifecycleStatus deviceLifecycleStatus) {
