...
public class ProfileGenericDataItem extends MeterReads {
     ...
     */
    public ProfileGenericDataItem(final Date logTime, final OsgpMeterValue activeEnergyImport,
     ...
     * @param activeEnergyExportTariffTwo
     */
    public ProfileGenericDataItem(final Date logTime, final OsgpMeterValue activeEnergyImportTariffOne,
            final OsgpMeterValue activeEnergyImportTariffTwo, final OsgpMeterValue activeEnergyExportTariffOne,
