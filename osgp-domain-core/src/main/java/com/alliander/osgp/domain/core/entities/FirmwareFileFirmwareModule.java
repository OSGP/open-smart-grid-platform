...
/**
 * FirmwareFileFirmwareModule entity class holds the module version of a
 * firmware module included in a firmware file.
 */
@Entity
public class FirmwareFileFirmwareModule implements Comparable<FirmwareFileFirmwareModule>, Serializable {
    ...
    @EmbeddedId
    private FirmwareFileFirmwareModuleId id;
    ...
    public FirmwareFileFirmwareModule(final FirmwareFile firmwareFile, final FirmwareModule firmwareModule,
    ...
    public int compareTo(final FirmwareFileFirmwareModule o) {
        final int compareFirmwareFile = this.firmwareFile.getIdentification()
                .compareTo(o.firmwareFile.getIdentification());
    ...
    @Override
    public String toString() {
        return String.format("FirmwareFileFirmwareModule[file=%s, module=%s, version=%s]",
                this.firmwareFile.getIdentification(), this.firmwareModule.getDescription(), this.moduleVersion);
    }
