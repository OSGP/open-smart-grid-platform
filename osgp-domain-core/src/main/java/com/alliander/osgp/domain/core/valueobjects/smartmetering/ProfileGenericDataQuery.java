 ...
 * @author dev
 */
public class ProfileGenericDataQuery implements Serializable {
    ...
    public ProfileGenericDataQuery(final PeriodType periodType, final Date beginDate, final Date endDate,
