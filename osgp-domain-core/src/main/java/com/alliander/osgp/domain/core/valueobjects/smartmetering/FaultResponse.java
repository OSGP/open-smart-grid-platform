...
public class FaultResponse extends ActionResponse {
    ...
    private final FaultResponseParameters parameters;

    public FaultResponse(final Integer code, final String message, final String component, final String innerException,
            final String innerMessage, final FaultResponseParameters parameters) {
    ...
    public FaultResponseParameters getParameters() {
