...
public class BundleResponseMessagesResponseListDto implements Serializable {
    ...
    public BundleResponseMessagesResponseListDto(final List<ActionResponse> actionResponseList) {
