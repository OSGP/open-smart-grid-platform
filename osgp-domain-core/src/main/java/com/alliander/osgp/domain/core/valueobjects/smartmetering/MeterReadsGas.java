...
public class MeterReadsGas extends ActionValueResponseObject implements Serializable {
    ...
    public MeterReadsGas(final Date logTime, final OsgpMeterValue consumption, final Date captureTime) {
